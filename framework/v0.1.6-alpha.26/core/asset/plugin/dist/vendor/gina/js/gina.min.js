...
Ja,Ua,pb){Ja&&r(Ja,function(ab,gb){if(Ua||!Q(Ia,gb))!pb||'object'!==typeof ab||!ab||U(ab)||ma(ab)||ab instanceof RegExp?Ia[gb]=ab:(Ia[gb]||(Ia[gb]={}),G(Ia[gb],ab,Ua,pb))});return Ia}function w(Ia,Ja){return function(){return Ja.apply(Ia,arguments)}}function na(Ia){throw Ia;}function Aa(Ia){if(!Ia)return Ia;var Ja=B;M(Ia.split('.'),function(Ua){Ja=Ja[Ua]});return Ja}function N(Ia,Ja,Ua,pb){Ja=Error(Ja+'\nhttps://requirejs.org/docs/errors.html#'+Ia);Ja.requireType=Ia;Ja.requireModules=pb;Ua&&(Ja.originalError=
...
z[l[y++]],z[l[y++]],z[l[y++]],z[l[y++]],z[l[y++]]].join('')}function ma(l,y,z){var F=function(u,v,H,J){J=H&&J||0;if('string'==typeof u&&(u=function(T){T=unescape(encodeURIComponent(T));for(var ra=Array(T.length),Fa=0;Fa<T.length;Fa++)ra[Fa]=T.charCodeAt(Fa);return ra}(u)),'string'==typeof v&&(v=function(T){var ra=[];return T.replace(/[a-fA-F0-9]{2}/g,function(Fa){ra.push(parseInt(Fa,16))}),ra}(v)),!Array.isArray(u))throw TypeError('value must be an array of bytes');if(!Array.isArray(v)||16!==v.length)throw TypeError('namespace must be uuid string or an Array of 16 byte values');
...
typeof M[0]&&null!=M[0]&&'undefined'!=typeof M[0][r]&&'object'==typeof ba[0]&&'undefined'!=typeof ba[0][r]){B=Array.isArray(ba)?Array.from(ba):JSON.clone(ba);var G=0;for(Q=B.length;G<Q;++G)S.push(B[G][r]);Q=JSON.clone(M);var w=0;G=0;M=Q.length;for(var na=N||0,Aa=ba.length;na<Aa;++na)a:for(G=G||0;G<M;++G)if(Q[G][r]===ba[na][r]){-1<S.indexOf(Q[G][r])?(B[w]=Q[G],++w):-1==S.indexOf(Q[G][r])&&(S.push(Q[G][r]),B[w]=Q[G],++w);break a}else-1==S.indexOf(Q[G][r])&&(S.push(Q[G][r]),B.push(Q[G]));return B}return Array.isArray(M)&&
...
var N=null;G=0;for(M=B.length;G<M;++G)S.push(B[G][r]);for(G=0;G<M;++G)a:for(na=N||0,Aa=Q.length;na<Aa;++na)if(null!=Q[na]&&'undefined'!=typeof Q[na][r]&&Q[na][r]!==B[G][r]){if(-1==S.indexOf(Q[na][r])){B.push(Q[na]);S.push(Q[na][r]);N=na+1;M<Aa&&++M;break a}}else if(null!=Q[na]&&'undefined'!=typeof Q[na][r]&&Q[na][r]===B[G][r])N=na+1;else break a;return B}for(G=0;G<M.length;++G)if(S=null,'undefined'==typeof M||'object'!=typeof M[G]||Array.isArray(M[G])||null==M[G]||(S=Object.getOwnPropertyNames(M[G])),
...
'object'!=typeof M[G]?B.push(M[G]):'undefined'==typeof ba[G]||/null/i.test(ba[G])||'undefined'==typeof ba[G][S]||'undefined'==typeof M[G]||'undefined'==typeof M[G][S]||ba[G][S]!=M[G][S]||(B[G]=Q?M[G]:ba[G]):B[G]=Q?M[G]:ba[G]}if(0<B.length&&0<ba.length||0==B.length&&0==ba.length)return B};ma.prototype.setKeyComparison=function(M){this.keyComparison=M};var U=function(M){if(!M||'[object Object]'!=={}.toString.call(M)||M.nodeType||M.setInterval)return!1;var ba={}.hasOwnProperty,Q=ba.call(M,'constructor');
...
function handleXhr(B,P,V,ma){if(!B)throw Error('No `xhr` object initiated');var U=null,M=null,ba=null,Q=null,S=null,r=V.$link||null,G=V.$form||null,w=null;delete V.$link;delete V.$form;G||r?r?(r.target=document.getElementById(r.id),w=gina.link.target,S=gina.link.id):(w=G.target,S=w.getAttribute('id')):(w=P,S=w.getAttribute('id'));var na=r&&P.getAttribute('data-gina-link-event-on-success')||r&&P.getAttribute('data-gina-link-event-on-error')?!0:!1,Aa=G&&w.getAttribute('data-gina-form-event-on-submit-success')||
...
return{setCulture:function(r,G){/\-/.test(G)?(V=G,ma=G.split(/\-/)[0]):ma=G;return this},format:function(r,G,w){var na=M[ma]||M.en,Aa=null;try{Aa=P(na.masks,U)}catch(T){P=(B='undefined'!==typeof module&&module.exports?!1:!0)?require('lib/merge'):require('./../lib/merge'),Aa=P(na.masks,U)}'undefined'!=typeof M[V]&&(na=M[V],'undefined'!=typeof M[V].mask&&(Aa=P(na.masks,U)));var N=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,
...
var H=w?0:r.getTimezoneOffset(),J={d:Aa,dd:A(Aa),ddd:na.dayNames[l],dddd:na.dayNames[l+7],m:y+1,mm:A(y+1),mmm:na.monthNames[y],mmmm:na.monthNames[y+12],yy:String(z).slice(2),yyyy:z,h:F%12||12,hh:A(F%12||12),H:F,HH:A(F),M:u,MM:A(u),s:v,ss:A(v),l:A(D,3),L:A(D),t:12>F?'a':'p',tt:12>F?'am':'pm',T:12>F?'A':'P',TT:12>F?'AM':'PM',Z:w?'UTC':(String(r).match(N)||['']).pop().replace(O,''),o:(0<H?'-':'+')+A(100*Math.floor(Math.abs(H)/60)+Math.abs(H)%60,4),S:['th','st','nd','rd'][3<Aa%10?0:(10!=Aa%100-Aa%10)*
Aa%10]};return G.replace(/d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g,function(T){return T in J?J[T]:T.slice(1,T.length-1)})},countDaysTo:ba,getDaysTo:function(r,G,w){if(G instanceof Date){G=ba(r,G);var na=r.getMonth(),Aa=r.getFullYear();r=r.getDate()+1;r=new Date(Aa,na,r);na=[];for(Aa=0;Aa<G;++Aa)'undefined'!=typeof w?na.push((new Date(r)).format(w)):na.push(new Date(r)),r.setDate(r.getDate()+1);return na||[]}throw Error('dateTo is not instance of Date() !');},getDaysInMonth:function(r){var G=
...
n?b.unique(e):e),e.selector=this.selector?this.selector+' '+a:a,e},filter:function(a){return this.pushStack(ma(this,a||[],!1))},not:function(a){return this.pushStack(ma(this,a||[],!0))},is:function(a){return!!ma(this,'string'==typeof a&&ea.test(a)?b(a):a||[],!1).length}});var oa=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;(b.fn.init=function(a,c,e){var k,n;if(!a)return this;if(e=e||sa,'string'==typeof a){if(k='<'===a.charAt(0)&&'>'===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:oa.exec(a),!k||!k[1]&&
...
c,e,k){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var n,C,I,Y=b.camelCase(c),qa=a.style;if(c=b.cssProps[Y]||(b.cssProps[Y]=ha(Y)||Y),I=b.cssHooks[c]||b.cssHooks[Y],void 0===e)return I&&'get'in I&&void 0!==(n=I.get(a,!1,k))?n:qa[c];if(C=typeof e,'string'===C&&(n=Mb.exec(e))&&n[1]&&(e=na(a,c,n),C='number'),null!=e&&e===e&&('number'===C&&(e+=n&&n[3]||(b.cssNumber[Y]?'':'px')),h.clearCloneStyle||''!==e||0!==c.indexOf('background')||(qa[c]='inherit'),!(I&&'set'in I&&void 0===(e=I.set(a,e,k)))))try{qa[c]=
...
''==B||null==B)B=[];if(!Array.isArray(B))throw Error('`new Collection([content] [, options] )`: `content` argument must be an Array !');B=B?JSON.clone(B):[];for(var w=[],na=V=0,Aa=B.length;na<Aa;++na)B[na]||(B[na]={}),B[na]._uuid=ma.v4(),w[V]=B[na]._uuid,++V;var N=B;N.setSearchOption=function(){if(!arguments.length)throw Error('searchOption cannot be left blank');if(3<arguments.length||3>arguments.length&&1<arguments.length)throw Error('argument length mismatch');var A=0,D=arguments.length;if(1==
...
query:'Must be a valid response',isApiError:'Condition not satisfied'}},r=null;if(B)r=M(JSON.clone(B),r),S.data=M(JSON.clone(B),S.data);else throw Error('missing data param');var G=function(l,y){var z=null;for(let F in ma)if(ma[F].name===y){z=(new DOMParser).parseFromString(l.innerHTML,'text/html').getElementById(ma[F].id);break}if(z)return z;throw Error('Field `'+y+'` not found in fieldsSet');},w=function(l){var y;var z='';var F=l.length;for(y=0;y<F;){var u=l[y++];switch(u>>4){case 0:case 1:case 2:case 3:case 4:case 5:case 6:case 7:z+=
String.fromCharCode(u);break;case 12:case 13:var v=l[y++];z+=String.fromCharCode((u&31)<<6|v&63);break;case 14:v=l[y++];var H=l[y++];z+=String.fromCharCode((u&15)<<12|(v&63)<<6|(H&63)<<0)}}return z},na=function(l,y){y=l.match(/\{\{([^{{}}]+)\}\}/g);for(let z=0,F=y.length;z<F;z++){let u=y[z].replace(/\[/g,'["').replace(/\]/g,'"]').replace(/\{|\}/g,'').trim();try{u=eval('data.'+u).replace(/^"|"$/g,''),l=l.replace(new RegExp(y[z].replace(/\{|\[|\]|\}/g,'\\$&'),'g'),u)}catch(v){}}return l},Aa=function(l,
...
getContext('gina').plugins,U=V.Validator);P.getUrlProps=function(r,G){var w={};if(B){var na=window.gina.config;w.hostname=na.hostname;'undefined'!=typeof r&&(r=this.getRoute('webroot@'+r),w.hostname=r.hostname,w.host=r.host,w.webroot=r.webroot)}else na=getContext('gina').config,'undefined'!=typeof getContext('argvFilename')&&(na.getRouting=getContext('gina').Config.instance.getRouting),'undefined'==typeof r&&(r=na.bundle),'undefined'==typeof G&&(G=na.env),w.hostname=na.envConf[r][G].hostname,w.host=
na.envConf[r][G].host,w.webroot=na.envConf[r][G].server.webroot;return w};P.compareUrls=async function(r,G,w,na,Aa){'undefined'==typeof w&&(w={routing:{}});if(/,/.test(G)){var N=0;G=G.split(/,/g);for(var O=G.length,A={past:!1,request:w};N<O&&!A.past;)A=await M(r,G[N],w,na,Aa),++N;return A}return await M(r,G,w,na,Aa)};var M=async function(r,G,w,na,Aa){var N=null;try{N=r.url.split(/\//)}catch(T){console.warn(T),N=['']}G=G.split(/\//);var O=0,A=0,D=G.length,l=0,y={},z=0,F=w.method.toLowerCase(),u='get';
...
1);else if(/^validator::/.test(u)&&await ba(G[T],N[T],r,w,na,Aa)){++l;continue}/^:/.test(G[T])&&'undefined'!=typeof u&&(new RegExp(u)).test(N[T])&&(++l,w[F][G[T].substr(1)]=N[T])}v=!0}for(var H in w[F])'undefined'!=typeof r.requirements[H]&&0>G.indexOf(':'+H)&&(G[A]=':'+H,++A,N[O]=w[F][H],++O,v||N.length!==G.length||++D)}if(!v&&N.length===G.length)for(;z<D;++z)N[z]===G[z]?++l:l==z&&/:/.test(G[z])&&await ba(G[z],N[z],r,w,na,Aa)&&++l;if('undefined'!=typeof r.requirements&&F==r.method.toLowerCase()&&
...
z),v=Array.isArray(u[ra])?await _validator[A][ra].apply(_validator[A],u[ra]):await _validator[A][ra](u[ra],w,na,Aa),!v.isValid&&(--l,'undefined'!=typeof v.error))throw v.error;}O++}y.past=l===D?!0:!1;y.past&&(w.routing=S(r,w[F]),y.request=w);return y},ba=async function(r,G,w,na,Aa,N){var O=-1,A=r.match(/:\w+/g);O=new RegExp(r,'g');var D=null,l=null,y=null;D=!1;var z=D=l=l=null,F=null,u=na.method.toLowerCase();if(!A.length)return!1;w.param.path&&O.test(w.param.path)&&(w.param.path=w.param.path.replace(O,
...
typeof na[u]&&(na[u]={});y=A[O].substr(1);O=w.requirements[y];if(/^\//.test(O))D=O.match(/\/(.*)\//).pop(),l=O.replace('/'+D+'/',''),D=(new RegExp(D,l)).test(G);else if(/^validator::/.test(O)&&G){l={};D={};z={};F='';r.replace(new RegExp('[^'+y+']','g'),function(ra){F+=ra});l[y]=G.replace(new RegExp(F,'g'),'');try{D=JSON.parse(O.split(/::/).splice(1)[0].replace(/([^:"\s+](\w+)):/g,'"$1":').replace(/([^:"\s+](\w+))\s+:/g,'"$1":'))}catch(ra){throw ra;}'undefined'!=typeof D.query&&'undefined'!=typeof D.query.data&&
r==D.query.data[Object.keys(D.query.data)[0]]&&(D.query.data[Object.keys(D.query.data)[0]]=l[y],na.params[y]=l[y]);z[y]=D;l=new U('routing',l,null,z);if(0==D.count())return console.error('Route validation failed '+w.rule),!1;for(var v in D)Array.isArray(D[v])?await l[y][v].apply(l[y],D[v]):await l[y][v](D[v],na,Aa,N);D=l.isValid()}else D=(new RegExp(w.requirements[y])).test(G);if('undefined'!=typeof w.param[y]&&'undefined'!=typeof w.requirements&&'undefined'!=typeof w.requirements[y]&&'undefined'!=
typeof na.params&&D)return na.params[y]=G,'undefined'==typeof na[u][y]&&(na[u][y]=G),!0}else{Aa=w.url;N=na.url;u={};z='';var H=!1,J=0;v=0;for(var T=N.length;v<T;++v)if(N.charAt(v)!=Aa.charAt(J)||H){if(''==z)H=!0,z+=N.charAt(v);else if(v>Aa.indexOf(A[0])+A[0].length){O=w.requirements[A[0]];G=z.substr(0,z.length);if(/^\//.test(O))D=O.match(/\/(.*)\//).pop(),l=O.replace('/'+D+'/',''),D=(new RegExp(D,l)).test(G);else if(/^validator::/.test(O)){l={};D={};z={};F='';r.replace(new RegExp('[^'+y[0]+']','g'),
...
r.param.file.replace(A,Q));if(/,/.test(r.url)){w=r.url.split(/,/g);var D=0;for(na=w.length;D<na;++D)Q.variable=G[O],w[D]=w[D].replace(A,Q);r.url=w.join(',')}else Q.variable=G[O],r.url=r.url.replace(A,Q)}}if(w){D=0;na=w.length;Aa=Aa.split(/,/g);var l=0;for(r.urlIndex=0;D<na;++D)if(w=0,A=Aa[0].match(/:[-_a-z0-9]+/ig)){N=0;for(O=A.length;N<O;N++){var y=A[N].substr(1);'undefined'!=typeof G[y]&&G[y]&&w++}w>l&&(l=w,r.urlIndex=D)}}return r};P.getRoute=function(r,G,w){var na=null,Aa=!1;B?(window.location.port||
window.location.hostname!=window.gina.config.hostname.replace(/^(https|http|wss|ws):\/\//,'').replace(/:\d+$/,'')||(Aa=!0,window.gina.config.hostname=window.gina.config.hostname.replace(/^(https|http|wss|ws):\/\//,'').replace(/:\d+$/,'')),na=window.gina.config):(na=getContext('gina').config,'undefined'!=typeof getContext('argvFilename')&&(na.getRouting=getContext('gina').Config.instance.getRouting),Aa=getContext('isProxyHost'));var N=na.env||GINA_ENV,O=null,A=na.bundle;/@/.test(r)||'undefined'==typeof A||
null==A||(r=r.toLowerCase(),r+='@'+A);if(/@/.test(r)){var D=r.replace(/(.*):\/\//,'').split(/@/);A=D[1];/\/(.*)$/.test(r)&&(O=r.replace(/(.*):\/\//,'').split(/\/(.*)$/)[1],A=A.replace(/\/(.*)$/,''),N=O||N);r=D[0].toLowerCase()+'@'+A}O=na.getRouting(A,N);if('undefined'==typeof O[r])throw Error('[ RoutingHelper::getRouting(rule, params) ] : `'+r+'` not found !');na=JSON.clone(O[r]);A=null;na=S(na,G);if(na.isProxyHost=Aa)na.hostname=B?window.location.protocol+'//'+window.gina.config.hostname:process.gina.PROXY_HOSTNAME,
na.host=na.hostname.replace(/^(https|http):\/\//,'');/,/.test(na.url)&&('undefined'!=typeof na.urlIndex&&(w=na.urlIndex,delete na.urlIndex),w='undefined'!=typeof w?w:0,na.url=na.url.split(/,/g)[w]);/\/$/.test(na.url)&&'/'!=na.url&&(na.url=na.url.substr(0,na.url.length-1));if(/GET/i.test(na.method)&&'undefined'!=typeof G){w='?';Aa=O[r].url;O=[];A=0;for(let l in na.param)-1<P.reservedParams.indexOf(l)||(new RegExp(na.param[l])).test(Aa)||'undefined'==typeof G[l]||(w+=l+'='+encodeRFC5987ValueChars(G[l])+
'&',O[A]=G[l],++A);for(let l in G)-1<P.reservedParams.indexOf(l)||'undefined'!=typeof na.requirements[l]||-1<O.indexOf(l)||(w='object'==typeof G[l]?w+(l+'='+encodeRFC5987ValueChars(JSON.stringify(G[l]))+'&'):w+(l+'='+G[l]+'&'));A=O=Aa=null;1<w.length&&(w=w.substring(0,w.length-1),na.url+=w);w=null}na.toUrl=function(l){var y=null;/^redirect$/i.test(this.param.control)&&(y=P.getUrlProps(this.bundle,N||GINA_ENV));var z=this.webroot||y.webroot;y=this.hostname||y.hostname;var F=this.url;this.url='undefined'!=
typeof l&&/^true$/i.test(l)?F.replace(new RegExp('^'+z),'/'):F.replace(new RegExp('^('+z+'|/$)'),z);return y+this.url};na.request=function(l,y){var z=null,F=null;'function'==typeof arguments[arguments.length-1]&&(z=arguments[arguments.length-1]);'object'==typeof arguments[2]&&(F=arguments[2]);var u=this.webroot||F.webroot,v=this.hostname||F.hostname;F='undefined'!=typeof l&&1==l?path.replace(u,'/'):this.url||F.url;v=/^https/.test(v)?'https':'http';B?window.open(F,'undefined'!=typeof y&&'undefined'!=
typeof y.target?y.target:'_self'):('undefined'==typeof y.agent&&(y.agent=!1),v=require(''+v),u=function(H){var J='',T=!1;H.on('data',function(ra){J+=ra});H.on('error',function(ra){T='Failed to get mail content';ra&&'undefined'!=typeof ra.stack?T+=ra.stack:'string'==typeof ra&&(T+='\n'+ra)});H.on('end',function(){if(/^\{/.test(J))try{J=JSON.parse(J),'undefined'!=typeof J.error&&(T=JSON.clone(J),J=null)}catch(ra){T=ra}T?z(T):z(!1,J)})},z?v.get(F,y,u):v.get(F,y))};!/:/.test(na.url)||/:d+\//.test(na.url)||
/:\/\//.test(na.url)||(G=na.url.match(/(:(.*)\/|:(.*)$)/g).map(function(l){return l.replace(/\//g,'')}).join(', '),A='[ RoutingHelper::getRoute(rule[, bundle, method]) ] : route [ %r ] param placeholder not defined: `'+na.url+'` !\n Check your route description to compare requirements against param variables [ '+G+']',A=A.replace(/%r/,r),r=Error(A),console.warn(r),A=r=G=null);return na};P.getRouteByUrl=function(r,G,w,na,Aa){2==arguments.length&&'undefined'!=typeof arguments[1]&&arguments[1]&&-1<P.allowedMethods.indexOf(arguments[1].toLowerCase())&&
(w=arguments[1],G=void 0);var N=null,O=null,A=null,D=null,l=null,y=null;if(/#/.test(r)&&1<r.length){var z=r.split(/#/);r=z[0];l='#'+z[1];z=null}1==arguments.length&&'undefined'!=typeof arguments[0]&&(/^(https|http)/i.test(r)||/^\//.test(r)||(r='/'+r),N='/'+r.split(/\//g)[1],B&&(D=gina.config.reverseRouting,A=gina.config.routing),'undefined'!=typeof D[N]&&(z=A[D[N]],G=z.bundle,N=z.webroot,y=z.hostname,z=null));Aa='boolean'!=typeof arguments[arguments.length-1]?!1:arguments[arguments.length-1];var F=
!1,u=null,v=null,H=u=v=null;z='undefined'!=typeof w?!0:!1;B?(u=window.gina.config,G='undefined'!=typeof G?G:u.bundle,v=u.env,A=A||u.getRouting(G),D=D||u.reverseRouting,isXMLRequest='undefined'!=typeof isXMLRequest?isXMLRequest:!1,y=y||u.hostname,N=N||u.webroot,na={routing:{},method:w,params:{},url:r},G&&(na.bundle=G)):(u=getContext('gina').config,G='undefined'!=typeof G?G:u.bundle,v=u.env,A=u.getRouting(G),y=u.envConf[G][v].hostname,N=u.envConf[G][v].server.webroot,na||={routing:{},isXMLRequest:!1,
method:'undefined'!=typeof w?w.toLowerCase():'get',params:{},url:r},Aa&&(na.method=w),isXMLRequest=na.isXMLRequest||!1);v=r.replace(new RegExp('^('+y+'|'+y.replace(/:\d+/,'')+')'),'');'undefined'==typeof na.routing.path&&(na.routing.path=decodeURI(v));w='undefined'!=typeof w?w.toLowerCase():'get';z&&(na.originalMethod=na.method,na.method=w,na.routing.path=decodeURI(v));na.method||(na.method=w);u={};N=new RegExp(w,'i');D=null;var J;for(J in A){if('undefined'==typeof A[J].param)break;if(A[J].bundle==
G&&(D=A[J].method,/,/.test(D)&&N.test(D)&&(D=na.method),'undefined'==typeof A[J].method||N.test(D))){u={method:D,requirements:A[J].requirements,namespace:A[J].namespace||void 0,url:decodeURI(v),rule:A[J].originalRule||J,param:A[J].param,middleware:JSON.clone(A[J].middleware),bundle:A[J].bundle,isXMLRequest};try{if(H=P.compareUrls(u,A[J].url,na),H.past){O=JSON.clone(A[J]);O.name=J;F=!0;H={};break}}catch(T){throw Error('Route [ '+J+' ] needs your attention.\n'+T.stack);}}}if(F)return/\/$/.test(r)&&
...
G)return A=l,'undefined'==typeof P.notFound[A]?(O=O.replace(/%r/,w.toUpperCase()+'::'+l),P.notFound[A]={count:1,message:O}):z&&'undefined'!=typeof P.notFound[A]&&++P.notFound[A].count,!1;A=P.compareUrls(u,r,na)||null;A.past&&z&&(A=w.toUpperCase()+'::'+A.request.routing.rule,'undefined'==typeof P.notFound[A]?O=O.replace(/%r/,A):++P.notFound[A].count);return!1}console.warn(Error('[ RoutingHelper::getRouteByUrl(rule[, bundle, method, request]) ] : route not found for url: `'+r+'` !').stack);return!1};
...
typeof O&&'undefined'!=typeof O)throw Error('`options` must be an object');'undefined'==typeof O&&(O={});ba=ma(O,ba);S=window.localStorage;O=ba.bucket;if(!S.getItem(O)&&void 0!=O)S.setItem(O,JSON.stringify(G));else if(void 0==O)throw Error('`bucket` name cannot be undefined');Q.bucket=O;Q=ma(Q,na)})(B);return Q}
...
null,errors:{},initialized:!1,isReady:!1,rules:{},$forms:{},getFormById:null,validateFormById:null,setOptions:null,resetErrorsDisplay:null,resetFields:null},na={id:null,plugin:this.plugin,on:U?on:null,eventData:{},target:U?document:null,cachedErrors:{},binded:!1,unbinded:!1,withUserBindings:!1,rules:{},setOptions:null,send:null,isValidating:null,isSubmitting:null,submit:null,destroy:null,resetErrorsDisplay:null,resetFields:null},Aa={},N={},O=null,A={url:'',method:'GET',isSynchrone:!1,withCredentials:!1,
...
m=m.replace(/#/,'');if(null!=document.getElementById(m)&&'undefined'==typeof w.$forms[m]){var h=document.getElementById(m),b,x=typeof(0<Aa.count())?Aa:w.rules;h.getAttribute?(id=h.getAttribute('id')||'form.'+ba.v4(),id!==h.getAttribute('id')&&h.setAttribute('id',id)):(id='form.'+ba.v4(),h.setAttribute('id',id));h.id=na.id=id;if('undefined'!=typeof h.id&&'null'!=h.id&&''!=h.id){na.target=h;w.$forms[h.id]=Q({},na);if(b=h.getAttribute('data-gina-form-rule')){b=b.replace(/\-|\//g,'.');if('undefined'==
typeof x[b])throw Error('['+h.id+'] no rule found with key: `null`');b=x[b]}'string'==typeof h.id&&'undefined'!=typeof x[h.id.replace(/\-/g,'.')]?$target=w.$forms[h.id].target:'object'==typeof h.id?(delete w.$forms[h.id],x=h.attributes.getNamedItem('id').nodeValue||'form.'+ba.v4(),h.setAttribute('id',x),h.id=x,na.target=h,w.$forms[x]=Q({},na),$target=w.$forms[x].target):$target=w.$forms[h.id].target;b?xb($target,b):xb($target)}}'undefined'!=typeof w.$forms[m]&&(w.$forms[m].withUserBindings=!0,g='undefined'!=
...
ha.off('click').on('click',function(q){la&&window.open('','JSON RAW','width=400,height=100').document.write(JSON.stringify(la.data))});Aa.off('click').on('click',function(q){q.preventDefault();Aa.removeClass('gina-toolbar-active');A.removeClass('gina-toolbar-active');P(this).addClass('gina-toolbar-active');l=P(this).attr('href');D=P(l).addClass('gina-toolbar-active');w.panelId=l;w.save()});N.off('click').on('click',function(q){q.preventDefault();G.toggleClass('gina-toolbar-collapsed');na=G.hasClass('gina-toolbar-collapsed');
w.isCollapsed=na;w.save()});F.off('change').on('change',function(q){q.preventDefault();q=y.val();var p=z.val();u=q+'-'+p;Zb(u);w.position=u;w.save()});v.off('change').on('change',function(q){q.preventDefault();H=v.val();jb(H);w.width=H;w.save()});P(window).off('resize').on('resize',function(){Db()});P('body').off('keypress').on('keypress',function(q){if(!/INPUT|TEXTAREA/.test(q.target.tagName)){ra=q.keyCode?q.keyCode:q.which?q.which:q.charCode;q=new Date;if('undefined'!=typeof Fa.keynum&&Fa.keynum==
ra&&'undefined'!=typeof Fa.pressTime&&500>q.getTime()-Fa.pressTime)switch(ra){case 103:G.toggle()}Fa.pressTime=q.getTime();Fa.keynum=ra}});Aa.filter('[href="'+l+'"]').trigger('click');na||P('#gina-toolbar-toggle').trigger('click');Zb(u);var x=u.split('-');y.val(x[0]);z.val(x[1]);jb(H);v.val(H);Db();x=W?W.text():'';/^\{\{ (.*) \}\}/.test(x)?h(x,ab):ab()},Zb=function(x){G.removeClass('gina-toolbar-top-left gina-toolbar-top-right gina-toolbar-bottom-left gina-toolbar-bottom-right').addClass('gina-toolbar-'+
...
define('gina','require vendor/uuid lib/merge utils/events helpers/prototypes helpers/dateFormat gina/toolbar'.split(' '),function(B){B('utils/events');var P=B('lib/merge'),V=B('helpers/dateFormat')();B('helpers/prototypes')({dateFormat:V});var ma=B('vendor/uuid');window.process||function(U,M,ba,Q,S,r,G){for(r=U[ba]||(U[ba]={});!G&&S<Q.length;)G=U[Q[S++]+'requestAnimationFrame'];r[M]=r[M]||G&&G.bind(U)||U.setImmediate||U.setTimeout}(window,'nextTick','process',['r','webkitR','mozR','msR','oR'],0);
window.getComputedStyle||(window.getComputedStyle=function(U,M){this.el=U;this.getPropertyValue=function(ba){var Q=/(\-([a-z]){1})/g;'float'==ba&&(ba='styleFloat');Q.test(ba)&&(ba=ba.replace(Q,function(S,r,G){return G.toUpperCase()}));return U.currentStyle[ba]?U.currentStyle[ba]:null};return this});return function(U){this.plugin='gina';var M='gina-'+ma.v1(),ba=document,Q;document.id=M;M={id:M,isFrameworkLoaded:!1,hasValidator:!1,hasPopinHandler:!1,config:{},session:null,registeredEvents:{},events:{},
...
return ya}function na(ya){var za=S();return function(){var m=ba(ya);if(za){var g=ba(this).constructor;m=Reflect.construct(m,arguments,g)}else m=m.apply(this,arguments);return!m||'object'!=typeof m&&'function'!=typeof m?w(this):m}}function Aa(ya,za,m){return Aa='undefined'!=typeof Reflect&&Reflect.get?Reflect.get:function(g,h,b){for(;!Object.prototype.hasOwnProperty.call(g,h)&&null!==(g=ba(g)););if(g)return h=Object.getOwnPropertyDescriptor(g,h),h.get?h.get.call(b):h.value},Aa(ya,za,m||ya)}function N(ya){if(ya){for(var za in N.prototype)ya[za]=
...
N.prototype.emitReserved=N.prototype.emit;N.prototype.listeners=function(ya){return this._callbacks=this._callbacks||{},this._callbacks['$'+ya]||[]};N.prototype.hasListeners=function(ya){return!!this.listeners(ya).length};var Ea='undefined'!=typeof self?self:'undefined'!=typeof window?window:Function('return this')(),Na=setTimeout,Ia=clearTimeout,Ja,Ua=function(ya){function za(g,h,b){var x;return P(this,za),(x=m.call(this,g)).description=h,x.context=b,x.type='TransportError',x}M(za,ya);var m=na(za);
return za}(G(Error));la=function(ya){function za(g){var h;return P(this,za),(h=m.call(this)).writable=!1,A(w(h),g),h.opts=g,h.query=g.query,h.readyState='',h.socket=g.socket,h}M(za,ya);var m=na(za);return ma(za,[{key:'onError',value:function(g,h,b){return Aa(ba(za.prototype),'emitReserved',this).call(this,'error',new Ua(g,h,b)),this}},{key:'open',value:function(){return'closed'!==this.readyState&&''!==this.readyState||(this.readyState='opening',this.doOpen()),this}},{key:'close',value:function(){return'opening'!==
...
za}(la);var jb=function(ya){function za(g,h){var b;return P(this,za),A(w(b=m.call(this)),h),b.opts=h,b.method=h.method||'GET',b.uri=g,b.async=!1!==h.async,b.data=void 0!==h.data?h.data:null,b.create(),b}M(za,ya);var m=na(za);return ma(za,[{key:'create',value:function(){var g=this,h=O(this.opts,'agent','pfx','key','passphrase','cert','ca','ciphers','rejectUnauthorized','autoUnref');h.xdomain=!!this.opts.xd;h.xscheme=!!this.opts.xs;var b=this.xhr=new F(h);try{b.open(this.method,this.uri,this.async);
...
Ea?'pagehide':'unload',v,!1);var Db='function'==typeof Promise&&'function'==typeof Promise.resolve?function(ya){return Promise.resolve().then(ya)}:function(ya,za){return za(ya,0)},rb=Ea.WebSocket||Ea.MozWebSocket,xb='undefined'!=typeof navigator&&'string'==typeof navigator.product&&'reactnative'===navigator.product.toLowerCase(),Ka={websocket:function(ya){function za(g){var h;return P(this,za),(h=m.call(this,g)).supportsBinary=!g.forceBase64,h}M(za,ya);var m=na(za);return ma(za,[{key:'doOpen',value:function(){if(this.check()){var g=
...
!1))),h.open(),h}M(za,ya);var m=na(za);return ma(za,[{key:'createTransport',value:function(g){var h=U({},this.opts.query);h.EIO=4;h.transport=g;this.id&&(h.sid=this.id);h=U({},this.opts.transportOptions[g],this.opts,{query:h,socket:this,hostname:this.hostname,secure:this.secure,port:this.port});return new Ka[g](h)}},{key:'open',value:function(){var g=this;if(this.opts.rememberUpgrade&&za.priorWebsocketSuccess&&-1!==this.transports.indexOf('websocket'))var h='websocket';else{if(0===this.transports.length)return void this.setTimeoutFn(function(){g.emitReserved('error',
...
xa+'?version='+(new Date).getMilliseconds(),W[ka].setAttribute('href',xa))}ha.isRedirecting?triggerEvent(gina,l.target,'loaded.'+ha.id,ha):triggerEvent(gina,l.target,'open.'+ha.id,ha);if(gina&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar)try{ginaToolbar.update('el-xhr',ha.id)}catch(la){throw la;}}}function w(W){var ka=setupXhr();ka.open('GET',W,!0);ka.setRequestHeader('Content-Type','text/javascript');ka.onload=function(){eval(ka.response)};ka.send()}function na(W){var ka=setupXhr();
...
La);Da<Qa;++Da){if('undefined'==typeof xa[Da].src||''==xa[Da].src)continue;let Ea=xa[Da].src.replace(/(https|http|):\/\//,'').replace(La,'');-1<ha.indexOf(Ea)||w(xa[Da].src)}Da=0;for(Qa=ua.length;Da<Qa;++Da)'undefined'!=typeof ua[Da].href&&''!=ua[Da].href&&(ha=ua[Da].href.replace(/(https|http|):\/\//,'').replace(La,''),-1<la.indexOf(ha)||na(ua[Da].href));Q({target:W,type:'loaded.'+ka.id},ka);/gina-popin-is-active/.test(W.className)||(W.className+=' gina-popin-is-active');if(!D.options.useDialogMode||
