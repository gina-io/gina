...
(function(B,P){function V(Ia,Ja){return Ja||''}function ma(Ia){return'[object Function]'===Da.call(Ia)}function U(Ia){return'[object Array]'===Da.call(Ia)}function M(Ia,Ja){if(Ia){var Ua;for(Ua=0;Ua<Ia.length&&(!Ia[Ua]||!Ja(Ia[Ua],Ua,Ia));Ua+=1);}}function ba(Ia,Ja){if(Ia){var Ua;for(Ua=Ia.length-1;-1<Ua&&(!Ia[Ua]||!Ja(Ia[Ua],Ua,Ia));--Ua);}}function Q(Ia,Ja){return W.call(Ia,Ja)}function S(Ia,Ja){return Q(Ia,Ja)&&Ia[Ja]}function r(Ia,Ja){for(var Ua in Ia)if(Q(Ia,Ua)&&Ja(Ia[Ua],Ua))break}function H(Ia,
Ja,Ua,pb){Ja&&r(Ja,function(ab,gb){if(Ua||!Q(Ia,gb))!pb||'object'!==typeof ab||!ab||U(ab)||ma(ab)||ab instanceof RegExp?Ia[gb]=ab:(Ia[gb]||(Ia[gb]={}),H(Ia[gb],ab,Ua,pb))});return Ia}function w(Ia,Ja){return function(){return Ja.apply(Ia,arguments)}}function va(Ia){throw Ia;}function Aa(Ia){if(!Ia)return Ia;var Ja=B;M(Ia.split('.'),function(Ua){Ja=Ja[Ua]});return Ja}function N(Ia,Ja,Ua,pb){Ja=Error(Ja+'\nhttps://requirejs.org/docs/errors.html#'+Ia);Ja.requireType=Ia;Ja.requireModules=pb;Ua&&(Ja.originalError=
Ua);return Ja}function O(){if(y&&'interactive'===y.readyState)return y;ba(document.getElementsByTagName('script'),function(Ia){if('interactive'===Ia.readyState)return y=Ia});return y}var A,D,l,y,z,F,u,v=/\/\*[\s\S]*?\*\/|([^:"'=]|^)\/\/.*$/mg,G=/[^.]\s*require\s*\(\s*["']([^'"\s]+)["']\s*\)/g,L=/\.js$/,T=/^\.\//;var qa=Object.prototype;var Da=qa.toString,W=qa.hasOwnProperty,ka=!('undefined'===typeof window||'undefined'===typeof navigator||!window.document),ha=!ka&&'undefined'!==typeof importScripts,
xa=ka&&'PLAYSTATION 3'===navigator.platform?/^complete$/:/^(complete|loaded)$/,la='undefined'!==typeof opera&&'[object Opera]'===opera.toString(),ta={},Ea={},Qa=[],La=!1;if('undefined'===typeof define){if('undefined'!==typeof requirejs){if(ma(requirejs))return;Ea=requirejs;requirejs=void 0}'undefined'===typeof require||ma(require)||(Ea=require,require=void 0);var Fa=requirejs=function(Ia,Ja,Ua,pb){var ab='_';if(!U(Ia)&&'string'!==typeof Ia){var gb=Ia;U(Ja)?(Ia=Ja,Ja=Ua,Ua=pb):Ia=[]}gb&&gb.context&&
(ab=gb.context);(pb=S(ta,ab))||(pb=ta[ab]=Fa.s.newContext(ab));gb&&pb.configure(gb);return pb.require(Ia,Ja,Ua)};Fa.config=function(Ia){return Fa(Ia)};Fa.nextTick='undefined'!==typeof P?function(Ia){P(Ia,4)}:function(Ia){Ia()};require||=Fa;Fa.version='2.3.6';Fa.jsExtRegExp=/^\/|:|\?|\.js$/;Fa.isBrowser=ka;qa=Fa.s={contexts:ta,newContext:function(Ia){function Ja(E,na,ra){var ia;na=na&&na.split('/');var Z=m.map,Ga=Z&&Z['*'];if(E){E=E.split('/');var Pa=E.length-1;m.nodeIdCompat&&L.test(E[Pa])&&(E[Pa]=
E[Pa].replace(L,''));'.'===E[0].charAt(0)&&na&&(Pa=na.slice(0,na.length-1),E=Pa.concat(E));Pa=E;for(ia=0;ia<Pa.length;ia++){var $a=Pa[ia];'.'===$a?(Pa.splice(ia,1),--ia):'..'===$a&&0!==ia&&(1!==ia||'..'!==Pa[2])&&'..'!==Pa[ia-1]&&0<ia&&(Pa.splice(ia-1,2),ia-=2)}E=E.join('/')}if(ra&&Z&&(na||Ga)){Pa=E.split('/');ia=Pa.length;a:for(;0<ia;--ia){var ib=Pa.slice(0,ia).join('/');if(na)for($a=na.length;0<$a;--$a)if(ra=S(Z,na.slice(0,$a).join('/')))if(ra=S(ra,ib)){var Cb=ra;var zb=ia;break a}if(!qb&&Ga&&S(Ga,
...
E?E.indexOf('!'):-1;if(-1<na){var ra=E.substring(0,na);E=E.substring(na+1,E.length)}return[ra,E]}function gb(E,na,ra,ia){var Z=null,Ga=na?na.name:null,Pa=E,$a=!0,ib='';E||($a=!1,E='_@r'+(J+=1));E=ab(E);Z=E[0];E=E[1];if(Z){Z=Ja(Z,Ga,ia);var Cb=S(q,Z)}if(E)if(Z)ib=ra?E:Cb&&Cb.normalize?Cb.normalize(E,function(qb){return Ja(qb,Ga,ia)}):-1===E.indexOf('!')?Ja(E,Ga,ia):E;else{ib=Ja(E,Ga,ia);E=ab(ib);Z=E[0];ib=E[1];ra=!0;var zb=da.nameToUrl(ib)}ra=!Z||Cb||ra?'':'_unnormalized'+(fa+=1);return{prefix:Z,name:ib,
parentMap:na,unnormalized:!!ra,url:zb,originalName:Pa,isDefine:$a,id:(Z?Z+'!'+ib:ib)+ra}}function Ub(E){var na=E.id,ra=S(g,na);ra||=g[na]=new da.Module(E);return ra}function Zb(E,na,ra){var ia=E.id,Z=S(g,ia);if(!Q(q,ia)||Z&&!Z.defineEmitComplete)if(Z=Ub(E),Z.error&&'error'===na)ra(Z.error);else Z.on(na,ra);else'defined'===na&&ra(q[ia])}function jb(E,na){var ra=E.requireModules,ia=!1;if(na)na(E);else if(M(ra,function(Z){if(Z=S(g,Z))Z.error=E,Z.events.error&&(ia=!0,Z.emit('error',E))}),!ia)Fa.onError(E)}
function Db(){Qa.length&&(M(Qa,function(E){var na=E[0];'string'===typeof na&&(da.defQueueMap[na]=!0);x.push(E)}),Qa=[])}function rb(E){delete g[E];delete h[E]}function xb(E,na,ra){var ia=E.map.id;E.error?E.emit('error',E.error):(na[ia]=!0,M(E.depMaps,function(Z,Ga){Z=Z.id;var Pa=S(g,Z);!Pa||E.depMatched[Ga]||ra[Z]||(S(na,Z)?(E.defineDep(Ga,q[Z]),E.check()):xb(Pa,na,ra))}),ra[ia]=!0)}function Ka(){var E,na,ra=(E=1E3*m.waitSeconds)&&da.startTime+E<(new Date).getTime(),ia=[],Z=[],Ga=!1,Pa=!0;if(!ya){ya=
!0;r(h,function($a){var ib=$a.map,Cb=ib.id;if($a.enabled&&(ib.isDefine||Z.push($a),!$a.error))if(!$a.inited&&ra)pb(Cb)?Ga=na=!0:(ia.push(Cb),Ua(Cb));else if(!$a.inited&&$a.fetched&&ib.isDefine&&(Ga=!0,!ib.prefix))return Pa=!1});if(ra&&ia.length)return E=N('timeout','Load timeout for modules: '+ia,null,ia),E.contextName=da.contextName,jb(E);Pa&&M(Z,function($a){xb($a,{},{})});ra&&!na||!Ga||!ka&&!ha||za||(za=P(function(){za=0;Ka()},50));ya=!1}}function db(E){Q(q,E[0])||Ub(gb(E[0],null,!0)).init(E[1],
...
qb&&(zb=qb);cb&&(La=!1);Ub(Ya);Q(m.config,na)&&(m.config[Mb]=m.config[na]);try{Fa.exec(zb)}catch(ca){return jb(N('fromtexteval','fromText eval for '+na+' failed: '+ca,ca,[na]))}cb&&(La=!0);this.depMaps.push(Ya);da.completeLoad(Mb);$a([Mb],Cb)});ia.load(E.name,$a,Cb,m)}}));da.enable(ra,this);this.pluginMaps[ra.id]=ra},enable:function(){h[this.map.id]=this;this.enabling=this.enabled=!0;M(this.depMaps,w(this,function(E,na){var ra;if('string'===typeof E){E=gb(E,this.map.isDefine?this.map:this.map.parentMap,
...
on:function(E,na){var ra=this.events[E];ra||=this.events[E]=[];ra.push(na)},emit:function(E,na){M(this.events[E],function(ra){ra(na)});'error'===E&&delete this.events[E]}};var da={config:m,contextName:Ia,registry:g,defined:q,urlFetched:p,defQueue:x,defQueueMap:{},Module:ea,makeModuleMap:gb,nextTick:Fa.nextTick,onError:jb,configure:function(E){E.baseUrl&&'/'!==E.baseUrl.charAt(E.baseUrl.length-1)&&(E.baseUrl+='/');if('string'===typeof E.urlArgs){var na=E.urlArgs;E.urlArgs=function(Z,Ga){return(-1===
Ga.indexOf('?')?'?':'&')+na}}var ra=m.shim,ia={paths:!0,bundles:!0,config:!0,map:!0};r(E,function(Z,Ga){ia[Ga]?(m[Ga]||(m[Ga]={}),H(m[Ga],Z,!0,!0)):m[Ga]=Z});E.bundles&&r(E.bundles,function(Z,Ga){M(Z,function(Pa){Pa!==Ga&&(R[Pa]=Ga)})});E.shim&&(r(E.shim,function(Z,Ga){U(Z)&&(Z={deps:Z});!Z.exports&&!Z.init||Z.exportsFn||(Z.exportsFn=da.makeShimExports(Z));ra[Ga]=Z}),m.shim=ra);E.packages&&M(E.packages,function(Z){Z='string'===typeof Z?{name:Z}:Z;var Ga=Z.name;Z.location&&(m.paths[Ga]=Z.location);
m.pkgs[Ga]=Z.name+'/'+(Z.main||'main').replace(T,'').replace(L,'')});r(g,function(Z,Ga){Z.inited||Z.map.unnormalized||(Z.map=gb(Ga,null,!0))});(E.deps||E.callback)&&da.require(E.deps||[],E.callback)},makeShimExports:function(E){return function(){var na;E.init&&(na=E.init.apply(B,arguments));return na||E.exports&&Aa(E.exports)}},makeRequire:function(E,na){function ra(ia,Z,Ga){var Pa;na.enableBuildCallback&&Z&&ma(Z)&&(Z.__requireJsBuild=!0);if('string'===typeof ia){if(ma(Z))return jb(N('requireargs',
'Invalid require call'),Ga);if(E&&Q(Ba,ia))return Ba[ia](g[E.id]);if(Fa.get)return Fa.get(da,ia,E,ra);var $a=gb(ia,E,!1,!0);$a=$a.id;return Q(q,$a)?q[$a]:jb(N('notloaded','Module name "'+$a+'" has not been loaded yet for context: '+Ia+(E?'':'. Use require([])')))}Vb();da.nextTick(function(){Vb();Pa=Ub(gb(null,E));Pa.skipMap=na.skipMap;Pa.init(ia,Z,Ga,{enabled:!0});Ka()});return ra}na=na||{};H(ra,{isBrowser:ka,toUrl:function(ia){var Z=ia.lastIndexOf('.'),Ga=ia.split('/')[0];if(-1!==Z&&('.'!==Ga&&'..'!==
...
na,ra);if(Fa.jsExtRegExp.test(E))ia=E+(na||'');else{ia=m.paths;var Ga=E.split('/');for(Z=Ga.length;0<Z;--Z){var Pa=Ga.slice(0,Z).join('/');if(Pa=S(ia,Pa)){U(Pa)&&(Pa=Pa[0]);Ga.splice(0,Z,Pa);break}}ia=Ga.join('/');ia+=na||(/^data:|^blob:|\?/.test(ia)||ra?'':'.js');ia=('/'===ia.charAt(0)||ia.match(/^[\w\+\.\-]+:/)?'':m.baseUrl)+ia}return m.urlArgs&&!/^blob:/.test(ia)?ia+m.urlArgs(E,ia):ia},load:function(E,na){Fa.load(da,E,na)},execCb:function(E,na,ra,ia){return na.apply(ia,ra)},onScriptLoad:function(E){if('load'===
E.type||xa.test((E.currentTarget||E.srcElement).readyState))y=null,E=Lb(E),da.completeLoad(E.id)},onScriptError:function(E){var na=Lb(E);if(!pb(na.id)){var ra=[];r(g,function(ia,Z){0!==Z.indexOf('_@r')&&M(ia.depMaps,function(Ga){if(Ga.id===na.id)return ra.push(Z),!0})});return jb(N('scripterror','Script error for "'+na.id+(ra.length?'", needed by: '+ra.join(', '):'"'),E,[na.id]))}}};da.require=da.makeRequire();return da}};Fa({});M(['toUrl','undef','defined','specified'],function(Ia){Fa[Ia]=function(){var Ja=
ta._;return Ja.require[Ia].apply(Ja,arguments)}});if(ka){var Na=qa.head=document.getElementsByTagName('head')[0];if(A=document.getElementsByTagName('base')[0])Na=qa.head=A.parentNode}Fa.onError=va;Fa.createNode=function(Ia,Ja,Ua){Ja=Ia.xhtml?document.createElementNS('http://www.w3.org/1999/xhtml','html:script'):document.createElement('script');Ja.type=Ia.scriptType||'text/javascript';Ja.charset='utf-8';Ja.async=!0;return Ja};Fa.load=function(Ia,Ja,Ua){var pb=Ia&&Ia.config||{};if(ka){var ab=Fa.createNode(pb,
...
0),importScripts(Ua),Ia.completeLoad(Ja)}catch(gb){Ia.onError(N('importscripts','importScripts failed for '+Ja+' at '+Ua,gb,[Ja]))}};ka&&!Ea.skipDataMain&&ba(document.getElementsByTagName('script'),function(Ia){Na||(Na=Ia.parentNode);if(D=Ia.getAttribute('data-main'))return F=D,Ea.baseUrl||-1!==F.indexOf('!')||(l=F.split('/'),F=l.pop(),u=l.length?l.join('/')+'/':'./',Ea.baseUrl=u),F=F.replace(L,''),Fa.jsExtRegExp.test(F)&&(F=D),Ea.deps=Ea.deps?Ea.deps.concat(F):[F],!0});define=function(Ia,Ja,Ua){var pb;
'string'!==typeof Ia&&(Ua=Ja,Ja=Ia,Ia=null);U(Ja)||(Ua=Ja,Ja=null);!Ja&&ma(Ua)&&(Ja=[],Ua.length&&(Ua.toString().replace(v,V).replace(G,function(gb,Ub){Ja.push(Ub)}),Ja=(1===Ua.length?['require']:['require','exports','module']).concat(Ja)));if(La&&(pb=z||O())){Ia||=pb.getAttribute('data-requiremodule');var ab=ta[pb.getAttribute('data-requirecontext')]}ab?(ab.defQueue.push([Ia,Ja,Ua]),ab.defQueueMap[Ia]=!0):Qa.push([Ia,Ja,Ua])};define.amd={jQuery:!0};Fa.exec=function(Ia){return eval(Ia)};Fa(Ea)}})(this,
...
z[l[y++]],z[l[y++]],z[l[y++]],z[l[y++]],z[l[y++]]].join('')}function ma(l,y,z){var F=function(u,v,G,L){L=G&&L||0;if('string'==typeof u&&(u=function(T){T=unescape(encodeURIComponent(T));for(var qa=Array(T.length),Da=0;Da<T.length;Da++)qa[Da]=T.charCodeAt(Da);return qa}(u)),'string'==typeof v&&(v=function(T){var qa=[];return T.replace(/[a-fA-F0-9]{2}/g,function(Da){qa.push(parseInt(Da,16))}),qa}(v)),!Array.isArray(u))throw TypeError('value must be an array of bytes');if(!Array.isArray(v)||16!==v.length)throw TypeError('namespace must be uuid string or an Array of 16 byte values');
u=z(v.concat(u));if(u[6]=15&u[6]|y,u[8]=63&u[8]|128,G)for(v=0;16>v;++v)G[L+v]=u[v];return G||V(u)};try{F.name=l}catch(u){}return F.DNS='6ba7b810-9dad-11d1-80b4-00c04fd430c8',F.URL='6ba7b811-9dad-11d1-80b4-00c04fd430c8',F}function U(l,y){var z=(65535&l)+(65535&y);return(l>>16)+(y>>16)+(z>>16)<<16|65535&z}function M(l,y,z,F,u,v){return U((G=U(U(y,l),U(F,v)))<<(L=u)|G>>>32-L,z);var G,L}function ba(l,y,z,F,u,v,G){return M(y&z|~y&F,l,y,u,v,G)}function Q(l,y,z,F,u,v,G){return M(y&F|z&~F,l,y,u,v,G)}function S(l,
y,z,F,u,v,G){return M(z^(y|~F),l,y,u,v,G)}for(var r='undefined'!=typeof crypto&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto)||'undefined'!=typeof msCrypto&&'function'==typeof msCrypto.getRandomValues&&msCrypto.getRandomValues.bind(msCrypto),H=new Uint8Array(16),w,va,Aa=[],N=0;256>N;++N)Aa[N]=(N+256).toString(16).substr(1);var O=0,A=0;N=ma('v3',48,function(l){if('string'==typeof l){var y=unescape(encodeURIComponent(l));l=Array(y.length);for(var z=0;z<y.length;z++)l[z]=y.charCodeAt(z)}return function(F){var u,
v=[],G=32*F.length;for(u=0;u<G;u+=8){var L=F[u>>5]>>>u%32&255;L=parseInt('0123456789abcdef'.charAt(L>>>4&15)+'0123456789abcdef'.charAt(15&L),16);v.push(L)}return v}(function(F,u){F[u>>5]|=128<<u%32;F[14+(u+64>>>9<<4)]=u;var v=1732584193,G=-271733879,L=-1732584194,T=271733878;for(u=0;u<F.length;u+=16){var qa=v;var Da=G;var W=L;var ka=T;v=ba(v,G,L,T,F[u],7,-680876936);T=ba(T,v,G,L,F[u+1],12,-389564586);L=ba(L,T,v,G,F[u+2],17,606105819);G=ba(G,L,T,v,F[u+3],22,-1044525330);v=ba(v,G,L,T,F[u+4],7,-176418897);
T=ba(T,v,G,L,F[u+5],12,1200080426);L=ba(L,T,v,G,F[u+6],17,-1473231341);G=ba(G,L,T,v,F[u+7],22,-45705983);v=ba(v,G,L,T,F[u+8],7,1770035416);T=ba(T,v,G,L,F[u+9],12,-1958414417);L=ba(L,T,v,G,F[u+10],17,-42063);G=ba(G,L,T,v,F[u+11],22,-1990404162);v=ba(v,G,L,T,F[u+12],7,1804603682);T=ba(T,v,G,L,F[u+13],12,-40341101);L=ba(L,T,v,G,F[u+14],17,-1502002290);G=ba(G,L,T,v,F[u+15],22,1236535329);v=Q(v,G,L,T,F[u+1],5,-165796510);T=Q(T,v,G,L,F[u+6],9,-1069501632);L=Q(L,T,v,G,F[u+11],14,643717713);G=Q(G,L,T,v,F[u],
20,-373897302);v=Q(v,G,L,T,F[u+5],5,-701558691);T=Q(T,v,G,L,F[u+10],9,38016083);L=Q(L,T,v,G,F[u+15],14,-660478335);G=Q(G,L,T,v,F[u+4],20,-405537848);v=Q(v,G,L,T,F[u+9],5,568446438);T=Q(T,v,G,L,F[u+14],9,-1019803690);L=Q(L,T,v,G,F[u+3],14,-187363961);G=Q(G,L,T,v,F[u+8],20,1163531501);v=Q(v,G,L,T,F[u+13],5,-1444681467);T=Q(T,v,G,L,F[u+2],9,-51403784);L=Q(L,T,v,G,F[u+7],14,1735328473);G=Q(G,L,T,v,F[u+12],20,-1926607734);v=M(G^L^T,v,G,F[u+5],4,-378558);T=M(v^G^L,T,v,F[u+8],11,-2022574463);L=M(T^v^G,L,
T,F[u+11],16,1839030562);G=M(L^T^v,G,L,F[u+14],23,-35309556);v=M(G^L^T,v,G,F[u+1],4,-1530992060);T=M(v^G^L,T,v,F[u+4],11,1272893353);L=M(T^v^G,L,T,F[u+7],16,-155497632);G=M(L^T^v,G,L,F[u+10],23,-1094730640);v=M(G^L^T,v,G,F[u+13],4,681279174);T=M(v^G^L,T,v,F[u],11,-358537222);L=M(T^v^G,L,T,F[u+3],16,-722521979);G=M(L^T^v,G,L,F[u+6],23,76029189);v=M(G^L^T,v,G,F[u+9],4,-640364487);T=M(v^G^L,T,v,F[u+12],11,-421815835);L=M(T^v^G,L,T,F[u+15],16,530742520);G=M(L^T^v,G,L,F[u+2],23,-995338651);v=S(v,G,L,T,
F[u],6,-198630844);T=S(T,v,G,L,F[u+7],10,1126891415);L=S(L,T,v,G,F[u+14],15,-1416354905);G=S(G,L,T,v,F[u+5],21,-57434055);v=S(v,G,L,T,F[u+12],6,1700485571);T=S(T,v,G,L,F[u+3],10,-1894986606);L=S(L,T,v,G,F[u+10],15,-1051523);G=S(G,L,T,v,F[u+1],21,-2054922799);v=S(v,G,L,T,F[u+8],6,1873313359);T=S(T,v,G,L,F[u+15],10,-30611744);L=S(L,T,v,G,F[u+6],15,-1560198380);G=S(G,L,T,v,F[u+13],21,1309151649);v=S(v,G,L,T,F[u+4],6,-145523070);T=S(T,v,G,L,F[u+11],10,-1120210379);L=S(L,T,v,G,F[u+2],15,718787259);G=S(G,
L,T,v,F[u+9],21,-343485551);v=U(v,qa);G=U(G,Da);L=U(L,W);T=U(T,ka)}return[v,G,L,T]}(function(F){var u,v=[];v[(F.length>>2)-1]=void 0;for(u=0;u<v.length;u+=1)v[u]=0;var G=8*F.length;for(u=0;u<G;u+=8)v[u>>5]|=(255&F[u/8])<<u%32;return v}(l),8*l.length))});var D=ma('v5',80,function(l){var y=[1518500249,1859775393,2400959708,3395469782],z=[1732584193,4023233417,2562383102,271733878,3285377520];if('string'==typeof l){var F=unescape(encodeURIComponent(l));l=Array(F.length);for(var u=0;u<F.length;u++)l[u]=
F.charCodeAt(u)}l.push(128);F=Math.ceil((l.length/4+2)/16);var v=Array(F);for(u=0;u<F;u++){v[u]=Array(16);for(var G=0;16>G;G++)v[u][G]=l[64*u+4*G]<<24|l[64*u+4*G+1]<<16|l[64*u+4*G+2]<<8|l[64*u+4*G+3]}v[F-1][14]=8*(l.length-1)/Math.pow(2,32);v[F-1][14]=Math.floor(v[F-1][14]);v[F-1][15]=8*(l.length-1)&4294967295;for(u=0;u<F;u++){l=Array(80);for(G=0;16>G;G++)l[G]=v[u][G];for(G=16;80>G;G++){var L=l[G-3]^l[G-8]^l[G-14]^l[G-16];l[G]=L<<1|L>>>31}L=z[0];var T=z[1],qa=z[2],Da=z[3],W=z[4];for(G=0;80>G;G++){var ka=
Math.floor(G/20),ha=L<<5|L>>>27;a:{switch(ka){case 0:var xa=T&qa^~T&Da;break a;case 1:xa=T^qa^Da;break a;case 2:xa=T&qa^T&Da^qa&Da;break a;case 3:xa=T^qa^Da;break a}xa=void 0}ka=ha+xa+W+y[ka]+l[G]>>>0;W=Da;Da=qa;qa=(T<<30|T>>>2)>>>0;T=L;L=ka}z[0]=z[0]+L>>>0;z[1]=z[1]+T>>>0;z[2]=z[2]+qa>>>0;z[3]=z[3]+Da>>>0;z[4]=z[4]+W>>>0}return[z[0]>>24&255,z[0]>>16&255,z[0]>>8&255,255&z[0],z[1]>>24&255,z[1]>>16&255,z[1]>>8&255,255&z[1],z[2]>>24&255,z[2]>>16&255,z[2]>>8&255,255&z[2],z[3]>>24&255,z[3]>>16&255,z[3]>>
8&255,255&z[3],z[4]>>24&255,z[4]>>16&255,z[4]>>8&255,255&z[4]]});B.v1=function(l,y,z){z=y&&z||0;var F=y||[],u=(l=l||{}).node||w,v=void 0!==l.clockseq?l.clockseq:va;if(null==u||null==v){var G=l.random||(l.rng||P)();null==u&&(u=w=[1|G[0],G[1],G[2],G[3],G[4],G[5]]);null==v&&(v=va=16383&(G[6]<<8|G[7]))}G=void 0!==l.msecs?l.msecs:(new Date).getTime();var L=void 0!==l.nsecs?l.nsecs:A+1,T=G-O+(L-A)/1E4;if(0>T&&void 0===l.clockseq&&(v=v+1&16383),(0>T||G>O)&&void 0===l.nsecs&&(L=0),1E4<=L)throw Error("uuid.v1(): Can't create more than 10M uuids/sec");
O=G;A=L;va=v;l=(1E4*(268435455&(G+=122192928E5))+L)%4294967296;F[z++]=l>>>24&255;F[z++]=l>>>16&255;F[z++]=l>>>8&255;F[z++]=255&l;l=G/4294967296*1E4&268435455;F[z++]=l>>>8&255;F[z++]=255&l;F[z++]=l>>>24&15|16;F[z++]=l>>>16&255;F[z++]=v>>>8|128;F[z++]=255&v;for(v=0;6>v;++v)F[z+v]=u[v];return y||V(F)};B.v3=N;B.v4=function(l,y,z){z=y&&z||0;'string'==typeof l&&(y='binary'===l?Array(16):null,l=null);var F=(l=l||{}).random||(l.rng||P)();if(F[6]=15&F[6]|64,F[8]=63&F[8]|128,y)for(l=0;16>l;++l)y[z+l]=F[l];
return y||V(F)};B.v5=D;Object.defineProperty(B,'__esModule',{value:!0})});
function Merge(){var B=[],P=!1,V=function(M,ba){var Q=M;P||('object'==typeof M&&Array.isArray(M),P=!0);'undefined'==typeof Q&&(Q='undefined'!=typeof ba&&Array.isArray(ba)?[]:{});var S=!1;'boolean'==typeof arguments[arguments.length-1]&&(S=arguments[arguments.length-1]);var r=1,H=arguments.length,w,va;if('object'!==typeof Q&&'function'!==typeof Q)Q=S?'undefined'==typeof arguments[2]?arguments[1]:arguments[2]:'undefined'==typeof arguments[0]?arguments[1]:arguments[0];else for(;r<H;++r)if('boolean'!=
typeof arguments[r]&&null!=(w=arguments[r])){if('object'!=typeof w){Q=w;break}if(Array.isArray(w)&&Array.isArray(Q))Q=ma(w,Q,S);else for(var Aa in w){Q||={name:null};var N=Q[Aa];var O=w[Aa];if(Q!==O)if(O&&(U(O)||(va=Array.isArray(O)))){var A=!1;if(va){va=!1;if(N&&Array.isArray(N))var D=N||[];else if(U(N)){D=N||{};Q[Aa]=D;continue}else D=[];B=D;D=ma(O,D,S);Q[Aa]=D}else{D=N&&U(N)?N:null;if(!D){A=!0;D={};for(var l in O)D[l]=O[l]}if(S){for(l in O)'undefined'!=typeof O[l]?Array.isArray(O[l])&&Array.isArray(D[l])?
...
typeof M[0]&&null!=M[0]&&'undefined'!=typeof M[0][r]&&'object'==typeof ba[0]&&'undefined'!=typeof ba[0][r]){B=Array.isArray(ba)?Array.from(ba):JSON.clone(ba);var H=0;for(Q=B.length;H<Q;++H)S.push(B[H][r]);Q=JSON.clone(M);var w=0;H=0;M=Q.length;for(var va=N||0,Aa=ba.length;va<Aa;++va)a:for(H=H||0;H<M;++H)if(Q[H][r]===ba[va][r]){-1<S.indexOf(Q[H][r])?(B[w]=Q[H],++w):-1==S.indexOf(Q[H][r])&&(S.push(Q[H][r]),B[w]=Q[H],++w);break a}else-1==S.indexOf(Q[H][r])&&(S.push(Q[H][r]),B.push(Q[H]));return B}return Array.isArray(M)&&
...
var N=null;H=0;for(M=B.length;H<M;++H)S.push(B[H][r]);for(H=0;H<M;++H)a:for(va=N||0,Aa=Q.length;va<Aa;++va)if(null!=Q[va]&&'undefined'!=typeof Q[va][r]&&Q[va][r]!==B[H][r]){if(-1==S.indexOf(Q[va][r])){B.push(Q[va]);S.push(Q[va][r]);N=va+1;M<Aa&&++M;break a}}else if(null!=Q[va]&&'undefined'!=typeof Q[va][r]&&Q[va][r]===B[H][r])N=va+1;else break a;return B}for(H=0;H<M.length;++H)if(S=null,'undefined'==typeof M||'object'!=typeof M[H]||Array.isArray(M[H])||null==M[H]||(S=Object.getOwnPropertyNames(M[H])),
...
function handleXhr(B,P,V,ma){if(!B)throw Error('No `xhr` object initiated');var U=null,M=null,ba=null,Q=null,S=null,r=V.$link||null,H=V.$form||null,w=null;delete V.$link;delete V.$form;H||r?r?(r.target=document.getElementById(r.id),w=gina.link.target,S=gina.link.id):(w=H.target,S=w.getAttribute('id')):(w=P,S=w.getAttribute('id'));var va=r&&P.getAttribute('data-gina-link-event-on-success')||r&&P.getAttribute('data-gina-link-event-on-error')?!0:!1,Aa=H&&w.getAttribute('data-gina-form-event-on-submit-success')||
...
return{setCulture:function(r,H){/\-/.test(H)?(V=H,ma=H.split(/\-/)[0]):ma=H;return this},format:function(r,H,w){var va=M[ma]||M.en,Aa=null;try{Aa=P(va.masks,U)}catch(T){P=(B='undefined'!==typeof module&&module.exports?!1:!0)?require('lib/merge'):require('./../lib/merge'),Aa=P(va.masks,U)}'undefined'!=typeof M[V]&&(va=M[V],'undefined'!=typeof M[V].mask&&(Aa=P(va.masks,U)));var N=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,
...
var G=w?0:r.getTimezoneOffset(),L={d:Aa,dd:A(Aa),ddd:va.dayNames[l],dddd:va.dayNames[l+7],m:y+1,mm:A(y+1),mmm:va.monthNames[y],mmmm:va.monthNames[y+12],yy:String(z).slice(2),yyyy:z,h:F%12||12,hh:A(F%12||12),H:F,HH:A(F),M:u,MM:A(u),s:v,ss:A(v),l:A(D,3),L:A(D),t:12>F?'a':'p',tt:12>F?'am':'pm',T:12>F?'A':'P',TT:12>F?'AM':'PM',Z:w?'UTC':(String(r).match(N)||['']).pop().replace(O,''),o:(0<G?'-':'+')+A(100*Math.floor(Math.abs(G)/60)+Math.abs(G)%60,4),S:['th','st','nd','rd'][3<Aa%10?0:(10!=Aa%100-Aa%10)*
Aa%10]};return H.replace(/d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g,function(T){return T in L?L[T]:T.slice(1,T.length-1)})},countDaysTo:ba,getDaysTo:function(r,H,w){if(H instanceof Date){H=ba(r,H);var va=r.getMonth(),Aa=r.getFullYear();r=r.getDate()+1;r=new Date(Aa,va,r);va=[];for(Aa=0;Aa<H;++Aa)'undefined'!=typeof w?va.push((new Date(r)).format(w)):va.push(new Date(r)),r.setDate(r.getDate()+1);return va||[]}throw Error('dateTo is not instance of Date() !');},getDaysInMonth:function(r){var H=
...
I.childNodes.length&&(I=n),n||k)){var Va=b.map(N(I,'script'),v);for(C=Va.length;pa>Y;Y++)n=I,Y!==Ca&&(n=b.clone(n,!0,!0),C&&b.merge(Va,N(n,'script'))),e.call(a[Y],n,Y);if(C)for(I=Va[Va.length-1].ownerDocument,b.map(Va,G),Y=0;C>Y;Y++)n=Va[Y],ua.test(n.type||'')&&!b._data(n,'globalEval')&&b.contains(I,n)&&(n.src?b._evalUrl&&b._evalUrl(n.src):b.globalEval((n.text||n.textContent||n.innerHTML||'').replace(Xb,'')));I=n=null}return a}function qa(a,c,e){for(var k=c?b.filter(c,a):a,n=0;null!=(c=k[n]);n++)e||
1!==c.nodeType||b.cleanData(N(c)),c.parentNode&&(e&&b.contains(c.ownerDocument,c)&&O(N(c,'script')),c.parentNode.removeChild(c));return a}function Da(a,c){a=b(c.createElement(a)).appendTo(c.body);c=b.css(a[0],'display');return a.detach(),c}function W(a){var c=Ka,e=Nb[a];return e||(e=Da(a,c),'none'!==e&&e||(gc=(gc||b("<iframe frameborder='0' width='0' height='0'/>")).appendTo(c.documentElement),c=(gc[0].contentWindow||gc[0].contentDocument).document,c.write(),c.close(),e=Da(a,c),gc.detach()),Nb[a]=
...
C)},guid:1,proxy:function(a,c){var e,k,n;return'string'==typeof c&&(n=a[c],c=a,a=n),b.isFunction(a)?(e=db.call(arguments,2),k=function(){return a.apply(c||this,e.concat(db.call(arguments)))},k.guid=a.guid=a.guid||b.guid++,k):void 0},now:function(){return+new Date},support:h});'function'==typeof Symbol&&(b.fn[Symbol.iterator]=xb[Symbol.iterator]);b.each('Boolean Number String Function Array Date RegExp Object Error Symbol'.split(' '),function(a,c){za['[object '+c+']']=c.toLowerCase()});var J=function(a){function c(K,
aa,oa,wa){var Ha,Ma,Ta,Za,Wa=aa&&aa.ownerDocument,kb=aa?aa.nodeType:9;if(oa=oa||[],'string'!=typeof K||!K||1!==kb&&9!==kb&&11!==kb)return oa;if(!wa&&((aa?aa.ownerDocument||aa:ac)!==tb&&Bc(aa),aa=aa||tb,fc)){if(11!==kb&&(Za=xd.exec(K)))if(Ha=Za[1])if(9===kb){if(!(Ma=aa.getElementById(Ha)))return oa;if(Ma.id===Ha)return oa.push(Ma),oa}else{if(Wa&&(Ma=Wa.getElementById(Ha))&&oc(aa,Ma)&&Ma.id===Ha)return oa.push(Ma),oa}else{if(Za[2])return Ac.apply(oa,aa.getElementsByTagName(K)),oa;if((Ha=Za[3])&&Pb.getElementsByClassName&&
aa.getElementsByClassName)return Ac.apply(oa,aa.getElementsByClassName(Ha)),oa}if(!(!Pb.qsa||bc[K+' ']||Tb&&Tb.test(K))){if(1!==kb){Wa=aa;var nb=K}else if('object'!==aa.nodeName.toLowerCase()){(Ta=aa.getAttribute('id'))?Ta=Ta.replace(yd,'\\$&'):aa.setAttribute('id',Ta=Ab);Za=Mc(K);Ha=Za.length;for(Ma=kd.test(Ta)?'#'+Ta:"[id='"+Ta+"']";Ha--;)Za[Ha]=Ma+' '+Va(Za[Ha]);nb=Za.join(',');Wa=Wc.test(K)&&sa(aa.parentNode)||aa}if(nb)try{return Ac.apply(oa,Wa.querySelectorAll(nb)),oa}catch(fb){}finally{Ta===
Ab&&aa.removeAttribute('id')}}}return hc(K.replace(Nc,'$1'),aa,oa,wa)}function e(){function K(oa,wa){return aa.push(oa+' ')>Fb.cacheLength&&delete K[aa.shift()],K[oa+' ']=wa}var aa=[];return K}function k(K){return K[Ab]=!0,K}function n(K){var aa=tb.createElement('div');try{return!!K(aa)}catch(oa){return!1}finally{aa.parentNode&&aa.parentNode.removeChild(aa)}}function C(K,aa){K=K.split('|');for(var oa=K.length;oa--;)Fb.attrHandle[K[oa]]=aa}function I(K,aa){var oa=aa&&K,wa=oa&&1===K.nodeType&&1===aa.nodeType&&
(~aa.sourceIndex||-2147483648)-(~K.sourceIndex||-2147483648);if(wa)return wa;if(oa)for(;oa=oa.nextSibling;)if(oa===aa)return-1;return K?1:-1}function Y(K){return function(aa){return'input'===aa.nodeName.toLowerCase()&&aa.type===K}}function pa(K){return function(aa){var oa=aa.nodeName.toLowerCase();return('input'===oa||'button'===oa)&&aa.type===K}}function Ca(K){return k(function(aa){return aa=+aa,k(function(oa,wa){for(var Ha,Ma=K([],oa.length,aa),Ta=Ma.length;Ta--;)oa[Ha=Ma[Ta]]&&(oa[Ha]=!(wa[Ha]=
oa[Ha]))})})}function sa(K){return K&&'undefined'!=typeof K.getElementsByTagName&&K}function Sa(){}function Va(K){for(var aa=0,oa=K.length,wa='';oa>aa;aa++)wa+=K[aa].value;return wa}function yb(K,aa,oa){var wa=aa.dir,Ha=oa&&'parentNode'===wa,Ma=Qb++;return aa.first?function(Ta,Za,Wa){for(;Ta=Ta[wa];)if(1===Ta.nodeType||Ha)return K(Ta,Za,Wa)}:function(Ta,Za,Wa){var kb,nb,fb,Jb=[Wb,Ma];if(Wa)for(;Ta=Ta[wa];){if((1===Ta.nodeType||Ha)&&K(Ta,Za,Wa))return!0}else for(;Ta=Ta[wa];)if(1===Ta.nodeType||Ha){if(fb=
Ta[Ab]||(Ta[Ab]={}),nb=fb[Ta.uniqueID]||(fb[Ta.uniqueID]={}),(kb=nb[wa])&&kb[0]===Wb&&kb[1]===Ma)return Jb[2]=kb[2];if(nb[wa]=Jb,Jb[2]=K(Ta,Za,Wa))return!0}}}function bb(K){return 1<K.length?function(aa,oa,wa){for(var Ha=K.length;Ha--;)if(!K[Ha](aa,oa,wa))return!1;return!0}:K[0]}function Hb(K,aa,oa,wa,Ha){for(var Ma,Ta=[],Za=0,Wa=K.length,kb=null!=aa;Wa>Za;Za++)(Ma=K[Za])&&(oa&&!oa(Ma,wa,Ha)||(Ta.push(Ma),kb&&aa.push(Za)));return Ta}function kc(K,aa,oa,wa,Ha,Ma){return wa&&!wa[Ab]&&(wa=kc(wa)),Ha&&
!Ha[Ab]&&(Ha=kc(Ha,Ma)),k(function(Ta,Za,Wa,kb){var nb,fb=[],Jb=[],cc=Za.length,Yb;if(!(Yb=Ta)){Yb=aa||'*';for(var ub=Wa.nodeType?[Wa]:Wa,tc=[],ic=0,qc=ub.length;qc>ic;ic++)c(Yb,ub[ic],tc);Yb=tc}Yb=!K||!Ta&&aa?Yb:Hb(Yb,fb,K,Wa,kb);ub=oa?Ha||(Ta?K:cc||wa)?[]:Za:Yb;if(oa&&oa(Yb,ub,Wa,kb),wa){var dc=Hb(ub,Jb);wa(dc,[],Wa,kb);for(Wa=dc.length;Wa--;)(nb=dc[Wa])&&(ub[Jb[Wa]]=!(Yb[Jb[Wa]]=nb))}if(Ta){if(Ha||K){if(Ha){dc=[];for(Wa=ub.length;Wa--;)(nb=ub[Wa])&&dc.push(Yb[Wa]=nb);Ha(null,ub=[],dc,kb)}for(Wa=
ub.length;Wa--;)(nb=ub[Wa])&&-1<(dc=Ha?Cc(Ta,nb):fb[Wa])&&(Ta[dc]=!(Za[dc]=nb))}}else ub=Hb(ub===Za?ub.splice(cc,ub.length):ub),Ha?Ha(null,Za,ub,kb):Ac.apply(Za,ub)})}function Gc(K){var aa,oa,wa=K.length,Ha=Fb.relative[K[0].type];var Ma=Ha||Fb.relative[' '];for(var Ta=Ha?1:0,Za=yb(function(nb){return nb===aa},Ma,!0),Wa=yb(function(nb){return-1<Cc(aa,nb)},Ma,!0),kb=[function(nb,fb,Jb){nb=!Ha&&(Jb||fb!==Bb)||((aa=fb).nodeType?Za(nb,fb,Jb):Wa(nb,fb,Jb));return aa=null,nb}];wa>Ta;Ta++)if(Ma=Fb.relative[K[Ta].type])kb=
[yb(bb(kb),Ma)];else{if(Ma=Fb.filter[K[Ta].type].apply(null,K[Ta].matches),Ma[Ab]){for(oa=++Ta;wa>oa&&!Fb.relative[K[oa].type];oa++);return kc(1<Ta&&bb(kb),1<Ta&&Va(K.slice(0,Ta-1).concat({value:' '===K[Ta-2].type?'*':''})).replace(Nc,'$1'),Ma,oa>Ta&&Gc(K.slice(Ta,oa)),wa>oa&&Gc(K=K.slice(oa)),wa>oa&&Va(K))}kb.push(Ma)}return bb(kb)}function lc(K,aa){var oa=0<aa.length,wa=0<K.length,Ha=function(Ma,Ta,Za,Wa,kb){var nb,fb,Jb=0,cc='0',Yb=Ma&&[],ub=[],tc=Bb,ic=Ma||wa&&Fb.find.TAG('*',kb),qc=Wb+=null==
tc?1:Math.random()||.1,dc=ic.length;for(kb&&(Bb=Ta===tb||Ta||kb);cc!==dc&&null!=(nb=ic[cc]);cc++){if(wa&&nb){var Xc=0;for(Ta||nb.ownerDocument===tb||(Bc(nb),Za=!fc);fb=K[Xc++];)if(fb(nb,Ta||tb,Za)){Wa.push(nb);break}kb&&(Wb=qc)}oa&&((nb=!fb&&nb)&&Jb--,Ma&&Yb.push(nb))}if(Jb+=cc,oa&&cc!==Jb){for(Xc=0;fb=aa[Xc++];)fb(Yb,ub,Ta,Za);if(Ma){if(0<Jb)for(;cc--;)Yb[cc]||ub[cc]||(ub[cc]=Yc.call(Wa));ub=Hb(ub)}Ac.apply(Wa,ub);kb&&!Ma&&0<ub.length&&1<Jb+aa.length&&c.uniqueSort(Wa)}return kb&&(Wb=qc,Bb=tc),Yb};
return oa?k(Ha):Ha}var wc,vb,hc,Bb,Ob,Rb,tb,jc,fc,Tb,ec,Sb,oc,Ab='sizzle'+1*new Date,ac=a.document,Wb=0,Qb=0,Hc=e(),pc=e(),bc=e(),uc=function(K,aa){return K===aa&&(Rb=!0),0},vc={}.hasOwnProperty,mc=[],Yc=mc.pop,zd=mc.push,Ac=mc.push,ld=mc.slice,Cc=function(K,aa){for(var oa=0,wa=K.length;wa>oa;oa++)if(K[oa]===aa)return oa;return-1},Ad=RegExp('[\\x20\\t\\r\\n\\f]+','g'),Nc=RegExp('^[\\x20\\t\\r\\n\\f]+|((?:^|[^\\\\])(?:\\\\.)*)[\\x20\\t\\r\\n\\f]+$','g'),Bd=RegExp('^[\\x20\\t\\r\\n\\f]*,[\\x20\\t\\r\\n\\f]*'),
...
'i')},Fd=/^(?:input|select|textarea|button)$/i,Gd=/^h\d$/i,Kc=/^[^{]+\{\s*\[native \w/,xd=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,Wc=/[+~]/,yd=/'|\\/g,xc=RegExp('\\\\([\\da-f]{1,6}[\\x20\\t\\r\\n\\f]?|([\\x20\\t\\r\\n\\f])|.)','ig'),yc=function(K,aa,oa){K='0x'+aa-65536;return K!==K||oa?aa:0>K?String.fromCharCode(K+65536):String.fromCharCode(K>>10|55296,1023&K|56320)},md=function(){Bc()};try{Ac.apply(mc=ld.call(ac.childNodes),ac.childNodes),mc[ac.childNodes.length].nodeType}catch(K){Ac={apply:mc.length?
function(aa,oa){zd.apply(aa,ld.call(oa))}:function(aa,oa){for(var wa=aa.length,Ha=0;aa[wa++]=oa[Ha++];);aa.length=wa-1}}}var Pb=c.support={};var Hd=c.isXML=function(K){return(K=K&&(K.ownerDocument||K).documentElement)?'HTML'!==K.nodeName:!1};var Bc=c.setDocument=function(K){var aa,oa;K=K?K.ownerDocument||K:ac;return K!==tb&&9===K.nodeType&&K.documentElement?(tb=K,jc=tb.documentElement,fc=!Hd(tb),(oa=tb.defaultView)&&oa.top!==oa&&(oa.addEventListener?oa.addEventListener('unload',md,!1):oa.attachEvent&&
...
Ha);for(;wa=wa.parentNode;)Wa.unshift(wa);for(wa=Ha;wa=wa.parentNode;)kb.unshift(wa);for(;Wa[Ma]===kb[Ma];)Ma++;return Ma?I(Wa[Ma],kb[Ma]):Wa[Ma]===ac?-1:kb[Ma]===ac?1:0},tb):tb};c.matches=function(K,aa){return c(K,null,null,aa)};c.matchesSelector=function(K,aa){if((K.ownerDocument||K)!==tb&&Bc(K),aa=aa.replace(Dd,"='$1']"),!(!Pb.matchesSelector||!fc||bc[aa+' ']||ec&&ec.test(aa)||Tb&&Tb.test(aa)))try{var oa=Sb.call(K,aa);if(oa||Pb.disconnectedMatch||K.document&&11!==K.document.nodeType)return oa}catch(wa){}return 0<
c(aa,tb,null,[K]).length};c.contains=function(K,aa){return(K.ownerDocument||K)!==tb&&Bc(K),oc(K,aa)};c.attr=function(K,aa){(K.ownerDocument||K)!==tb&&Bc(K);var oa=Fb.attrHandle[aa.toLowerCase()];oa=oa&&vc.call(Fb.attrHandle,aa.toLowerCase())?oa(K,aa,!fc):void 0;return void 0!==oa?oa:Pb.attributes||!fc?K.getAttribute(aa):(oa=K.getAttributeNode(aa))&&oa.specified?oa.value:null};c.error=function(K){throw Error('Syntax error, unrecognized expression: '+K);};c.uniqueSort=function(K){var aa,oa=[],wa=0,
Ha=0;if(Rb=!Pb.detectDuplicates,Ob=!Pb.sortStable&&K.slice(0),K.sort(uc),Rb){for(;aa=K[Ha++];)aa===K[Ha]&&(wa=oa.push(Ha));for(;wa--;)K.splice(oa[wa],1)}return Ob=null,K};var Zc=c.getText=function(K){var aa,oa='',wa=0;if(aa=K.nodeType)if(1===aa||9===aa||11===aa){if('string'==typeof K.textContent)return K.textContent;for(K=K.firstChild;K;K=K.nextSibling)oa+=Zc(K)}else{if(3===aa||4===aa)return K.nodeValue}else for(;aa=K[wa++];)oa+=Zc(aa);return oa};var Fb=c.selectors={cacheLength:50,createPseudo:k,
...
c.error(K[0]),K},PSEUDO:function(K){var aa,oa=!K[6]&&K[2];return Oc.CHILD.test(K[0])?null:(K[3]?K[2]=K[4]||K[5]||'':oa&&Ed.test(oa)&&(aa=Mc(oa,!0))&&(aa=oa.indexOf(')',oa.length-aa)-oa.length)&&(K[0]=K[0].slice(0,aa),K[2]=oa.slice(0,aa)),K.slice(0,3))}},filter:{TAG:function(K){var aa=K.replace(xc,yc).toLowerCase();return'*'===K?function(){return!0}:function(oa){return oa.nodeName&&oa.nodeName.toLowerCase()===aa}},CLASS:function(K){var aa=Hc[K+' '];return aa||(aa=new RegExp('(^|[\\x20\\t\\r\\n\\f])'+
K+'([\\x20\\t\\r\\n\\f]|$)'),Hc(K,function(oa){return aa.test('string'==typeof oa.className&&oa.className||'undefined'!=typeof oa.getAttribute&&oa.getAttribute('class')||'')}))},ATTR:function(K,aa,oa){return function(wa){wa=c.attr(wa,K);return null==wa?'!='===aa:aa?(wa+='','='===aa?wa===oa:'!='===aa?wa!==oa:'^='===aa?oa&&0===wa.indexOf(oa):'*='===aa?oa&&-1<wa.indexOf(oa):'$='===aa?oa&&wa.slice(-oa.length)===oa:'~='===aa?-1<(' '+wa.replace(Ad,' ')+' ').indexOf(oa):'|='===aa?wa===oa||wa.slice(0,oa.length+
1)===oa+'-':!1):!0}},CHILD:function(K,aa,oa,wa,Ha){var Ma='nth'!==K.slice(0,3),Ta='last'!==K.slice(-4),Za='of-type'===aa;return 1===wa&&0===Ha?function(Wa){return!!Wa.parentNode}:function(Wa,kb,nb){var fb,Jb;kb=Ma!==Ta?'nextSibling':'previousSibling';var cc=Wa.parentNode,Yb=Za&&Wa.nodeName.toLowerCase();nb=!nb&&!Za;var ub=!1;if(cc){if(Ma){for(;kb;){for(fb=Wa;fb=fb[kb];)if(Za?fb.nodeName.toLowerCase()===Yb:1===fb.nodeType)return!1;var tc=kb='only'===K&&!tc&&'nextSibling'}return!0}if(tc=[Ta?cc.firstChild:
cc.lastChild],Ta&&nb){fb=cc;var ic=fb[Ab]||(fb[Ab]={});var qc=ic[fb.uniqueID]||(ic[fb.uniqueID]={});var dc=qc[K]||[];ub=(Jb=dc[0]===Wb&&dc[1])&&dc[2];for(fb=Jb&&cc.childNodes[Jb];fb=++Jb&&fb&&fb[kb]||(ub=Jb=0)||tc.pop();)if(1===fb.nodeType&&++ub&&fb===Wa){qc[K]=[Wb,Jb,ub];break}}else if(nb&&(fb=Wa,ic=fb[Ab]||(fb[Ab]={}),qc=ic[fb.uniqueID]||(ic[fb.uniqueID]={}),dc=qc[K]||[],Jb=dc[0]===Wb&&dc[1],ub=Jb),!1===ub)for(;(fb=++Jb&&fb&&fb[kb]||(ub=Jb=0)||tc.pop())&&((Za?fb.nodeName.toLowerCase()!==Yb:1!==
fb.nodeType)||!++ub||(nb&&(ic=fb[Ab]||(fb[Ab]={}),qc=ic[fb.uniqueID]||(ic[fb.uniqueID]={}),qc[K]=[Wb,ub]),fb!==Wa)););return ub-=Ha,ub===wa||0===ub%wa&&0<=ub/wa}}},PSEUDO:function(K,aa){var oa,wa=Fb.pseudos[K]||Fb.setFilters[K.toLowerCase()]||c.error('unsupported pseudo: '+K);return wa[Ab]?wa(aa):1<wa.length?(oa=[K,K,'',aa],Fb.setFilters.hasOwnProperty(K.toLowerCase())?k(function(Ha,Ma){for(var Ta,Za=wa(Ha,aa),Wa=Za.length;Wa--;)Ta=Cc(Ha,Za[Wa]),Ha[Ta]=!(Ma[Ta]=Za[Wa])}):function(Ha){return wa(Ha,
0,oa)}):wa}},pseudos:{not:k(function(K){var aa=[],oa=[],wa=vb(K.replace(Nc,'$1'));return wa[Ab]?k(function(Ha,Ma,Ta,Za){var Wa;Ta=wa(Ha,null,Za,[]);for(Za=Ha.length;Za--;)(Wa=Ta[Za])&&(Ha[Za]=!(Ma[Za]=Wa))}):function(Ha,Ma,Ta){return aa[0]=Ha,wa(aa,null,Ta,oa),aa[0]=null,!oa.pop()}}),has:k(function(K){return function(aa){return 0<c(K,aa).length}}),contains:k(function(K){return K=K.replace(xc,yc),function(aa){return-1<(aa.textContent||aa.innerText||Zc(aa)).indexOf(K)}}),lang:k(function(K){return kd.test(K||
'')||c.error('unsupported lang: '+K),K=K.replace(xc,yc).toLowerCase(),function(aa){var oa;do if(oa=fc?aa.lang:aa.getAttribute('xml:lang')||aa.getAttribute('lang'))return oa=oa.toLowerCase(),oa===K||0===oa.indexOf(K+'-');while((aa=aa.parentNode)&&1===aa.nodeType);return!1}}),target:function(K){var aa=a.location&&a.location.hash;return aa&&aa.slice(1)===K.id},root:function(K){return K===jc},focus:function(K){return K===tb.activeElement&&(!tb.hasFocus||tb.hasFocus())&&!!(K.type||K.href||~K.tabIndex)},
enabled:function(K){return!1===K.disabled},disabled:function(K){return!0===K.disabled},checked:function(K){var aa=K.nodeName.toLowerCase();return'input'===aa&&!!K.checked||'option'===aa&&!!K.selected},selected:function(K){return K.parentNode&&K.parentNode.selectedIndex,!0===K.selected},empty:function(K){for(K=K.firstChild;K;K=K.nextSibling)if(6>K.nodeType)return!1;return!0},parent:function(K){return!Fb.pseudos.empty(K)},header:function(K){return Gd.test(K.nodeName)},input:function(K){return Fd.test(K.nodeName)},
button:function(K){var aa=K.nodeName.toLowerCase();return'input'===aa&&'button'===K.type||'button'===aa},text:function(K){var aa;return'input'===K.nodeName.toLowerCase()&&'text'===K.type&&(null==(aa=K.getAttribute('type'))||'text'===aa.toLowerCase())},first:Ca(function(){return[0]}),last:Ca(function(K,aa){return[aa-1]}),eq:Ca(function(K,aa,oa){return[0>oa?oa+aa:oa]}),even:Ca(function(K,aa){for(var oa=0;aa>oa;oa+=2)K.push(oa);return K}),odd:Ca(function(K,aa){for(var oa=1;aa>oa;oa+=2)K.push(oa);return K}),
lt:Ca(function(K,aa,oa){for(aa=0>oa?oa+aa:oa;0<=--aa;)K.push(aa);return K}),gt:Ca(function(K,aa,oa){for(oa=0>oa?oa+aa:oa;++oa<aa;)K.push(oa);return K})}};Fb.pseudos.nth=Fb.pseudos.eq;for(wc in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})Fb.pseudos[wc]=Y(wc);for(wc in{submit:!0,reset:!0})Fb.pseudos[wc]=pa(wc);Sa.prototype=Fb.filters=Fb.pseudos;Fb.setFilters=new Sa;var Mc=c.tokenize=function(K,aa){var oa,wa,Ha,Ma,Ta;if(Ma=pc[K+' '])return aa?0:Ma.slice(0);Ma=K;var Za=[];for(Ta=Fb.preFilter;Ma;){Wa&&
!(oa=Bd.exec(Ma))||(oa&&(Ma=Ma.slice(oa[0].length)||Ma),Za.push(wa=[]));var Wa=!1;(oa=Cd.exec(Ma))&&(Wa=oa.shift(),wa.push({value:Wa,type:oa[0].replace(Nc,' ')}),Ma=Ma.slice(Wa.length));for(Ha in Fb.filter)!(oa=Oc[Ha].exec(Ma))||Ta[Ha]&&!(oa=Ta[Ha](oa))||(Wa=oa.shift(),wa.push({value:Wa,type:Ha,matches:oa}),Ma=Ma.slice(Wa.length));if(!Wa)break}return aa?Ma.length:Ma?c.error(K):pc(K,Za).slice(0)};return vb=c.compile=function(K,aa){var oa,wa=[],Ha=[],Ma=bc[K+' '];if(!Ma){aa||=Mc(K);for(oa=aa.length;oa--;)Ma=
Gc(aa[oa]),Ma[Ab]?wa.push(Ma):Ha.push(Ma);Ma=bc(K,lc(Ha,wa));Ma.selector=K}return Ma},hc=c.select=function(K,aa,oa,wa){var Ha,Ma,Ta,Za,Wa,kb='function'==typeof K&&K,nb=!wa&&Mc(K=kb.selector||K);if(oa=oa||[],1===nb.length){if(Ma=nb[0]=nb[0].slice(0),2<Ma.length&&'ID'===(Ta=Ma[0]).type&&Pb.getById&&9===aa.nodeType&&fc&&Fb.relative[Ma[1].type]){if(aa=(Fb.find.ID(Ta.matches[0].replace(xc,yc),aa)||[])[0],!aa)return oa;kb&&(aa=aa.parentNode);K=K.slice(Ma.shift().value.length)}for(Ha=Oc.needsContext.test(K)?
0:Ma.length;Ha--&&(Ta=Ma[Ha],!Fb.relative[Za=Ta.type]);)if((Wa=Fb.find[Za])&&(wa=Wa(Ta.matches[0].replace(xc,yc),Wc.test(Ma[0].type)&&sa(aa.parentNode)||aa))){if(Ma.splice(Ha,1),K=wa.length&&Va(Ma),!K)return Ac.apply(oa,wa),oa;break}}return(kb||vb(K,nb))(wa,aa,!fc,oa,!aa||Wc.test(K)&&sa(aa.parentNode)||aa),oa},Pb.sortStable=Ab.split('').sort(uc).join('')===Ab,Pb.detectDuplicates=!!Rb,Bc(),Pb.sortDetached=n(function(K){return 1&K.compareDocumentPosition(tb.createElement('div'))}),n(function(K){return K.innerHTML=
"<a href='#'></a>",'#'===K.firstChild.getAttribute('href')})||C('type|href|height|width',function(K,aa,oa){return oa?void 0:K.getAttribute(aa,'type'===aa.toLowerCase()?1:2)}),Pb.attributes&&n(function(K){return K.innerHTML='<input/>',K.firstChild.setAttribute('value',''),''===K.firstChild.getAttribute('value')})||C('value',function(K,aa,oa){return oa||'input'!==K.nodeName.toLowerCase()?void 0:K.defaultValue}),n(function(K){return null==K.getAttribute('disabled')})||C('checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped',
function(K,aa,oa){var wa;return oa?void 0:!0===K[aa]?aa.toLowerCase():(wa=K.getAttributeNode(aa))&&wa.specified?wa.value:null}),c}(B);b.find=J;b.expr=J.selectors;b.expr[':']=b.expr.pseudos;b.uniqueSort=b.unique=J.uniqueSort;b.text=J.getText;b.isXMLDoc=J.isXML;b.contains=J.contains;var fa=function(a,c,e){for(var k=[],n=void 0!==e;(a=a[c])&&9!==a.nodeType;)if(1===a.nodeType){if(n&&b(a).is(e))break;k.push(a)}return k},Ba=function(a,c){for(var e=[];a;a=a.nextSibling)1===a.nodeType&&a!==c&&e.push(a);return e},
...
b._data(this),e=c[a+'queue'];var k=c[a+'queueHooks'];var n=b.timers,C=e?e.length:0;c.finish=!0;b.queue(this,a,[]);k&&k.stop&&k.stop.call(this,!0);for(k=n.length;k--;)n[k].elem===this&&n[k].queue===a&&(n[k].anim.stop(!0),n.splice(k,1));for(k=0;C>k;k++)e[k]&&e[k].finish&&e[k].finish.call(this);delete c.finish})}});b.each(['toggle','show','hide'],function(a,c){var e=b.fn[c];b.fn[c]=function(k,n,C){return null==k||'boolean'==typeof k?e.apply(this,arguments):this.animate(Fa(c,!0),k,n,C)}});b.each({slideDown:Fa('show'),
slideUp:Fa('hide'),slideToggle:Fa('toggle'),fadeIn:{opacity:'show'},fadeOut:{opacity:'hide'},fadeToggle:{opacity:'toggle'}},function(a,c){b.fn[a]=function(e,k,n){return this.animate(c,e,k,n)}});b.timers=[];b.fx.tick=function(){var a=b.timers,c=0;for(Fc=b.now();c<a.length;c++){var e=a[c];e()||a[c]!==e||a.splice(c--,1)}a.length||b.fx.stop();Fc=void 0};b.fx.timer=function(a){b.timers.push(a);a()?b.fx.start():b.timers.pop()};b.fx.interval=13;b.fx.start=function(){ad||=B.setInterval(b.fx.tick,b.fx.interval)};
...
!0:!1:S[arguments[0]][arguments[1]]=arguments[2]}return N};N.find=function(){ba=!1;'boolean'==typeof arguments[arguments.length-1]&&(ba=arguments[arguments.length-1],delete arguments[arguments.length-1],--arguments.length);var A=null,D=null,l=null;try{A=JSON.stringify(arguments),D=JSON.parse(A),l=D.count()}catch(la){throw Error('filter must be an object\n'+la.stack);}if('undefined'!=typeof D&&0<l){1<l&&(ba=!0);l=A=null;var y=0,z=Array.isArray(this)?this:JSON.clone(B),F=[],u='',v=null,G=S,L=P.searchOptionRules,
T=null,qa=[],Da=function(la,ta,Ea,Qa,La){if(null===la&&null===Ea)++Qa;else if(la&&-1<r.indexOf(u)&&'not null'==u&&'undefined'!=typeof Ea&&'object'!==typeof Ea&&'null'!=Ea&&'undefined'!=Ea)0>F.indexOf(Ea)&&++Qa;else if('undefined'!=typeof Ea&&'object'!==typeof Ea&&/(<|>|=)/.test(la)&&!/undefined|function/.test(typeof Ea))ta=la,La=Ea+la,'string'==typeof la&&'string'==typeof Ea&&(La=la.replace(/^(<=|>=|!==|!=|===|!==)/g,''),'string'!=typeof Ea||/^"(.*)"$/.test(La)||(la=la.replace(La,'"'+La+'"')),La=
'"'+Ea+'"'+la,la=ta),/(\d{4})\-(\d{2})\-(\d{2})(\s+|T)(\d{2}):(\d{2}):(\d{2})/.test(Ea)&&/(\d{4})\-(\d{2})\-(\d{2})(\s+|T)(\d{2}):(\d{2}):(\d{2})/.test(la)?H(Ea.replace(/(\d{4})\-(\d{2})\-(\d{2})(\s+|T)(\d{2}):(\d{2}):(\d{2})/,'new Date("$&")')+la.replace(/(\d{4})\-(\d{2})\-(\d{2})(\s+|T)(\d{2}):(\d{2}):(\d{2})/,'new Date("$&")'))&&++Qa:H(La)&&++Qa;else if('undefined'!=typeof Ea&&'object'!==typeof Ea&&Ea===la&&!G||'undefined'!=typeof Ea&&'object'!==typeof Ea&&Ea===la&&'undefined'==typeof G[ta])++Qa;
else if('undefined'!=typeof Ea&&'object'!==typeof Ea&&G&&'undefined'!=typeof G[ta]){var Fa=0;var Na=G[ta].count();for(var Ia in G[ta])La[Ia][G[ta][Ia]].re=La[Ia][G[ta][Ia]].re.replace(/%s/,la),v=La[Ia][G[ta][Ia]].modifiers?new RegExp(La[Ia][G[ta][Ia]].re,La[Ia][G[ta][Ia]].modifiers):new RegExp(La[Ia][G[ta][Ia]].re),v.test(Ea)&&++Fa;Fa==Na&&++Qa}return{matched:Qa}},W=function(la,ta,Ea,Qa){var La=ta.split(/\./g);La=La[La.length-1];v=new RegExp('("'+La+'":\\w+)');La=null;try{Ea&&(La=eval('_content.'+
ta))}catch(Fa){}La&&(Array.isArray(La)?La=La[1].split(/:/)[1]:'string'==typeof La&&/:/.test(La)&&(La=La.split(/:/)[1]),/(<|>|=)/.test(la)?/(\d{4})\-(\d{2})\-(\d{2})(\s+|T)(\d{2}):(\d{2}):(\d{2})/.test(La)&&/(\d{4})\-(\d{2})\-(\d{2})(\s+|T)(\d{2}):(\d{2}):(\d{2})/.test(la)?H(La.replace(/(\d{4})\-(\d{2})\-(\d{2})(\s+|T)(\d{2}):(\d{2}):(\d{2})/,'new Date("$&")')+la.replace(/(\d{4})\-(\d{2})\-(\d{2})(\s+|T)(\d{2}):(\d{2}):(\d{2})/,'new Date("$&")'))&&++Qa:H(La+la)&&++Qa:La==la&&++Qa);return{matched:Qa}},
ka=function(la,ta,Ea,Qa,La){ta=ta.split(/\[\*\]/g);La=ta[0].replace(/\[\*\]/,'');Ea=Ea[La];ta=ta[1];/^\./.test(ta)&&(ta=ta.substr(1));La=0;if(Ea)for(var Fa=0,Na=Ea.length;Fa<Na&&!(qa=/\./.test(ta)?W(la,ta,Ea[Fa],La):Da(la,ta,Ea[Fa],La,L),La=qa.matched,0<La);++Fa);return{matched:Qa+La}},ha;for(ha in z)if(z[ha]||(z[ha]={}),!/undefined|function/.test(typeof z[ha]))for(let la=0,ta=D.count();la<ta;++la){A=D[la];l=A.count();T=0;for(var xa in A){if('undefined'==typeof A[xa])throw Error('filter `'+xa+'` cannot be left undefined');
u=null===A[xa]||/(boolean|number)/.test(typeof A[xa])?A[xa]:A[xa].toLocaleLowerCase();qa=/\./.test(xa)?/\[\*\]/.test(xa)?ka(A[xa],xa,z[ha],T,0):W(A[xa],xa,z[ha],T):Da(A[xa],xa,z[ha][xa],T,L);T=qa.matched}if(T==l)if(ba&&Q&&0>w.indexOf(z[ha]._uuid)||Q||!ba){if(!ba||ba&&0>F.indexOf(z[ha]._uuid)||Q)F[y]=z[ha],++y}else ba&&!Q&&0>F.indexOf(z[ha]._uuid)&&(F[y]=z[ha],++y)}}else F=B;S=null;F.insert=N.insert;F.notIn=N.notIn;F.find=this.find;F.update=N.update;F.replace=N.replace;F.or=N.or;F.findOne=N.findOne;
...
try{var D=Object.keys(A)[0],l={};l[D]='desc';return N.find(A).orderBy(l).limit(1)[0][D]}catch(y){throw y;}};var O=function(A,D){if('object'!=typeof A)throw Error('`filter` parametter must be an object or an array');var l={},y=null,z=null,F=y=null;y=[];if(0==A.count())return null;l.asc=function(u,v){var G=v.map(function(L,T){var qa={};qa.index=T;qa[u]=L[u];return qa});G.sort(function(L,T){var qa=function(Da,W){/^(true|false)$/i.test(Da)&&(Da=/true/i.test(Da)?1:0);/^(true|false)$/i.test(W)&&(W=/true/i.test(W)?
1:0);return'string'==typeof Da&&''!=Da||'string'==typeof W?('number'==typeof Da&&(Da=''+Da),'number'==typeof W&&(W=''+W),Da.localeCompare(W,void 0,{sensitivity:'case',caseFirst:'upper'})):Da>W?1:Da<W?-1:0};return'object'==typeof L?qa(L[u],T[u]):qa(L,T)});return G.map(function(L,T,qa){return v[L.index]})};l.desc=function(u,v){return l.asc(u,v).reverse()};y=function(u,v){var G=[],L=[];if(Array.isArray(v))for(var T=0,qa=v.length;T<qa;++T)G[T]=Object.keys(v[T])[0],L[T]=v[T][G[T]];else for(qa in T=0,v)G[T]=
qa,L[T]=v[qa],++T;z=function(Da,W,ka,ha,xa){var la='desc'==ha[xa]?1:0,ta,Ea=ta=null;return'string'==typeof Da[ka[xa]]&&''!=Da[ka[xa]]?(ta=Da[ka[xa]].localeCompare(W[ka[xa]]),0==la&&0!=ta?0>ta?-1:1:0!=ta?0>ta?1:-1:ka.length-1>xa?z(Da,W,ka,ha,xa+1):0):'number'==typeof Da[ka[xa]]||'number'==typeof W[ka[xa]]?(ta=(''+Da[ka[xa]]).localeCompare(''+W[ka[xa]],void 0,{numeric:!0}),0==la&&0!=ta?0>ta?-1:1:0!=ta?0>ta?1:-1:ka.length-1>xa?z(Da,W,ka,ha,xa+1):0):'boolean'==typeof Da[ka[xa]]||'boolean'==typeof W[ka[xa]]?
('boolean'==typeof Da[ka[xa]]&&(ta=Da[ka[xa]]?1:0),'boolean'==typeof W[ka[xa]]&&(Ea=W[ka[xa]]?1:0),ta>Ea?0==la?1:-1:ta<Ea?0==la?-1:1:ka.length-1>xa?z(Da,W,ka,ha,xa+1):0):Da[ka[xa]]>W[ka[xa]]?0==la?1:-1:Da[ka[xa]]<W[ka[xa]]?0==la?-1:1:ka.length-1>xa?z(Da,W,ka,ha,xa+1):0};return u.sort(function(Da,W){return z(Da,W,G,L,0)})};Array.isArray(A)||1<A.count()?y=y(D,A):(F=Object.keys(A)[0],y=A[F],y=l[y](F,D));y.find=N.find;y.findOne=N.findOne;y.limit=N.limit;y.notIn=N.notIn;y.insert=N.insert;y.update=N.update;
...
isOnException=!0;xa=this.getResponseHeader('Content-Type');if(/\/json/.test(xa))xa=JSON.parse(this.responseText),'undefined'==typeof xa.status&&(xa.status=this.status);else if(xa={status:T.status,message:''},/^(\{|\[)/.test(T.responseText))try{xa=M(xa,JSON.parse(T.responseText))}catch(ta){xa=M(xa,ta)}return ha(xa)},T.onload=function(){try{W=this.responseText;var xa=this.getResponseHeader('Content-Type');if(/\/json/.test(xa))W=JSON.parse(this.responseText),'undefined'==typeof W.status&&(W.status=this.status);
else if(W={status:T.status,message:''},/^(\{|\[)/.test(T.responseText))try{W=M(W,JSON.parse(T.responseText))}catch(la){W=M(W,la)}return ha(W)}catch(la){throw la;}},B?T.send(u):T.send())}else console.debug('stopping on errors ...'),triggerEvent(gina,this.target,'asyncCompleted.'+F,r[this.name])},N=async function(l,y,z,F){var u=(new (require(_(GINA_FRAMEWORK_DIR+'/core/config.js',!0)))).getInstance(),v=null,G=null,L=null,T=getContext('bundle');if(/@/.test(l.url)){var qa=l.url.split(/@/);G=qa[0];L=qa[1];
getConfig(T,'app');try{u.bundle!==L&&(v=getConfig(T,'app').proxy[L])}catch(ha){throw Error('Could not retrieve `proxy` configuration for bundle `'+L+'`. Please check your `/config/app.json`.\n'+ha.stack);}qa=null}else throw Error('external url/domain not  handled at this moment, please contact us if you need support for it.');qa=JSON.clone(ba.getRoute(l.url,l.data));var Da=u[L][u.env];v||(u.bundle==L&&(v=getConfig(T,'settings').server.credentials,l.ca=v.ca||null,l.hostname=Da.server.scheme+'://'+
Da.host,l.port=Da.port[Da.server.protocol][Da.server.scheme],l.protocol=Da.server.protocol,l.rejectUnauthorized=!1),v={ca:l.ca,hostname:l.hostname,port:l.port,path:l.path},'undefined'!=typeof l.protocol&&(v.protocol=l.protocol),'undefined'!=typeof l.rejectUnauthorized&&(v.rejectUnauthorized=l.rejectUnauthorized));G={method:qa.method,requirements:qa.requirements,namespace:qa.namespace||void 0,url:decodeURI(qa.url),rule:G+'@'+L,param:JSON.clone(qa.param),middleware:JSON.clone(qa.middleware),bundle:qa.bundle,
isXMLRequest:y.isXMLRequest,isWithCredentials:y.isWithCredentials};L=G.rule.replace('@'+L,'')||'_common';L={template:'undefined'!=typeof Da.content.templates?Da.content.templates[L]||Da.content.templates._common:void 0,cacheless:Da.cacheless};L=M(L,G);Da=JSON.clone(Da);L.conf=Da;L.conf.content.routing[L.rule].param=G.param;L.template&&'undefined'==typeof L.template.ginaLoader&&(L.template.ginaLoader=L.conf.content.templates._common.ginaLoader);L.conf.content.routing[L.rule].param=G.param;delete L.middleware;
delete L.param;delete L.requirements;Da=new (require(_(GINA_FRAMEWORK_DIR+'/core/controller/controller.js'),!0))(L);Da.name=qa.param.control;Da.setOptions(y,z,F,L);y='object'==typeof l.data&&0<l.data.count()?l.data:{};if(/^get|delete|put$/i.test(l.method)){z=0;for(let ha in y)'object'==typeof y[ha]&&encodeRFC5987ValueChars(JSON.stringify(y[ha])),z++}v.method=l.method;v.path=qa.url;l=require('util').promisify;var W={isValid:!1},ka=!1;await l(Da.query)(v,y).then(function(ha){W=ha}).catch(function(ha){ka=
ha});ka&&(console.error(ka),W.error=ka);return W},O=null;O=U?Aa:N;var A=function(l,y){var z=null,F=null;'undefined'==typeof r[l]&&'undefined'!=typeof y&&(r[l]=z=y);if('object'==typeof r[l])try{z=JSON.parse(JSON.stringify(r[l]))}catch(u){z=r[l]}else z=r[l];F='';U&&'undefined'!=typeof P&&(F=P[l].getAttribute('data-gina-form-field-label')||'');r[l]={target:U&&'undefined'!=typeof P?P[l]:null,name:l,value:z,valid:!1,label:F,exclude:!1};r[l].is=function(u,v,G){var L=!1,T='undefined'!=typeof window&&'undefined'!=
typeof window._currentValidatorAlias?window._currentValidatorAlias:'is';'undefined'!=typeof window&&window._currentValidatorAlias&&delete window._currentValidatorAlias;var qa=r[this.name].errors||{};S.data[this.name]=r[this.name].value;'undefined'==typeof qa.isRequired&&''==this.value&&!/^false$/i.test(this.value)&&0!=this.value||!qa.isRequired&&''==this.value&&!/^false$/i.test(this.value)&&0!=this.value?L=!0:qa.isRequired||'string'!=typeof this.value||''!=this.value||(L=!0);if(!L&&/^(true|false)$/i.test(u))L=
u;else if(!L){var Da=null,W=null;if(/[!=>><a-z 0-9]+/i.test(u)){if((W=u.match(/\${0}[-_,.\[\]a-z0-9]+/ig))&&0<W.length){for(var ka=0,ha=W.length;ka<ha;++ka)'undefined'!=typeof r[W[ka]]&&W[ka]&&(Da=new RegExp('\\$'+W[ka]+'(?!\\S+)','g'),u=''==r[W[ka]].value?u.replace(Da,'""'):'string'==typeof r[W[ka]].value?u.replace(Da,'"'+r[W[ka]].value+'"'):u.replace(Da,r[W[ka]].value));try{u=u.replace(/(\(|\)|return)/g,''),L=/^\//.test(u)?eval(u+'.test("'+this.value+'")'):eval(u)}catch(xa){throw Error(xa.stack||
xa.message);}}}else if(u instanceof RegExp)L=u.test(this.value)?!0:!1;else if('boolean'==typeof u)L=u?!0:!1;else try{/\/(.*)\//.test(u)?(Da=u.match(/\/(.*)\//).pop(),W=u.replace('/'+Da+'/',''),L=(new RegExp(Da,W)).test(this.value)):L=eval(u)}catch(xa){throw Error(xa.stack||xa.message);}}L?L&&'undefined'!=typeof qa[T]&&delete qa[T]:(qa[T]=D(this.error||v||S.errorLabels[T],this),'undefined'!=typeof G&&(qa.stack=G));this.valid=L;0<qa.count()&&(this.errors=qa);return r[this.name]};r[l].set=function(u){this.value=
...
!1}(u=null!==u?!0:!1)?u&&'undefined'!=typeof v.isBoolean&&delete v.isBoolean:v.isBoolean=D(this.error||S.errorLabels.isBoolean,this);this.valid=u;0<v.count()&&(this.errors=v);return r[this.name]};r[l].isNumber=function(u,v){var G=this.value,L=!1,T=!0,qa=!0,Da=r[this.name].errors||{};try{'string'==typeof G&&/,|\./g.test(G)?G=S.data[this.name]=this.value=parseFloat(G.replace(/,/g,'.').replace(/\s+/g,'')):'string'==typeof G&&''!=G&&(G=S.data[this.name]=this.value=parseInt(G.replace(/\s+/g,'')))}catch(ka){Da.isNumber=
D(this.error||S.errorLabels.isNumber,this),this.valid=!1,0<Da.count()&&(this.errors=Da)}if(+G===+G&&(L=!0,!Da.isRequired&&''!=G)){var W=G.toString().length;u&&'number'==typeof u&&W<u&&(T=!1,this.size=u);v&&'number'==typeof v&&W>v&&(qa=!1,this.size=v)}L&&T&&qa||(L||(Da.isNumber=D(this.error||S.errorLabels.isNumber,this)),T&&qa||(T||(Da.isNumberLength=D(this.error||S.errorLabels.isNumberMinLength,this)),qa||(Da.isNumberLength=D(this.error||S.errorLabels.isNumberMaxLength,this)),u===v&&(Da.isNumberLength=
D(this.error||S.errorLabels.isNumberLength,this))),L=!1);L&&'undefined'!=typeof Da.isNumberLength&&delete Da.isNumberLength;this.valid=L;this.value=S.data[this.name]=''!=G?Number(G):G;0<Da.count()&&(this.errors=Da);return r[this.name]};r[l].toInteger=function(){var u=this.value,v=r[this.name].errors||{};if(u)try{this.value=S.data[this.name]=Math.round(u)}catch(G){v.toInteger=D(this.error||S.errorLabels.toInteger,this),this.valid=!1,0<v.count()&&(this.errors=v)}return r[this.name]};r[l].isInteger=
function(u,v){var G=this.value,L=!1,T=!0,qa=!0,Da=r[this.name].errors||{};+G===+G&&0===G%1&&(L=!0,Da.isRequired||''==G||(u&&'number'==typeof u&&G.length<u&&(T=!1,this.size=u),v&&'number'==typeof v&&G.length>v&&(qa=!1,this.size=v)));L&&T&&qa||(L||(Da.isInteger=D(this.error||S.errorLabels.isInteger,this)),T&&qa||(T||(Da.isIntegerLength=D(this.error||S.errorLabels.isIntegerMinLength,this),L=!1),qa||(Da.isIntegerLength=D(this.error||S.errorLabels.isIntegerMaxLength,this),L=!1),u===v&&(Da.isIntegerLength=
D(this.error||S.errorLabels.isIntegerLength,this),L=!1)));this.valid=L;this.value=S.data[this.name]=Number(G);0<Da.count()&&(this.errors=Da);return r[this.name]};r[l].toFloat=function(u){'string'==typeof this.value&&(this.value=this.value.replace(/\s+/g,''),/,/.test(this.value)&&!/\./.test(this.value)?this.value=this.value.replace(/,/g,'.'):this.value=this.value.replace(/,/g,''));var v=S.data[this.name]=this.value,G=r[this.name].errors||{},L=!0;u?this.decimals=parseInt(u):'undefined'==typeof this.decimals&&
(this.decimals=2);if(v)if(this.isNumber().valid)try{Number.isFinite(v)||(v=this.value=S.data[this.name]=new Number(parseFloat(v.match(/[0-9.,]+/g).join('').replace(/,/,'.')))),U&&this.target.setAttribute('value',v)}catch(T){L=!1,G.toFloat=D(this.error||S.errorLabels.toFloat,this),this.valid=!1,0<G.count()&&(this.errors=G)}else L=!1,G.toFloat=D(this.error||S.errorLabels.toFloatNAN,this);else return r[this.name];this.decimals&&v&&!G.toFloat&&(this.value=S.data[this.name]=parseFloat(this.value.toFixed(this.decimals)));
this.valid=L;0<G.count()&&(this.errors=G);return r[this.name]};r[l].isFloat=function(u){'string'==typeof this.value&&(this.value=this.value.replace(/\s+/g,''));var v=S.data[this.name]=this.value;u=r[this.name].errors||{};'string'==typeof v&&/\./.test(v)&&Number.isFinite(Number(v));'string'==typeof v&&/,/g.test(v)&&(v=this.value=S.data[this.name]=Number(v.replace(/,/g,'.')));Number(v)===v&&0!==v%1?(this.value=S.data[this.name]=Number(v),v=!0):v=!1;u.isRequired||''!=this.value||(v=!0);v||(u.isFloat=
...
/true/.test(u[v].value)?!0:!1:this.value=S.data[this.name]=u[v].value;this.valid=!0;break}}u='undefined'==typeof this.value||null==this.value||''==this.value||/^\s+/.test(this.value)?!1:!0;v=r[this.name].errors||{};u?u&&'undefined'!=typeof v.isRequired&&delete v.isRequired:v.isRequired=D(this.error||S.errorLabels.isRequired,this);this.valid=u;0<v.count()&&(this.errors=v);return r[this.name]};r[l].isString=function(u,v){var G=S.data[this.name]=this.value,L=!1,T=!0,qa=!0,Da=r[this.name].errors||{};
'string'!=typeof G||Da.isRequired||''==G||(L=!0,u&&'number'==typeof u&&G.length<u&&(T=!1,this.size=u),v&&'number'==typeof v&&G.length>v&&(qa=!1,this.size=v));L&&T&&qa||(!L&&Da.isRequired&&''==G?(L=!1,Da.isString=D(this.error||S.errorLabels.isString,this)):L||Da.isRequired||(L=!0),T&&qa||(L=!1,T||(Da.isStringLength=D(this.error||S.errorLabels.isStringMinLength,this)),qa||(Da.isStringLength=D(this.error||S.errorLabels.isStringMaxLength,this)),u===v&&(Da.isStringLength=D(this.error||S.errorLabels.isStringLength,
this))));this.valid=L;0<Da.count()&&(this.errors=Da);return r[this.name]};r[l].isDate=function(u){var v=this.value,G=!1,L=r[this.name].errors||{},T=null;if(!v||''==v||/NaN|Invalid Date/i.test(v))return/NaN|Invalid Date/i.test(v)&&(console.warn('[FormValidator::isDate] Provided value for field `'+this.name+'` is not allowed: `'+v+'`'),L.isDate=D(this.error||S.errorLabels.isDate,this)),this.valid=G,0<L.count()&&(this.errors=L),r[this.name];if('undefined'==typeof u||'undefined'!=typeof u&&/true/i.test(u))u=
'yyyy-mm-dd';if(v instanceof Date)v=v.format(u);else{try{T=u.match(/[^\/\- ]+/g)}catch(ha){throw Error('[FormValidator::isDate] Provided mask not allowed: `'+u+'`');}try{v=v.match(/[^\/\- ]+/g);var qa={},Da;var W=0;for(Da=T.length;W<Da;++W)qa[T[W]]=v[W];for(var ka in qa)u=u.replace(new RegExp(ka,'g'),qa[ka])}catch(ha){throw Error('[FormValidator::isDate] Provided value not allowed: `'+v+'`'+ha);}v=this.value=S.data[this.name]=new Date(u);if(/Invalid Date/i.test(v)||!1===v instanceof Date)return L.isRequired||
''!=this.value?L.isDate=D(this.error||S.errorLabels.isDate,this):G=!0,this.valid=G,0<L.count()&&(this.errors=L),r[this.name];G=!0}this.valid=G;return v};r[l].format=function(u,v){var G=this.value;return G?G.format(u,v):r[this.name]};r[l].setFlash=function(u,v){'undefined'!=typeof v&&''!=v&&(this.error=v);return r[this.name]};r[l].setLabel=function(u){'undefined'!=typeof u&&''!=u&&(this.label=u);return r[this.name]};r[l].trim=function(u){if('boolean'==typeof u&&u)return this.value=this.value.replace(/^\s+|\s+$/,
...
getContext('gina').plugins,U=V.Validator);P.getUrlProps=function(r,H){var w={};if(B){var va=window.gina.config;w.hostname=va.hostname;'undefined'!=typeof r&&(r=this.getRoute('webroot@'+r),w.hostname=r.hostname,w.host=r.host,w.webroot=r.webroot)}else va=getContext('gina').config,'undefined'!=typeof getContext('argvFilename')&&(va.getRouting=getContext('gina').Config.instance.getRouting),'undefined'==typeof r&&(r=va.bundle),'undefined'==typeof H&&(H=va.env),w.hostname=va.envConf[r][H].hostname,w.host=
va.envConf[r][H].host,w.webroot=va.envConf[r][H].server.webroot;return w};P.compareUrls=async function(r,H,w,va,Aa){'undefined'==typeof w&&(w={routing:{}});if(/,/.test(H)){var N=0;H=H.split(/,/g);for(var O=H.length,A={past:!1,request:w};N<O&&!A.past;)A=await M(r,H[N],w,va,Aa),++N;return A}return await M(r,H,w,va,Aa)};var M=async function(r,H,w,va,Aa){var N=null;try{N=r.url.split(/\//)}catch(T){console.warn(T),N=['']}H=H.split(/\//);var O=0,A=0,D=H.length,l=0,y={},z=0,F=w.method.toLowerCase(),u='get';
try{u=r.method.toLowerCase()}catch(T){}var v=!1;if('undefined'!=typeof r.requirements&&/get|delete/i.test(F)&&'undefined'!=typeof w[F]||'undefined'!=typeof r.requirements&&/get/i.test(F)&&/delete/i.test(u)){/get/i.test(F)&&/delete/i.test(u)&&(F=u);if(/^(delete)$/i.test(F)&&N.length===H.length){'undefined'==typeof w[F]&&(w[F]={});for(let T=0,qa=H.length;T<qa;T++)if(N[T]===H[T])++l;else if(u=H[T].substr(1),'undefined'!=typeof r.requirements[u]){u=r.requirements[u];if(/^\//.test(u))u=u.substr(1,u.lastIndexOf('/')-
1);else if(/^validator::/.test(u)&&await ba(H[T],N[T],r,w,va,Aa)){++l;continue}/^:/.test(H[T])&&'undefined'!=typeof u&&(new RegExp(u)).test(N[T])&&(++l,w[F][H[T].substr(1)]=N[T])}v=!0}for(var G in w[F])'undefined'!=typeof r.requirements[G]&&0>H.indexOf(':'+G)&&(H[A]=':'+G,++A,N[O]=w[F][G],++O,v||N.length!==H.length||++D)}if(!v&&N.length===H.length)for(;z<D;++z)N[z]===H[z]?++l:l==z&&/:/.test(H[z])&&await ba(H[z],N[z],r,w,va,Aa)&&++l;if('undefined'!=typeof r.requirements&&F==r.method.toLowerCase()&&
!v&&l>=D)for(G=Object.getOwnPropertyNames(r.requirements),O=0,H.join(',').match(/:[-_a-z0-9]+/g);O<G.length;){A=G[O];if('undefined'==typeof r.param[A]&&/^validator::/i.test(r.requirements[A])){if(H.length!=N.length)break;var L=H.join(',').match(/:[-_a-z0-9]+/g);let T=r.requirements[A];z={};u={};v={};try{u=JSON.parse(T.split(/::/).splice(1)[0].replace(/([^:"\s+](\w+)):/g,'"$1":').replace(/([^:"\s+](\w+))\s+:/g,'"$1":'))}catch(qa){throw qa;}if('undefined'!=typeof u.query&&'undefined'!=typeof u.query.data){z=
u.query.data;for(let qa in z)0>L.indexOf(z[qa])&&delete z[qa];for(let qa=0,Da=H.length;qa<Da;qa++)/^:/.test(H[qa])&&(L=H[qa].replace(/^:/,''),''!=L&&'undefined'!=typeof N[qa]&&(z[L]=N[qa],'undefined'==typeof w.params[L]&&(w.params[L]=N[qa])))}z=ma(z,JSON.clone(w[F])||{});'undefined'==typeof z[A]&&(z[A]=null);v[A]=u;_validator=B?new U(z):new U('routing',z,null,v);if(0==u.count()){console.error('Route validation failed '+r.rule);--l;O++;continue}for(let qa in u)if('undefined'!=typeof u[qa].data&&(u[qa].data=
z),v=Array.isArray(u[qa])?await _validator[A][qa].apply(_validator[A],u[qa]):await _validator[A][qa](u[qa],w,va,Aa),!v.isValid&&(--l,'undefined'!=typeof v.error))throw v.error;}O++}y.past=l===D?!0:!1;y.past&&(w.routing=S(r,w[F]),y.request=w);return y},ba=async function(r,H,w,va,Aa,N){var O=-1,A=r.match(/:\w+/g);O=new RegExp(r,'g');var D=null,l=null,y=null;D=!1;var z=D=l=l=null,F=null,u=va.method.toLowerCase();if(!A.length)return!1;w.param.path&&O.test(w.param.path)&&(w.param.path=w.param.path.replace(O,
...
typeof va[u]&&(va[u]={});y=A[O].substr(1);O=w.requirements[y];if(/^\//.test(O))D=O.match(/\/(.*)\//).pop(),l=O.replace('/'+D+'/',''),D=(new RegExp(D,l)).test(H);else if(/^validator::/.test(O)&&H){l={};D={};z={};F='';r.replace(new RegExp('[^'+y+']','g'),function(qa){F+=qa});l[y]=H.replace(new RegExp(F,'g'),'');try{D=JSON.parse(O.split(/::/).splice(1)[0].replace(/([^:"\s+](\w+)):/g,'"$1":').replace(/([^:"\s+](\w+))\s+:/g,'"$1":'))}catch(qa){throw qa;}'undefined'!=typeof D.query&&'undefined'!=typeof D.query.data&&
r==D.query.data[Object.keys(D.query.data)[0]]&&(D.query.data[Object.keys(D.query.data)[0]]=l[y],va.params[y]=l[y]);z[y]=D;l=new U('routing',l,null,z);if(0==D.count())return console.error('Route validation failed '+w.rule),!1;for(var v in D)Array.isArray(D[v])?await l[y][v].apply(l[y],D[v]):await l[y][v](D[v],va,Aa,N);D=l.isValid()}else D=(new RegExp(w.requirements[y])).test(H);if('undefined'!=typeof w.param[y]&&'undefined'!=typeof w.requirements&&'undefined'!=typeof w.requirements[y]&&'undefined'!=
typeof va.params&&D)return va.params[y]=H,'undefined'==typeof va[u][y]&&(va[u][y]=H),!0}else{Aa=w.url;N=va.url;u={};z='';var G=!1,L=0;v=0;for(var T=N.length;v<T;++v)if(N.charAt(v)!=Aa.charAt(L)||G){if(''==z)G=!0,z+=N.charAt(v);else if(v>Aa.indexOf(A[0])+A[0].length){O=w.requirements[A[0]];H=z.substr(0,z.length);if(/^\//.test(O))D=O.match(/\/(.*)\//).pop(),l=O.replace('/'+D+'/',''),D=(new RegExp(D,l)).test(H);else if(/^validator::/.test(O)){l={};D={};z={};F='';r.replace(new RegExp('[^'+y[0]+']','g'),
function(qa){F+=qa});l[y[0]]=H.replace(new RegExp(F,'g'),'');D=JSON.parse(O.split(/::/).splice(1)[0].replace(/([^\W+ true false])+(\w+)/g,'"$&"'));z[y[0]]=D;l=new U('routing',l,null,z);for(let qa in D)if(Array.isArray(D[qa]))l[y[0]][qa].apply(l[y[0]],D[qa]);else l[y[0]][qa](D[qa]);D=l.isValid()}else D=(new RegExp(w.requirements[y[0]])).test(H);if(D)u[A[0].substr(1)]=H;else return!1;z='';G=!1;L=Aa.indexOf(A[0])+A[0].length;--v;A.splice(0,1)}else z+=N.charAt(v),++L;if(v==T-1)if(O=w.requirements[A[0]],
H=z.substr(0,z.length),/^\//.test(O)?(D=O.match(/\/(.*)\//).pop(),l=O.replace('/'+D+'/',''),D=(new RegExp(D,l)).test(H)):D=(new RegExp(w.requirements[y])).test(H),D)u[A[0].substr(1)]=H;else return!1}else++L;if(u.count()==A.length){y=null;for(y in u)va.params[y]=u[y];return!0}}return!1},Q=function(r){return/\/$/.test(r)?Q.variable+'/':Q.variable},S=function(r,H){var w=null,va,Aa=r.url,N=null;for(N in r.param)if(('undefined'==typeof H||'undefined'!=typeof H[N])&&/^:/.test(r.param[N])){var O=r.param[N].substr(1);
...
r.param.file.replace(A,Q));if(/,/.test(r.url)){w=r.url.split(/,/g);var D=0;for(va=w.length;D<va;++D)Q.variable=H[O],w[D]=w[D].replace(A,Q);r.url=w.join(',')}else Q.variable=H[O],r.url=r.url.replace(A,Q)}}if(w){D=0;va=w.length;Aa=Aa.split(/,/g);var l=0;for(r.urlIndex=0;D<va;++D)if(w=0,A=Aa[0].match(/:[-_a-z0-9]+/ig)){N=0;for(O=A.length;N<O;N++){var y=A[N].substr(1);'undefined'!=typeof H[y]&&H[y]&&w++}w>l&&(l=w,r.urlIndex=D)}}return r};P.getRoute=function(r,H,w){var va=null,Aa=!1;B?(window.location.port||
window.location.hostname!=window.gina.config.hostname.replace(/^(https|http|wss|ws):\/\//,'').replace(/:\d+$/,'')||(Aa=!0,window.gina.config.hostname=window.gina.config.hostname.replace(/^(https|http|wss|ws):\/\//,'').replace(/:\d+$/,'')),va=window.gina.config):(va=getContext('gina').config,'undefined'!=typeof getContext('argvFilename')&&(va.getRouting=getContext('gina').Config.instance.getRouting),Aa=getContext('isProxyHost'));var N=va.env||GINA_ENV,O=null,A=va.bundle;/@/.test(r)||'undefined'==typeof A||
null==A||(r=r.toLowerCase(),r+='@'+A);if(/@/.test(r)){var D=r.replace(/(.*):\/\//,'').split(/@/);A=D[1];/\/(.*)$/.test(r)&&(O=r.replace(/(.*):\/\//,'').split(/\/(.*)$/)[1],A=A.replace(/\/(.*)$/,''),N=O||N);r=D[0].toLowerCase()+'@'+A}O=va.getRouting(A,N);if('undefined'==typeof O[r])throw Error('[ RoutingHelper::getRouting(rule, params) ] : `'+r+'` not found !');var l=JSON.clone(O[r]);A=null;l=S(l,H);if(l.isProxyHost=Aa)l.proxy_hostname=B?window.location.protocol+'//'+window.gina.config.hostname:process.gina.PROXY_HOSTNAME||
va.envConf._proxyHostname,l.proxy_host=l.proxy_hostname.replace(/^(https|http):\/\//,'');/,/.test(l.url)&&('undefined'!=typeof l.urlIndex&&(w=l.urlIndex,delete l.urlIndex),w='undefined'!=typeof w?w:0,l.url=l.url.split(/,/g)[w]);/\/$/.test(l.url)&&'/'!=l.url&&(l.url=l.url.substr(0,l.url.length-1));if(/GET/i.test(l.method)&&'undefined'!=typeof H){w='?';va=O[r].url;Aa=[];O=0;for(let y in l.param)-1<P.reservedParams.indexOf(y)||(new RegExp(l.param[y])).test(va)||'undefined'==typeof H[y]||(w+=y+'='+encodeRFC5987ValueChars(H[y])+
'&',Aa[O]=H[y],++O);for(let y in H)-1<P.reservedParams.indexOf(y)||'undefined'!=typeof l.requirements[y]||-1<Aa.indexOf(y)||(w='object'==typeof H[y]?w+(y+'='+encodeRFC5987ValueChars(JSON.stringify(H[y]))+'&'):w+(y+'='+H[y]+'&'));O=Aa=va=null;1<w.length&&(w=w.substring(0,w.length-1),l.url+=w);w=null}l.toUrl=function(y){var z=null;/^redirect$/i.test(this.param.control)&&(z=P.getUrlProps(this.bundle,N||GINA_ENV));var F=this.webroot||z.webroot;z=''+this.hostname||''+z.hostname;var u=''+this.url;this.isProxyHost&&
(z=''+l.proxy_hostname);this.url='undefined'!=typeof y&&/^true$/i.test(y)?u.replace(new RegExp('^'+F),'/'):u.replace(new RegExp('^('+F+'|/$)'),F);return z+this.url};l.request=function(y,z){var F=null,u=null;'function'==typeof arguments[arguments.length-1]&&(F=arguments[arguments.length-1]);'object'==typeof arguments[2]&&(u=arguments[2]);var v=this.webroot||u.webroot,G=this.hostname||u.hostname;u='undefined'!=typeof y&&1==y?path.replace(v,'/'):this.url||u.url;G=/^https/.test(G)?'https':'http';B?window.open(u,
'undefined'!=typeof z&&'undefined'!=typeof z.target?z.target:'_self'):('undefined'==typeof z.agent&&(z.agent=!1),G=require(''+G),v=function(L){var T='',qa=!1;L.on('data',function(Da){T+=Da});L.on('error',function(Da){qa='Failed to get mail content';Da&&'undefined'!=typeof Da.stack?qa+=Da.stack:'string'==typeof Da&&(qa+='\n'+Da)});L.on('end',function(){if(/^\{/.test(T))try{T=JSON.parse(T),'undefined'!=typeof T.error&&(qa=JSON.clone(T),T=null)}catch(Da){qa=Da}qa?F(qa):F(!1,T)})},F?G.get(u,z,v):G.get(u,
z))};!/:/.test(l.url)||/:d+\//.test(l.url)||/:\/\//.test(l.url)||(H=l.url.match(/(:(.*)\/|:(.*)$)/g).map(function(y){return y.replace(/\//g,'')}).join(', '),A='[ RoutingHelper::getRoute(rule[, bundle, method]) ] : route [ %r ] param placeholder not defined: `'+l.url+'` !\n Check your route description to compare requirements against param variables [ '+H+']',A=A.replace(/%r/,r),r=Error(A),console.warn(r),A=r=H=null);return l};P.getRouteByUrl=function(r,H,w,va,Aa){2==arguments.length&&'undefined'!=
typeof arguments[1]&&arguments[1]&&-1<P.allowedMethods.indexOf(arguments[1].toLowerCase())&&(w=arguments[1],H=void 0);var N=null,O=null,A=null,D=null,l=null,y=null;if(/#/.test(r)&&1<r.length){var z=r.split(/#/);r=z[0];l='#'+z[1];z=null}1==arguments.length&&'undefined'!=typeof arguments[0]&&(/^(https|http)/i.test(r)||/^\//.test(r)||(r='/'+r),N='/'+r.split(/\//g)[1],B&&(D=gina.config.reverseRouting,A=gina.config.routing),'undefined'!=typeof D[N]&&(z=A[D[N]],H=z.bundle,N=z.webroot,y=z.hostname,z=null));
Aa='boolean'!=typeof arguments[arguments.length-1]?!1:arguments[arguments.length-1];var F=!1,u=null,v=null,G=u=v=null;z='undefined'!=typeof w?!0:!1;B?(u=window.gina.config,H='undefined'!=typeof H?H:u.bundle,v=u.env,A=A||u.getRouting(H),D=D||u.reverseRouting,isXMLRequest='undefined'!=typeof isXMLRequest?isXMLRequest:!1,y=y||u.hostname,N=N||u.webroot,va={routing:{},method:w,params:{},url:r},H&&(va.bundle=H)):(u=getContext('gina').config,H='undefined'!=typeof H?H:u.bundle,v=u.env,A=u.getRouting(H),y=
u.envConf[H][v].hostname,N=u.envConf[H][v].server.webroot,va||={routing:{},isXMLRequest:!1,method:'undefined'!=typeof w?w.toLowerCase():'get',params:{},url:r},Aa&&(va.method=w),isXMLRequest=va.isXMLRequest||!1);v=r.replace(new RegExp('^('+y+'|'+y.replace(/:\d+/,'')+')'),'');'undefined'==typeof va.routing.path&&(va.routing.path=decodeURI(v));w='undefined'!=typeof w?w.toLowerCase():'get';z&&(va.originalMethod=va.method,va.method=w,va.routing.path=decodeURI(v));va.method||(va.method=w);u={};N=new RegExp(w,
'i');D=null;var L;for(L in A){if('undefined'==typeof A[L].param)break;if(A[L].bundle==H&&(D=A[L].method,/,/.test(D)&&N.test(D)&&(D=va.method),'undefined'==typeof A[L].method||N.test(D))){u={method:D,requirements:A[L].requirements,namespace:A[L].namespace||void 0,url:decodeURI(v),rule:A[L].originalRule||L,param:A[L].param,middleware:JSON.clone(A[L].middleware),bundle:A[L].bundle,isXMLRequest};try{if(G=P.compareUrls(u,A[L].url,va),G.past){O=JSON.clone(A[L]);O.name=L;F=!0;G={};break}}catch(T){throw Error('Route [ '+
L+' ] needs your attention.\n'+T.stack);}}}if(F)return/\/$/.test(r)&&'/'!=r&&(r=r.substr(0,r.length-1)),l&&(r+=l),O.url=r,O.toUrl=function(T){var qa=this.webroot,Da=this.hostname,W=this.url;this.url='undefined'!=typeof T&&1==T?W.replace(qa,'/'):W;return Da+this.url},O;if(B){l=!1;if('#'==r&&/GET/i.test(w)&&z||/^404:/.test(r))r=location.pathname,l=!0;'undefined'==typeof P.notFound&&(P.notFound={});A=null;O='[ RoutingHelper::getRouteByUrl(rule[, bundle, method]) ] : route [ %r ] is called but not found inside your view: `'+
...
delete A[l][D].save;delete A[l][D]._filter;if(O&&'object'==typeof A[l][D]){var F=function(v,G){for(var L=0,T=v.length;L<T;++L)'object'!=typeof G[L]||'undefined'==typeof v[L]||Array.isArray(v[L])?Array.isArray(v[L])?F(v[L],G[L]):'undefined'==typeof v[L]&&delete G[L]:u(v[L],G[L]);return G},u=function(v,G){for(var L in G)'object'!=typeof G[L]||'undefined'==typeof v[L]||Array.isArray(v[L])?Array.isArray(v[L])?F(v[L],G[L]):'undefined'==typeof v[L]&&delete G[L]:u(v[L],G[L]);return G};Array.isArray(A[l][D])?
...
typeof O&&'undefined'!=typeof O)throw Error('`options` must be an object');'undefined'==typeof O&&(O={});ba=ma(O,ba);S=window.localStorage;O=ba.bucket;if(!S.getItem(O)&&void 0!=O)S.setItem(O,JSON.stringify(H));else if(void 0==O)throw Error('`bucket` name cannot be undefined');Q.bucket=O;Q=ma(Q,va)})(B);return Q}
...
null,errors:{},initialized:!1,isReady:!1,rules:{},$forms:{},getFormById:null,validateFormById:null,setOptions:null,resetErrorsDisplay:null,resetFields:null},va={id:null,plugin:this.plugin,on:U?on:null,eventData:{},target:U?document:null,cachedErrors:{},binded:!1,unbinded:!1,withUserBindings:!1,rules:{},setOptions:null,send:null,isValidating:null,isSubmitting:null,submit:null,destroy:null,resetErrorsDisplay:null,resetFields:null},Aa={},N={},O=null,A={url:'',method:'GET',isSynchrone:!1,withCredentials:!1,
headers:{'Content-Type':'application/x-www-form-urlencoded; charset=UTF-8','X-Requested-With':'XMLHttpRequest'}},D=function(m,g,h){h='undefined'!=typeof h?{id:h}:null;var b={},x;for(x in g)b[x]=g[x];if('undefined'!=typeof m&&0<m.count()){try{La(m,''),Ea(m)}catch(q){throw q;}return za(h,b,null,w.rules)}return new r(b)},l=function(m){A=m=Q(m,A)},y=function(m){var g=null;if(!w.$forms)throw Error('`$forms` collection not found');if('undefined'==typeof m)throw Error('[ FormValidator::getFormById(formId) ] `formId` is missing');
...
(p.style.display='none');if(p&&'success'!=h){var R=x.message||x.error;p.innerHTML='<p>'+R+'</p>';fadeIn(p)}else if(p||'success'==h)for(h=0,x=q.length;h<x;++h){var J=b.id.replace(/\-preview/,'-'+h+'-reset-trigger');R=!1;p=document.getElementById(J);var fa=['reset','js-upload-reset'];p?(/a/i.test(p.tagName)&&(p.href='#'),p.innerHTML&&''!=p.innerHTML||(p.innerHTML=g.getAttribute('data-gina-form-upload-reset-label')||'Reset'),'undefined'==typeof p.className&&(p.className=''),J=Q(p.className.split(/\s+/g),
fa),p.className=J.join(' ')):(R=!0,p=document.createElement('A'),p.href='#',p.innerHTML=g.getAttribute('data-gina-form-upload-reset-label')||'Reset',p.className=fa.join(' '),p.id=J);p.style.display='none';if('undefined'==typeof q[h].preview&&m.hasPreviewContainer&&/^image/.test(q[h].mime)&&''!=q[h].location){J=document.createElement('IMG');J.src=q[h].tmpUri;J.style.display='none';J.setAttribute('data-upload-original-filename',q[h].originalFilename);J.setAttribute('data-upload-reset-link-id',p.id);
fa=b.getAttribute('data-preview-max-width')||null;if(J.width&&fa&&J.width>fa){var Ba=J.width/fa;J.width=fa;J.height/=Ba}else!J.width&&fa&&(J.width=fa);/ul/i.test(m.previewContainer.tagName)?(fa=document.createElement('LI'),fa.className='item',fa.appendChild(J),b.appendChild(fa)):b.appendChild(J);fadeIn(J)}J=m.uploadFields[h];for(var ea in J)if('name'==ea&&''!=J[ea].value||!q[h][ea]||'preview'==ea&&'undefined'==typeof q[h][ea]||/(height|width)/i.test(ea)&&!/^image/.test(q[h].mime))/(preview|height|width)/i.test(ea)&&
(fa=document.getElementById(J[ea].id))&&fa.parentNode.removeChild(fa);else if(J[ea].value=q[h][ea],'preview'==ea)for(var da in q[h][ea])if('undefined'!=typeof q[h][ea][da]&&'undefined'!=typeof J[ea][da]&&(J[ea][da].value=q[h][ea][da]),'tmpUri'==da&&m.hasPreviewContainer){Ba=document.createElement('IMG');Ba.src=q[h][ea].tmpUri;Ba.style.display='none';Ba.setAttribute('data-upload-original-filename',q[h].originalFilename);Ba.setAttribute('data-upload-preview-original-filename',q[h][ea].originalFilename);
...
ta(m[b]);if(p&&Array.isArray(m[b][p].conditions)&&0<m[b][p].conditions.length)for(g=0,h=m[b][p].conditions.length;g<h;)'undefined'!=typeof m[b][p].conditions[g].rules&&0==m[b][p].conditions[g].rules.count()&&(m[b][p].conditions.splice(g,1),h--,g--),g++}},Ea=function(m){var g=JSON.stringify(m),h=g.match(/("@import\s+[-_a-z A-Z 0-9/.]+")/g)||[],b=[];for(let R=0,J=h.length;R<J;R++)0>b.indexOf(h[R])&&b.push(h[R]);h=b;b=g.match(/("_merging(.*))(\s+:|:)(.*)(",|")/g);w.rules||(w.rules={});if(h&&0<h.length){m=
{};for(let R=0,J=h.length;R<J;++R){var x=h[R].replace(/(@import\s+|"|')/g,'');var q=x.replace(/(@import\s+|"|')/g,'').split(/\s/g);for(let fa=0,Ba=q.length;fa<Ba;++fa){var p=q[fa].replace(/\//g,'.').replace(/\-/g,'.');'undefined'!=typeof w.rules[p]?(p=JSON.stringify(w.rules[p]),p=JSON.parse(p),p._comment='undefined'!=typeof p._comment?p._comment+'\n':'',p._comment+='Imported from `'+x+'`',p=JSON.stringify(p),g=g.replace(new RegExp(h[R],'g'),p),w.rules=JSON.parse(JSON.stringify(w.rules).replace(new RegExp(h[R],
...
(q=w.$forms[q].target,p?xb(q,p):xb(q),++g):('object'==typeof h[b].id?(delete w.$forms[h[b].id],q=h[b].attributes.getNamedItem('id').nodeValue||'form.'+ba.v4(),h[b].setAttribute('id',q),h[b].id=q,va.target=h[b],w.$forms[q]=Q({},va),q=w.$forms[q].target):q=w.$forms[h[b].id].target,p?xb(q,p):xb(q))}if(window.XMLHttpRequest)O=new XMLHttpRequest;else if(window.ActiveXObject)try{O=new ActiveXObject('Msxml2.XMLHTTP')}catch(R){try{O=new ActiveXObject('Microsoft.XMLHTTP')}catch(J){}}w.isReady=!0;gina.hasValidator=
!0;gina.validator=w;triggerEvent(gina,w.target,'ready.'+w.id,w)}));w.initialized=!0;return w},La=function(m,g){var h;for(h in m)if('object'==typeof m[h]&&'undefined'==typeof w.rules[g+h]){var b=h;/\[|\]/.test(h)&&(b=h.replace(/\[/g,'.').replace(/\]/g,''));w.rules[g+b]=m[h];La(m[h],g+b+'.')}},Fa=function(m){if('undefined'!=typeof Aa[m])return Aa[m];var g=null;if('undefined'==typeof w.rules[m]){if(La(Aa,''),Aa=Ea(Aa),g=Aa[m],!g)return{}}else g=w.rules[m];g=JSON.clone(g);var h=new RegExp('^'+m),b=new RegExp('^'+
m+'.'),x=null,q=function(R,J,fa,Ba,ea,da,E){if(J.length){var na=Object.getOwnPropertyNames(R)[0],ra=J[0];ra=''==ea?ea+=ra:ea+'['+ra+']';1==J.length&&(R[na]=Q(R[na],fa,!0));J.splice(0,1);ra==na?q(R[na],J,fa,Ba,ra,da,E):'undefined'!=typeof R[na]?q(R[na],J,fa,Ba,ra,da,E):q(R,J,fa,Ba,ea,da,E)}},p;for(p in w.rules)p!=m&&h.test(p)&&(x=p.replace(b,''),/\./.test(x)&&(x=x.split(/\./g),q(g,x,w.rules[p],g,'',0,g.count()-1)));return Aa[m]=g},Na=formatDataFromString,Ia=function(m){var g=w.$forms[m.form.getAttribute('id')],
...
(p=!1);if(/^(radio|checkbox|text|hidden|password|number|date|email)$/i.test(g.type)&&!p||b&&!p){b=g.name;q=x[b]||null;if(!q&&(rb(x,g),'undefined'==typeof x[b]))return;if(m.target.dataset.ginaFormLiveCheckEnabled&&q&&(b=[],q=null,p=0,/^(radio|checkbox)$/i.test(g.type)?q=/^(radio|checkbox)$/i.test(g.type)?'changed.'+g.id:'change.'+g.id:(addEventListener(gina,g,'focusout.'+g.id,function(J){J.preventDefault();clearTimeout(h)}),q='change.'+g.id,'undefined'==typeof gina.events[q]&&(b[p]=q,++p),q='keyup.'+
g.id,'undefined'==typeof gina.events[q]&&(b[p]=q,++p),q='focusin.'+g.id,'undefined'==typeof gina.events[q]&&(b[p]=q,++p),q='focusout.'+g.id),'undefined'==typeof gina.events[q]&&(b[p]=q,++p),0<b.length)){var R=!1;addListener(gina,g,b,function(J){J.preventDefault();clearTimeout(h);if(!R&&/^changed\./i.test(J.type)||!R&&/^(radio|checkbox)$/i.test(J.target.type))R=!0;else if(R&&/^changed\./i.test(J.type)||R&&/^(radio|checkbox)$/i.test(J.target.type))return!1;if('undefined'!=typeof w.$forms[J.target.form.getAttribute('id')].isSubmitting&&
/true/i.test(w.$forms[J.target.form.getAttribute('id')].isSubmitting))return!1;var fa=function(){console.debug('processing: '+J.target.name+'/'+J.target.id);if(!/^(radio|checkbox)$/i.test(J.target.type)&&J.target.value===J.target.defaultValue&&''!=J.target.value){var Ba=w.$forms[J.target.form.getAttribute('id')].errors;if(Ba&&0!=Ba.count())G(J.target.form,Ba,null,J.target.name);else return G(J.target.form,{},null,J.target.name),cancelEvent(J)}Ba={};var ea={};Ba[J.target.name]=J.target.value;ea[J.target.name]=
J.target;w.$forms[J.target.form.getAttribute('id')].isValidating=!0;za(J.target,Ba,ea,m.rules,function(da){w.$forms[J.target.form.getAttribute('id')].isValidating=!1;da.isValid()?G(J.target.form,{},da.data,J.target.name):G(J.target.form,da.error,da.data,J.target.name);var E=J.target.form,na=da=null,ra=null;na=db(E,x);da=na.fields;na=na.$fields;var ia=E.getAttribute('id');ra=w.$forms[ia].rules;w.$forms[ia].isValidating=!0;za(E,da,na,ra,function(Z){w.$forms[ia].isValidating=!1;console.debug('['+ia+
'] onSilentGlobalLiveValidation: '+Z.isValid(),Z);var Ga=Z.isValid();M&&U&&'undefined'!=typeof window.ginaToolbar&&window.ginaToolbar&&(gina.forms.errors||(gina.forms.errors={}),window.ginaToolbar.update('forms',{id:ia,errors:Z.error||{}}));Ka(E,Ga);R=!1})})};if(/^changed\./i.test(J.type)||/^change\./i.test(J.type)&&'radio'==J.target.type)return function(Ba,ea){if(!(0<ea))return++ea,setTimeout(()=>{console.debug(' changed .... '+g.id);fa()},0)}(R,0);/^focusin\./i.test(J.type)?/\-error/.test(g.parentNode.className)&&
(console.debug('#1 you just focusin ....'+g.id,g.value),u(g)):/^focusout\./i.test(J.type)?/\-warning/.test(g.parentNode.className)&&(console.debug('#1 you just focusout ....'+g.id,g.value),u(g),G(g.form,w.$forms[g.form.getAttribute('id')].errors,null,g.name)):/^keyup\./i.test(J.type)?(g.ginaFormValidatorTestedValue=g.value,h=setTimeout(function(){-1<['91','17'].indexOf(''+J.keyCode)&&0==N.count()||(console.debug(' keyup ('+J.keyCode+') .... '+g.id,g.value,' VS ',g.ginaFormValidatorTestedValue+'(old)'),
fa())},1E3)):/^change\./i.test(J.type)&&!/^(checkbox)$/i.test(J.target.type)&&(console.debug(' change .... '+g.id),fa())})}}},Ua=function(m,g){m.setSelectionRange?(m.focus(),m.setSelectionRange(g,g)):m.createTextRange&&(m=m.createTextRange(),m.collapse(!0),m.moveEnd('character',g),m.moveStart('character',g),m.select())},pb=function(m,g){if(document.activeElement&&document.activeElement.form){m=Array.prototype.filter.call(document.activeElement.form.querySelectorAll('a:not([disabled]), button:not([disabled]), input[type=text]:not([disabled]), select:not([disabled]), [tabindex]:not([disabled]):not([tabindex="-1"])'),
...
var b='keydown.'+h.currentTarget.id;'undefined'==typeof gina.events[b]&&addListener(gina,h.currentTarget,b,function(x){x.preventDefault();clearTimeout(g);var q=x.currentTarget,p=x.currentTarget.value,R=q.selectionStart,J=q.selectionEnd;q.removeAttribute('readonly');switch(x.keyCode){case 46:case 8:R!=J?(q.value=p.substr(0,R)+p.substr(J),0==R&&(q.value=p.substr(J))):q.value=0==R?p.substring(R+1):p.substr(0,R-1)+p.substr(J);x.currentTarget.setAttribute('readonly','readonly');setTimeout(()=>{q.removeAttribute('readonly');
setTimeout(()=>{R!=J?Ua(q,R):0==R?Ua(q,R):Ua(q,R-1)},0)},0);break;case 9:N[16]&&N[9]?pb(q,!0):pb(q);break;case 13:case 16:break;case 37:console.debug('moving left ',R-1);Ua(q,R-1);break;case 39:R+1<p.length+1&&Ua(q,R+1);break;case 17:case 91:console.debug('CMD hit');x.preventDefault();break;case 67:if(N[67]&&N[91]||N[67]&&N[17]){q.setSelectionRange(R,J);document.execCommand('copy');break}case 86:if(N[86]&&N[91]||N[86]&&N[17]){R!=J&&(q.value=q.value.replace(p.substring(R,J),''));Ua(q,R);document.execCommand('paste');
break}case 88:if(N[88]&&N[91]||N[88]&&N[17]){q.setSelectionRange(R,J);document.execCommand('cut');break}case 90:if(N[90]&&N[91]||N[90]&&N[17]){q.value=q.defaultValue;break}default:R!=J?(q.value=p.substr(0,R)+x.key,J-1<p.length&&(q.value+=p.substring(J))):q.value=0==R?x.key+p.substring(R):p.substr(0,R)+x.key+p.substr(J),x.currentTarget.setAttribute('readonly','readonly'),setTimeout(()=>{q.removeAttribute('readonly');setTimeout(()=>{Ua(q,R+1)},0)},0)}})})},gb=function(m,g){if(/^(input|textarea)$/i.test(g.tagName)&&
...
w.$forms[Ra.getAttribute('id')].isValidating=!0;za(event.target,ja,ua,X.rules,function(Xa){w.$forms[Ra.getAttribute('id')].isValidating=!1;Xa.isValid()?G(Ra,{},Xa.data,event.target.name):G(Ra,Xa.error,Xa.data,event.target.name);var eb=Ra,Oa=Xa=null,wb=null;Oa=db(eb,x);Xa=Oa.fields;Oa=Oa.$fields;var lb=eb.getAttribute('id');wb=w.$forms[lb].rules;w.$forms[lb].isValidating=!0;za(eb,Xa,Oa,wb,function(hb){w.$forms[lb].isValidating=!1;console.debug('[updateSelect]: onSilentGlobalLiveValidation: '+hb.isValid(),
hb);hb=hb.isValid();Ka(eb,hb);once=!1})})}};E=na=null;Z=0;for(da=J.length;Z<da;++Z)if(rb(h.rules,J[Z]),ia=J[Z].getAttribute('id'),!ia||!/^gina\-toolbar/.test(ia)){ia&&''!=ia||(ia='select.'+ba.v4(),J[Z].setAttribute('id',ia));if(E=J[Z].getAttribute('data-gina-form-element-group'))na=J[Z].getAttribute('name')||ia,na===ia&&J[Z].setAttribute('name',ia),Ba[ia]={id:ia,name:na,group:E,target:J[Z]};addListener(gina,J[Z],'change',function(ca){ca=ca.target;/select/i.test(ca.type)&&Pa(ca,h)});if(J[Z].options&&
!h.fieldsSet[ia]){na=0;if(E=J[Z].getAttribute('data-value')||null)for(ra=0,fa=J[Z].options.length;ra<fa;++ra)if(J[Z].options[ra].value==E){na=ra;J[Z].selectedIndex=na;break}'undefined'!=typeof J[Z].options[J[Z].selectedIndex]&&J[Z].options[J[Z].selectedIndex].index&&(na=J[Z].options[J[Z].selectedIndex].index);0<J[Z].options.length&&'undefined'!=typeof J[Z].options[na]&&(E=J[Z].options[na].value);h.fieldsSet[ia]={id:ia,name:J[Z].name||null,value:E||null,selectedIndex:na||0};'undefined'!=typeof J[Z].selectedIndex&&
-1<J[Z].selectedIndex&&(J[Z].options[na].selected=!0,J[Z].setAttribute('data-value',J[Z].options[na].value))}}var $a=function(ca,X,ja,ua){'undefined'==typeof ua&&(ua=!1);if('undefined'==typeof Ba[ca])throw Error('Radio & Checkbox dependencies not met: you must use the ID attribue of the `master element` as the `data-gina-form-element-group`');var Ra=ca.replace(/\-|_|@|#|\.|\[|\]/g,'\\$&');ca=Ba[ca].target.checked;for(let Oa in Ba)if(!/radio|checkbox/i.test(Ba[Oa].target.type)){var Xa=new RegExp(Ra);
...
Mb=document.getElementsByName(ca.name);for(let Xa=0,eb=Mb.length;Xa<eb;++Xa)Mb[Xa].id!==ca.id&&ua&&(Mb[Xa].checked=!1,Mb[Xa].removeAttribute('checked'),qb(Mb[Xa],!0));X?qb(ca):(ua&&'null'!=ua&&'false'!=ua&&''!=ua?setTimeout(function(){ja?qb(ca):(ca.checked=!1,ca.removeAttribute('checked'))},0):setTimeout(function(){ja?qb(ca):(ca.checked=!0,ca.setAttribute('checked','checked'))},0),Ra&&(ca.value=/^true$/.test(ca.value)?!0:!1))};Z=0;for(da=g.length;Z<da;++Z){J=g[Z].getAttribute('type');if('undefined'==
typeof g[Z].id||''==g[Z].id)g[Z].id=J+'-'+ba.v4(),g[Z].setAttribute('id',g[Z].id);if('undefined'!=typeof J&&/^checkbox$/i.test(J)){if(g[Z].disabled&&-1<ea.indexOf(g[Z].id)||!g[Z].checked&&-1<ea.indexOf(g[Z].id)){J=new RegExp(g[Z].id.replace(/\-|_|@|#|\.|\[|\]/g,'\\$&'));for(var cb in Ba)J.test(Ba[cb].group)&&(Ba[cb].target.disabled=!0)}R='change.'+g[Z].id;J=function(ca,X){addListener(gina,ca,X,function(ja){Cb(ja.target);triggerEvent(gina,ja.target,'changed.'+ja.target.id)});Cb(ca,!0)};'undefined'!=
typeof gina.events[R]&&gina.events[R]==g[Z].id&&removeListener(gina,g[Z],R);J(g[Z],R)}else'undefined'!=typeof J&&/^radio$/i.test(J)&&(R=g[Z].id,J=function(ca,X){addListener(gina,ca,X,function(ja){Ya(ja.target);triggerEvent(gina,ja.target,'changed.'+ja.target.id)});Ya(ca,!0)},'undefined'!=typeof gina.events[R]&&gina.events[R]==g[Z].id&&removeListener(gina,g[Z],R),J(g[Z],R))}R='click';J=function(){var ca=null;ca='reset.'+m.id;'undefined'==typeof gina.events[ca]&&addListener(gina,m,ca,function(X){X.preventDefault();
var ja=w.$forms[X.currentTarget.id||X.target.id];ja.target.dataset.ginaFormIsResetting=!0;T(ja);X=db(ja.target,ja.rules,!0);za(ja.target,X.fields,X.$fields,ja.rules,function(ua){var Ra=ua.isValid();console.debug('silent reset validation result[isValid:'+Ra+']: ',ua);G(ja.target,{});Ka(ja.target,Ra);ja.target.dataset.ginaFormIsResetting=!1})});addListener(gina,m,'reset',function(X){var ja=X.target;if('undefined'!=typeof X.defaultPrevented&&X.defaultPrevented)return!1;X.preventDefault();var ua=ja.id;
if(!ua)return!1;/^reset\./.test(ua)||(ua='reset.'+ja.id);gina.events[ua]&&triggerEvent(gina,ja,ua,X.detail)});addListener(gina,m,'keydown',function(X){var ja=X.target;if('undefined'!=typeof X.defaultPrevented&&X.defaultPrevented)return!1;N[X.keyCode]='keydown'==X.type;var ua=ja.id;if(!ua)return!1;/^keydown\./.test(ua)||(ua='keydown.'+ja.id);gina.events[ua]&&(cancelEvent(X),triggerEvent(gina,ja,ua,X.detail,X))});addListener(gina,m,'keyup',function(X){var ja=X.target;if('undefined'!=typeof X.defaultPrevented&&
X.defaultPrevented)return!1;N[X.keyCode]&&delete N[X.keyCode];var ua=ja.id;if(!ua)return!1;/^keyup\./.test(ua)||(ua='keyup.'+ja.id);gina.events[ua]&&(cancelEvent(X),triggerEvent(gina,ja,ua,X.detail,X))});addListener(gina,m,'focusin',function(X){var ja=X.target;if('undefined'!=typeof X.defaultPrevented&&X.defaultPrevented)return!1;var ua=ja.id;if(!ua)return!1;/^focusin\./.test(ua)||(ua='focusin.'+ja.id);gina.events[ua]&&(cancelEvent(X),triggerEvent(gina,ja,ua,X.detail))});addListener(gina,m,'focusout',
...
(w.$forms[q].submitTrigger=m[p].id||m[p].getAttribute('id'),m[p].dataset.ginaFormSubmitTriggerFor=q);var J=m[p].getAttribute('name');var fa=m[p].disabled||m[p].getAttribute('disabled');fa=/disabled|true/i.test(fa)?!0:!1;if(J&&!fa){if('undefined'!=typeof m[p].type&&'radio'==m[p].type||'undefined'!=typeof m[p].type&&'checkbox'==m[p].type)if(m[p].checked||'undefined'==typeof g[J]&&'undefined'!=m[p].value&&/^(true|false)$/.test(m[p].value)||!m[p].checked&&'undefined'!=typeof g[J]&&'undefined'!=typeof g[J].isBoolean&&
/^(true|false)$/.test(m[p].value))if(/^(true|false)$/.test(m[p].value))if('undefined'==typeof g[J]?g[J]={isBoolean:!0}:'undefined'!=typeof g[J]&&'undefined'==typeof g[J].isBoolean&&(g[J].isBoolean=!0,g[J].isRequired=!0),'radio'==m[p].type){if('undefined'==typeof g[J])throw Error('rule '+J+' is not defined');/^true$/.test(g[J].isBoolean)&&m[p].checked&&(x[J]=/^true$/.test(m[p].value)?!0:!1)}else x[J]=m[p].value=/^true$/.test(m[p].value)?!0:!1;else x[J]=m[p].value;else g&&'undefined'!=typeof g[J]&&
'undefined'!=typeof g[J].isBoolean&&'undefined'!=typeof g[J].isRequired&&!/^(true|false)$/.test(m[p].value)&&(x[J]=!1);else x[J]=m[p].value;'undefined'==typeof b[J]&&(b[J]=m[p],b[J].setAttribute('data-gina-form-errors',''))}}x._length=x.count()||0;return{$fields:b,fields:x,rules:g}},Lb=function(m,g,h,b){return'undefined'==typeof m[h]||/^(null|NaN|undefined|\s*)$/i.test(g[h])?g[h]:'undefined'!=typeof m[h].isNumber||'undefined'!=typeof m[h].isInteger||'undefined'!=typeof m[h].isFloat||'undefined'!=
...
b&&(g=h[Object.getOwnPropertyNames(h)[0]].form,h=db(g,x),delete h.fields._length,g=h.fields,h=h.$fields);b=[];var p=0;for(R in g)b[p]=R,p++;b.sort().reverse();for(let fa=0,Ba=b.length;fa<Ba;fa++){var R=b[fa].replace(/\-|_|@|#|\.|\[|\]/g,'\\$&');R=new RegExp('\\$'+R,'g');p='\\"'+g[b[fa]]+'\\"';var J=R.test(q);J&&'undefined'!=typeof x[b[fa]]?p=Lb(x,g,b[fa],!0):J&&console.warn('`'+b[fa]+'` is used in a dynamic rule without definition. This could lead to an evaluation error. Casting `'+b[fa]+'` to `string`.');
m=m.replace(R,p)}if(/\$(.*)/.test(m))for(let fa=0,Ba=b.length;fa<Ba;fa++)R=b[fa].replace(/\-|_|@|#|\.|\[|\]/g,'\\$&'),R=new RegExp('\\$'+R,'g'),p=''!=h[b[fa]].value?'\\"'+h[b[fa]].value+'\\"':'\\"\\"',(J=R.test(q))&&'undefined'!=typeof x[b[fa]]?p=Lb(x,g,b[fa],!0):J&&console.warn('`'+b[fa]+'` is used in a dynamic rule without definition. This could lead to an evaluation error. Casting `'+b[fa]+'` to `string`.'),m=m.replace(R,p||h[b[fa]].checked);return JSON.parse(m)},za=function(m,g,h,b,x){delete g._length;
var q=JSON.stringify(b);g=Vb(q,g);/\$(.*)/.test(q)&&(b=!/^form$/i.test(m.tagName)&&1==h.count()&&/true/i.test(m.form.dataset.ginaFormLiveCheckEnabled)?!0:!1,b=ya(q,g,h,b));var p=null,R=q=null,J=!1,fa=0;g.count();var Ba=!1,ea=null,da=null,E=null,na=0,ra=null,ia=null,Z=null,Ga=function(Ya,cb,ca){if('undefined'==typeof cb[Ya]){skipTest=!1;for(var X in cb)if(!/^_comment$/i.test(X)&&/^\//.test(X)&&(ra=X.match(/\/(.*)\//).pop(),ia=X.replace('/'+ra+'/',''),ra=ra.replace(/\[/g,'\\[').replace(/\]/g,'\\]'),
...
(gina.forms.validated||(gina.forms.validated={}),gina.forms.validated[p]||(gina.forms.validated[p]={}),window.ginaToolbar.update('forms',{id:p,validated:R}))}catch(Ib){throw Ib;}Ba=!0;if(!J&&0>=na)if('undefined'!=typeof Ra&&'function'===typeof Ra)Ra._errors=Pa.getErrors(),Ra._data=Pa.toData(),triggerEvent(gina,Ya,'validated.'+p,Ra);else return J=!0,{isValid:Pa.isValid,error:cb,data:R}}};U&&addListener(gina,m,q,function(Ya){Ya.preventDefault();if(!J){J=!0;Ba=!1;na=0;var cb=Ya.detail,ca=cb._data||Pa.toData(),
...
define('gina/toolbar','require jquery vendor/uuid lib/collection lib/routing gina/storage gina/validator'.split(' '),function(B){var P=B('jquery');P.noConflict();var V=B('lib/routing');B('lib/collection');var ma=B('gina/storage');return function(){var U=null,M=!1,ba=!1,Q=!1,S,r=(new ma({bucket:'gina'})).Collection('plugin'),H=null,w=null,va=!1,Aa=null,N=null,O=null,A=null,D=null,l='',y=null,z=null,F=null,u='',v=null,G=0,L=0,T=0,qa='',Da={},W=null,ka=null,ha=null,xa=null,la=null,ta=null,Ea=null,Qa=
null,La=null,Fa=null,Na=null,Ia=null,Ja=null,Ua=null,pb=function(){H=P('#gina-toolbar');if(!H.length)return!1;Aa=H.find('.gina-toolbar-tab > a');N=P('#gina-toolbar-toggle');O=P('#gina-toolbar-panels');A=O.find('.gina-toolbar-panel');y=P('#gina-toolbar-vposition');z=P('#gina-toolbar-hposition');F=y.add(z);v=P('#gina-toolbar-width');H.find('.gina-toolbar-main');W=P('#gina-toolbar-json');ka=P('#gina-toolbar-gina-json');ha=P('#gina-toolbar-toggle-code-raw');$forms=P('form:not(.gina-toolbar-options, .gina-toolbar-content)');
La=P('#gina-toolbar-data-html');Fa=P('#gina-toolbar-view-html');Na=P('#gina-toolbar-forms-html');Qa=P('#gina-toolbar-configuration-environment-html');Ia=P('#gina-toolbar-code-toggle');H.prepend('<textarea class="gina-toolbar-copy"></textarea>');Ja=H.find('.gina-toolbar-copy');w=r.findOne({_name:'toolbar'});w||(w={_name:'toolbar',_version:'1.0.3',_description:'Toolbar settings',_licence:'MIT',_author:[{name:'Fabrice Delaneau',company:'Freelancer'},{name:'Martin-Luther Etouman',company:'Rhinostone'}],
position:'top-right',width:'30',panelId:'#gina-toolbar-data',isCollapsed:!0,isUnfolded:[],debug:{forms:{active:!1,strategy:'frontend'}}},r.insert(w),w=r.findOne({_name:'toolbar'}));'1.0.3'!=w._version&&('1.0.1'>w._version&&(w.isUnfolded||(w.isUnfolded=[]),void 0!=w.codeFolding&&delete w.codeFolding),'undefined'==typeof w.isUnfolded||Array.isArray(w.isUnfolded)||(w.isUnfolded=[]),w._version='1.0.3',w.save(!0));u=w.position;G=w.width;l=w.panelId;va=w.isCollapsed;H.removeClass('gina-toolbar-hidden');
Ub()},ab=function(x,q,p){var R=null,J=null;try{J=W?W.text():'',''==J||'null'==J?W.text('{}'):(la=JSON.parse(J),Ea=JSON.parse(ka.text()),W.text(''),xa||(xa={jsonObject:JSON.clone(la),ginaJsonObject:JSON.clone(Ea)},ta={}))}catch(na){console.error('Could not load'+(x?' [ '+x+' ] ':' ')+'json\n'+na.message+'\n'+na.stack)}if(la){q&&!p?(la[x]||(la[x]={}),la[x]=Ea[x]=q):'data-xhr'==x&&!q&&la['data-xhr']?delete la['data-xhr']:p&&(la=q,Ea=p);b(la,'');Ea.environment&&(delete Ea.environment.routing,delete Ea.environment.reverseRouting,
delete Ea.environment.forms);la.environment&&(delete la.environment.routing,delete la.environment.reverseRouting,delete la.environment.forms);Qa.html(db(la.environment,Ea.environment));R=la.data;var fa=la.view;p=la.forms;var Ba=Ea.data,ea=Ea.view;J=Ea.forms;ba=S=!1;var da=null,E=!1;/^(view-xhr)$/.test(x)&&(da=!0,fa=la[x],ea=Ea[x],R=la['data-xhr'],Ba=Ea['data-xhr']);if(!x||/^(data)$/.test(x))La.html('<ul class="gina-toolbar-code">'+db(R,Ba,null,da)+'</ul>'),Fa.html('<div id="gina-toolbar-view-html-properties" class="gina-toolbar-section">\n    <h2 class="gina-toolbar-section-title">properties</h2>\n    <ul class="gina-toolbar-properties"></ul>\n</div>'),
Fa.html(Vb(fa,ea,null,da,Fa)),R=$forms,Na.html(''),Na.html(za(p,J,Na,0,R,R.length,da)),Na.find('div.gina-toolbar-section > h2').off('click').on('click',function(na){na.preventDefault();P(this).parent().find('ul').first().slideToggle()});if(/^(data-xhr|view-xhr)$/.test(x)){if('undefined'==typeof la[x]||!la[x]||'null'==la[x])return!1;da=!0;E='undefined'!=typeof la[x].isXHRViewData?!0:E;E||/^(view-xhr)$/.test(x)||'undefined'==typeof la['el-xhr']||(ta.data=JSON.clone(la[x]));E&&delete la[x].isXHRViewData;
/^(data-xhr)$/.test(x)?La.html('<ul class="gina-toolbar-code">'+db(la[x],Ea[x],null,da)+'</ul>'):/^(view-xhr)$/.test(x)&&(Fa.html('<div id="gina-toolbar-view-html-properties" class="gina-toolbar-section">\n    <h2 class="gina-toolbar-section-title">properties</h2>\n    <ul class="gina-toolbar-properties"></ul>\n</div>'),Fa.html(Vb(la[x],Ea[x],null,da,Fa)))}/^(el-xhr)$/.test(x)&&(da=!0,R=P('#'+q).find('form:not(.gina-toolbar-options, .gina-toolbar-content)'),Na.html(''),Na.html(za(p,J,Na,0,R,R.length,
da)),Na.find('div.gina-toolbar-section > h2').off('click').on('click',function(na){na.preventDefault();P(this).parent().find('ul').first().slideToggle()}));/^(forms)$/.test(x)&&(ba=da=!0,P('#gina-toolbar-form-'+q.id).length||(R=$forms,Na.html(''),Na.html(za(p,J,Na,0,R,R.length,da)),Na.find('div.gina-toolbar-section > h2').off('click').on('click',function(na){na.preventDefault();P(this).parent().find('ul').first().slideToggle()})),'undefined'!=typeof q.rules&&m(q.id,'rules',q.rules,da),'undefined'!=
...
gb(w.isUnfolded,w.isUnfolded.length,0)},200))})}if(!x||'el-xhr'==x&&!Q)Q=x&&'el-xhr'==x?!0:!1,ya(x)},gb=function(x,q,p){if(p==q)return!1;var R=x[p],J=null;M&&/^xhr-/.test(R)?(R=R.replace(/^xhr-/,''),J=P('.gina-toolbar-xhr-folding-state-'+R)):J=P('.gina-toolbar-folding-state-'+R);rb(J,function(){p+=1;gb(x,q,p)})},Ub=function(){La.add(Fa).off('click','a').on('click','a',function(q){q.preventDefault();rb(P(this),null,!0)}).add(Na).off('click','a').on('click','a',function(q){q.preventDefault();rb(P(this),
null,!0)});Qa.add(Fa).off('click','a').on('click','a',function(q){q.preventDefault();rb(P(this),null,!0)}).add(Na).off('click','a').on('click','a',function(q){q.preventDefault();rb(P(this),null,!0)});Ia.off('click').on('click',function(q){q.preventDefault();rb('all',null,!0)});La.add(Fa,Na).off('click','.gina-toolbar-value').on('click','.gina-toolbar-value',function(q){q.preventDefault();try{Ua=P(this).text(),Ja.text(Ua),Ja.select(),document.execCommand('copy',!1,null),Ja.blur()}catch(p){alert('Please press Ctrl/Cmd+C to copy the value')}});
ha.off('click').on('click',function(q){la&&window.open('','JSON RAW','width=400,height=100').document.write(JSON.stringify(la.data))});Aa.off('click').on('click',function(q){q.preventDefault();Aa.removeClass('gina-toolbar-active');A.removeClass('gina-toolbar-active');P(this).addClass('gina-toolbar-active');l=P(this).attr('href');D=P(l).addClass('gina-toolbar-active');w.panelId=l;w.save()});N.off('click').on('click',function(q){q.preventDefault();H.toggleClass('gina-toolbar-collapsed');va=H.hasClass('gina-toolbar-collapsed');
w.isCollapsed=va;w.save()});F.off('change').on('change',function(q){q.preventDefault();q=y.val();var p=z.val();u=q+'-'+p;Zb(u);w.position=u;w.save()});v.off('change').on('change',function(q){q.preventDefault();G=v.val();jb(G);w.width=G;w.save()});P(window).off('resize').on('resize',function(){Db()});P('body').off('keypress').on('keypress',function(q){if(!/INPUT|TEXTAREA/.test(q.target.tagName)){qa=q.keyCode?q.keyCode:q.which?q.which:q.charCode;q=new Date;if('undefined'!=typeof Da.keynum&&Da.keynum==
qa&&'undefined'!=typeof Da.pressTime&&500>q.getTime()-Da.pressTime)switch(qa){case 103:H.toggle()}Da.pressTime=q.getTime();Da.keynum=qa}});Aa.filter('[href="'+l+'"]').trigger('click');va||P('#gina-toolbar-toggle').trigger('click');Zb(u);var x=u.split('-');y.val(x[0]);z.val(x[1]);jb(G);v.val(G);Db();x=W?W.text():'';/^\{\{ (.*) \}\}/.test(x)?h(x,ab):ab()},Zb=function(x){H.removeClass('gina-toolbar-top-left gina-toolbar-top-right gina-toolbar-bottom-left gina-toolbar-bottom-right').addClass('gina-toolbar-'+
x)},jb=function(x){H.removeClass('gina-toolbar-auto gina-toolbar-100 gina-toolbar-80 gina-toolbar-60 gina-toolbar-50 gina-toolbar-40 gina-toolbar-30').addClass('gina-toolbar-'+x)},Db=function(){L=window.innerHeight-32;H.find('.gina-toolbar-main').css('max-height',L+'px');var x=D.find('.gina-toolbar-main'),q=x.find('.gina-toolbar-content');T=x.height();T==L?q.addClass('gina-toolbar-content-end'):q.removeClass('gina-toolbar-content-end')},rb=function(x,q,p){'undefined'==typeof p&&(p=!1);if(void 0!=
...
(x.addClass('gina-toolbar-unfolded'),x.next('ul').slideToggle('fast'));else if(-1<w.isUnfolded.indexOf(U)&&x.hasClass('gina-toolbar-unfolded')){for(var J=new RegExp('^('+U+')'),fa=0,Ba=w.isUnfolded.length;fa<Ba;++fa)J.test(w.isUnfolded[fa])&&(!ba&&p||ba&&R||p)&&(w.isUnfolded.splice(fa,1),--fa);w.save(!0);0>w.isUnfolded.indexOf(U)&&(x.removeClass('gina-toolbar-unfolded'),x.next('ul').slideToggle('fast'))}else x.addClass('gina-toolbar-unfolded'),x.next('ul').slideToggle('fast')}'undefined'!=typeof q&&
null!=q&&q()},xb=function(x){var q={},p=null,R=[],J=0;for(p in x)x.hasOwnProperty(p)&&(R[J]=p,++J);var fa=R.length;R.sort();for(J=0;J<fa;++J)p=R[J],q[p]=x[p];return q},Ka=function(x,q){var p='';if('undefined'!=typeof x&&''!=x){var R=x;'string'==typeof x&&(R=x.replace(/(\]\[|\[)/g,'-').replace(/\]/,'').replace(/[^A-Za-z0-9_-]/g,'_'));p+=R+'-'}'undefined'!=typeof q&&''!=q?(x=q,'string'==typeof q&&(x=q.replace(/(\]\[|\[)/g,'-').replace(/\]/,'')),p+=x):p=p.substr(0,p.length-1);return p.trim()},db=function(x,
q,p,R,J){var fa='';p='undefined'!=typeof p&&null!=p?p.replace(/[^A-Za-z0-9_-]/g,'_'):'';var Ba='undefined'!=typeof J&&null!=J?J:'',ea='undefined'!=typeof R&&null!=R?'-xhr':'';if(x){x=xb(x);q=xb(q);for(var da in x)if('object'!=typeof x[da]||Array.isArray(x[da])||null===x[da])if(Array.isArray(x[da])){p+='-'+da.replace(/[^A-Za-z0-9_-]/g,'_');var E=0<x[da].length||'undefined'!=typeof q[da]&&0<q[da].length?'':' is-empty';fa+='<li class="gina-toolbar-collection">';fa+='<a href="#" class="gina-toolbar-key gina-toolbar'+
ea+'-folding-state-'+Ka(Ba,da.replace(/[^A-Za-z0-9_-]/g,'_'))+E+'">'+da+' <span>['+x[da].length+']</span></a>';fa+='<ul class="gina-toolbar-collection">'+Lb(x[da],q[da],p,R,J)+'</ul>';fa+='</li>';p=p.substr(0,p.length-da.length)}else E=null===q[da]?'null':typeof q[da],'undefined'==E?(fa+='<li class="gina-toolbar-key-value">',fa+='<span class="gina-toolbar-key gina-toolbar-key-added">'+da+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+E+'">'+x[da]+'</span>'):(x[da]!==q[da]&&
...
'<li class="gina-toolbar-object">',fa+='<a href="#" class="gina-toolbar-key gina-toolbar'+ea+'-folding-state-'+Ka(Ba,da.replace(/[^A-Za-z0-9_-]/g,'_'))+E+'">'+da+' <span>{ }</span></a>',fa+='<ul class="gina-toolbar-object">'+db(x[da],q[da],p,R,J)+'</ul>',fa+='</li>',p=p.substr(0,p.length-da.length);return fa}},Lb=function(x,q,p,R,J){var fa='';p='undefined'!=typeof p&&null!=p?p:'';var Ba='undefined'!=typeof J&&null!=J?J:'',ea='undefined'!=typeof R&&null!=R?'-xhr':'';q||=[];for(var da=0,E=x.length;da<
E;++da)'object'!=typeof x[da]||Array.isArray(x[da])?Array.isArray(x[da])?(p+='-'+da,''==Ba&&(Ba=p),fa+='<li class="gina-toolbar-collection">',fa+='<a href="#" class="gina-toolbar-key gina-toolbar'+ea+'-folding-state-'+Ka(Ba,da)+'">'+da+'<span>[ ]</span></a>',fa+='<ul class="gina-toolbar-collection">'+Lb(x[da],q[da],p,R,J)+'</ul>',fa+='</li>',p=p.substr(0,p.length-da.toString().length)):fa+='<li class="gina-toolbar-key-value"><span class="gina-toolbar-key">'+da+':</span> <span class="gina-toolbar-value">'+
x[da]+'</span></li>':(q[da]||(q[da]=x[da]),p+='-'+da,''==Ba&&(Ba=p),fa+='<li class="gina-toolbar-object">',fa+='<a href="#" class="gina-toolbar-key gina-toolbar'+ea+'-folding-state-'+Ka(Ba,da)+'">'+da+' <span>{ }</span></a>',fa+='<ul class="gina-toolbar-object">'+db(x[da],q[da],p,R,J)+'</ul>',fa+='</li>',p=p.substr(0,p.length-da.toString().length-1));return fa},Vb=function(x,q,p,R,J,fa){p=null!=p?p.replace(/[^A-Za-z0-9_-]/g,'_'):'';var Ba='undefined'!=typeof R&&null!=R?'-xhr':'';x=xb(x);q=xb(q);fa||=
J;for(var ea in x){var da=ea;if('object'!=typeof x[ea]||Array.isArray(x[ea])||null===x[ea])if(Array.isArray(x[ea])){var E=P('#gina-toolbar-view-'+p.substr(0,p.length-1));var na=E.length?!0:!1;!na||/^html/.test(p)?(E=P('.'+p),na=p+ea.replace(/[^A-Za-z0-9_-]/g,'_')+'-',E.append('<li class="gina-toolbar-collection"><a href="#" class="gina-toolbar-key gina-toolbar'+Ba+'-folding-state-'+Ka(ea.replace(/[^A-Za-z0-9_-]/g,'_'),na.substr(0,na.length-1))+'">'+ea+' <span>['+x[ea].length+']</span></a><ul> '+Lb(x[ea],
...
p.length-ea.length-1)}else if(da=null===q[ea]?'null':typeof q[ea],'undefined'==da)/\-$/.test(p)&&(p=p.substr(0,p.length-1)),p&&J.find('ul.'+p).append('<li class="gina-toolbar-key-value"><span class="gina-toolbar-key gina-toolbar-key-added">'+ea+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+da+'">'+x[ea]+'</span></li>');else if(x[ea]!==q[ea]){p||(p+=ea.replace(/[^A-Za-z0-9_-]/g,'_')+'-');try{J.find('ul.'+p).append('<li class="gina-toolbar-key-value gina-toolbar-is-overridden"><span class="gina-toolbar-key">'+
ea+':</span> <span class="gina-toolbar-value">'+q[ea]+'</span></li>'),J.find('ul.'+p).append('<li class="gina-toolbar-key-value"><span class="gina-toolbar-key">'+ea+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+da+'">'+x[ea]+'</span></li>')}catch(ra){throw Error('GinaToolbarError: `ul.'+p+'` not found');}}else!p||/^html\-properties/.test(p)?fa.find('.gina-toolbar-properties').append('<li class="gina-toolbar-key-value"><span class="gina-toolbar-key">'+ea+':</span> <span class="gina-toolbar-value gina-toolbar-value-type-is-'+
...
p.length-1)+'"></ul></div>',P('#gina-toolbar-view-html-properties').before(da)):/^html/.test(p)||(da='<div id="gina-toolbar-view-'+p.substr(0,p.length-1)+'" class="gina-toolbar-section"><h2 class="gina-toolbar-section-title">'+p.substr(0,p.length-1)+'</h2><ul class="'+p.substr(0,p.length-1)+'"></ul></div>',J.append(da)),Vb(x[ea],q[ea],p,R,J.find('ul.'+p.substr(0,p.length-1)),fa)),p=p.substr(0,p.length-ea.length-1)}return fa.html()},ya=function(x){x=gina.hasPopinHandler?gina.popin.getActivePopin():
null;var q,p=(gina.hasPopinHandler?P('#'+x.id):P('body')).html().match(/404:\[(.+)\](.+)@(.+)"/gm);if(p){var R=0;for(q=p.length;R<q;++R){x=p[R].replace(/"(.*)|"/g,'');var J=x.match(/\[(.*)\]/g,'')[0].replace(/\[|\]/g,'');V.getRouteByUrl(x,J)}}fLen=V.notFound.count();if(0<fLen)for(f in V.notFound)console.warn('(x'+V.notFound[f].count+') '+f+' => '+V.notFound[f].message)},za=function(x,q,p,R,J,fa,Ba){if(!fa)return!1;for(var ea=J[R].attributes,da,E=J[R].getAttribute('id')||J[R].id,na=P('<div id="gina-toolbar-form-'+
...
ia+'</span></li>',na.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+da+' > ul').append(Z)):(/^action$/.test(ra)||(Z='<li><span class="gina-toolbar-key">'+ra+':</span><span class="gina-toolbar-value">'+ia+'</span></li>'),na.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-attributes > ul').append(Z));ea=null;try{var $a=J[R].getAttribute('data-gina-form-rule');ea='undefined'!=typeof $a&&null!=$a?eval('gina.forms.rules.'+$a.replace(/-/g,'.')):eval('gina.forms.rules.'+
E.replace(/-/g,'.'))}catch(ib){}ea&&(da='rules',na.find('ul.gina-toolbar-section-content').append('<li class="gina-toolbar-form-'+da+'"><h3 class="gina-toolbar-sub-section-title">'+da+'</h3><ul class="gina-toolbar-properties">'+db(ea,ea,E,Ba,da)+'</ul></li>'));p.append(na);++R;R<fa&&za(x,q,p,R,J,fa,Ba)},m=function(x,q,p,R){var J=P('#gina-toolbar-form-'+x);$section=J.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+q+'> ul');if(0<$section.length){if(0==p.count())return J.find('ul.gina-toolbar-section-content').find('li.gina-toolbar-form-'+
q).remove(),!1;$section.html(db(p,p,x,R,q))}else J.find('ul.gina-toolbar-section-content').append('<li class="gina-toolbar-form-'+q+'"><h3 class="gina-toolbar-sub-section-title">'+q+'</h3><ul class="gina-toolbar-properties">'+db(p,p,x,R,q)+'</ul></li>');x=J.find('ul.gina-toolbar-section-content');x.is(':visible')||x.slideToggle()},g=function(x,q){return x='<label class="gina-toolbar-input-file"><input type="file" multiple id="'+(x+'">')+q+'</label>'},h=function(x,q){x=g('mock','Select your JSON file');
La.html(x);W.text('');La.find('input').off('change').on('change',function(p){var R=P(this)[0].files,J=p=null;if(1==R.length)p=P(this)[0].files[0],J=new FileReader,J.addEventListener('load',function(){W.text(J.result);ka.text(J.result);q()},!1),J.readAsBinaryString(p);else{var fa=0;J=[];for(var Ba=0,ea=R.length;Ba<ea;++Ba)switch(p=R[Ba],!0){case /user/.test(p.name):J[Ba]=new FileReader;J[Ba].addEventListener('load',function(da){W.text(da.currentTarget.result);++fa;fa==R.length&&q()},!1);J[Ba].readAsBinaryString(p);
break;case /gina/.test(p.name):J[Ba]=new FileReader,J[Ba].addEventListener('load',function(da){ka.text(da.currentTarget.result);++fa;fa==R.length&&q()},!1),J[Ba].readAsBinaryString(p)}}});return!1},b=function(x,q){for(var p in x)'object'==typeof x[p]&&b(x[p],q+p+'-')};this.update=function(x,q){ab(x,q)};this.restore=function(){ta&&'undefined'!=typeof ta.data&&(xa.jsonObject.data=ta.data);ab('data',xa.jsonObject,xa.ginaJsonObject);Q=!1;V.notFound={}};if('undefined'!=typeof gina.validator)gina.validator.on('initialized',
...
':'),x.ipv6uri=!0),x.pathNames=function(p,R){p=R.replace(/\/{2,9}/g,'/').split('/');'/'!=R.substr(0,1)&&0!==R.length||p.splice(0,1);'/'==R.substr(R.length-1,1)&&p.splice(p.length-1,1);return p}(0,x.path),x.queryKey=(h=x.query,b={},h.replace(/(?:^|&)([^&=]*)=?([^&]*)/g,function(p,R,J){R&&(b[R]=J)}),b),x}var L=Object.create(null);L.open='0';L.close='1';L.ping='2';L.pong='3';L.message='4';L.upgrade='5';L.noop='6';var T=Object.create(null);Object.keys(L).forEach(function(ya){T[L[ya]]=ya});for(var qa=
{type:'error',data:'parser error'},Da='function'==typeof Blob||'undefined'!=typeof Blob&&'[object BlobConstructor]'===Object.prototype.toString.call(Blob),W='function'==typeof ArrayBuffer,ka=function(ya,za,m){var g=ya.type;ya=ya.data;return Da&&ya instanceof Blob?za?m(ya):ha(ya,m):W&&(ya instanceof ArrayBuffer||('function'==typeof ArrayBuffer.isView?ArrayBuffer.isView(ya):ya&&ya.buffer instanceof ArrayBuffer))?za?m(ya):ha(new Blob([ya]),m):m(L[g]+(ya||''))},ha=function(ya,za){var m=new FileReader;
return m.onload=function(){var g=m.result.split(',')[1];za('b'+g)},m.readAsDataURL(ya)},xa='undefined'==typeof Uint8Array?[]:new Uint8Array(256),la=0;64>la;la++)xa['ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.charCodeAt(la)]=la;var ta='function'==typeof ArrayBuffer,Ea=function(ya,za){if('string'!=typeof ya)return{type:'message',data:Qa(ya,za)};var m=ya.charAt(0);if('b'===m){ya=ya.substring(1);if(ta){var g=.75*ya.length;m=ya.length;var h=0;'='===ya[ya.length-1]&&(g--,'='===ya[ya.length-
2]&&g--);var b=new ArrayBuffer(g),x=new Uint8Array(b);for(g=0;g<m;g+=4){var q=xa[ya.charCodeAt(g)];var p=xa[ya.charCodeAt(g+1)];var R=xa[ya.charCodeAt(g+2)];var J=xa[ya.charCodeAt(g+3)];x[h++]=q<<2|p>>4;x[h++]=(15&p)<<4|R>>2;x[h++]=(3&R)<<6|63&J}za=Qa(b,za)}else za={base64:!0,data:ya};za={type:'message',data:za}}else za=T[m]?1<ya.length?{type:T[m],data:ya.substring(1)}:{type:T[m]}:qa;return za},Qa=function(ya,za){return'blob'===za&&ya instanceof ArrayBuffer?new Blob([ya]):ya},La=String.fromCharCode(30);
...
Fa?'pagehide':'unload',v,!1);var Db='function'==typeof Promise&&'function'==typeof Promise.resolve?function(ya){return Promise.resolve().then(ya)}:function(ya,za){return za(ya,0)},rb=Fa.WebSocket||Fa.MozWebSocket,xb='undefined'!=typeof navigator&&'string'==typeof navigator.product&&'reactnative'===navigator.product.toLowerCase(),Ka={websocket:function(ya){function za(g){var h;return P(this,za),(h=m.call(this,g)).supportsBinary=!g.forceBase64,h}M(za,ya);var m=va(za);return ma(za,[{key:'doOpen',value:function(){if(this.check()){var g=
...
value:function(g){function h(){J||(J=!0,ea(),R.close(),R=null)}function b(){Ba('transport closed')}function x(){Ba('socket closed')}function q(da){R&&da.name!==R.name&&h()}var p=this,R=this.createTransport(g),J=!1;za.priorWebsocketSuccess=!1;var fa=function(){J||(R.send([{type:'ping',data:'probe'}]),R.once('packet',function(da){if(!J)if('pong'===da.type&&'probe'===da.data){if(p.upgrading=!0,p.emitReserved('upgrading',R),R)za.priorWebsocketSuccess='websocket'===R.name,p.transport.pause(function(){J||
...
typeof l&&(l=r.target);var z,F=null;l=l.getElementsByTagName('a');for(var u=0,v=l.length;u<v;++u)if(((z=l[u].getAttribute('data-gina-link'))||''==z)&&!/^false$/i.test(z)){z=l[u];var G={type:'a',method:'GET'};var L=z.getAttribute('data-gina-link-url');G.url='undefined'!=typeof L&&null!=L?L:z.getAttribute('href');L=z.getAttribute('id');if('undefined'==typeof L||null==L||''==L||/popin\.link/.test(L))L='link.click.gina-link-'+r.id+'-'+P.v4();z.id=L;evt=G.id=L;z.setAttribute('id',evt);'A'==z.tagName&&
...
Ka.target.id=Ka.target.getAttribute('id')),/^popin\.close\./.test(Ka.target.id)&&(cancelEvent(Ka),ka.isRedirecting=!1,O(ka.name)),/^popin\.click\./.test(Ka.target.id)&&(cancelEvent(Ka),db=Ka.target.id,(new RegExp('^popin.click.gina-popin-'+l.id)).test(db)&&triggerEvent(gina,Ka.target,db,Ka.detail))})};gina.popinIsBinded=!0;var la=null,ta=null,Ea=null;if(!ka.isOpen&&D.options.cancelOnOverlayClick){var Qa=ka.target;if(!D.options.useDialogMode||gina.config.envIsDev)Qa=l.target.childNodes[0];addListener(gina,
Qa,'mousedown',function(jb){if(/gina-popin-is-active/.test(jb.target.className)){removeListener(gina,jb.target,'mousedown');jb=[];la=0;var Db=ha.getElementsByTagName('button');ta=0;Ea=Db.length;if(0<Ea)for(;ta<Ea;++ta)/gina-popin-close/.test(Db[ta].className)&&(jb[la]=Db[ta],++la);Db=ha.getElementsByTagName('div');ta=0;Ea=Db.length;if(0<Ea)for(;ta<Ea;++ta)/gina-popin-close/.test(Db[ta].className)&&(jb[la]=Db[ta],++la);Db=ha.getElementsByTagName('a');ta=0;Ea=Db.length;if(0<Ea)for(;ta<Ea;++ta)/gina-popin-close/.test(Db[ta].className)&&
(jb[la]=Db[ta],++la);ta=0;for(Ea=jb.length;ta<Ea;++ta){Db=jb[ta];let rb=Db.getAttribute('id');for(let xb=0,Ka=A.length;xb<Ka;xb++){let db=A[xb];'undefined'!=typeof gina.events[db]&&gina.events[db]==rb&&removeListener(gina,Db,db);'undefined'!=typeof gina.events[rb]&&gina.events[rb]==rb&&removeListener(gina,Db,rb);'undefined'!=typeof gina.events[db+'.'+rb]&&gina.events[db+'.'+rb]==rb&&removeListener(gina,Db,db+'.'+rb);'undefined'!=typeof gina.events[db+'.'+rb]&&gina.events[db+'.'+rb]==db+'.'+rb&&removeListener(gina,
Db,db+'.'+rb)}}ka.isRedirecting=!1;O(ka.name)}})}/<form/i.test(ha.innerHTML)&&'undefined'!=typeof z&&z&&(ka.hasForm=!0);var La=[],Fa=[];Qa=[];Fa=ha.getElementsByTagName('button');ta=la=0;Ea=Fa.length;if(0<Fa.length)for(;ta<Ea;++ta)/gina-popin-close/.test(Fa[ta].className)&&(La[la]=Fa[ta],++la);Fa=ha.getElementsByTagName('div');ta=0;Ea=Fa.length;if(0<Ea)for(;ta<Ea;++ta)/gina-popin-close/.test(Fa[ta].className)&&(La[la]=Fa[ta],++la);Fa=ha.getElementsByTagName('a');ta=0;Ea=Fa.length;if(0<Ea)for(;ta<
Ea;++ta)/gina-popin-close/.test(Fa[ta].className)?(La[la]=Fa[ta],++la):('undefined'==typeof Fa[ta]||/(#|#.*)$/.test(Fa[ta].href)||Fa[ta].id)&&('undefined'==typeof Fa[ta]||/(#|#.*)$/.test(Fa[ta].href)||/^(click\.|popin\.link)/.test(Fa[ta].id))||Qa.push(Fa[ta]);var Na=null;Fa=null;ta=0;for(Ea=La.length;ta<Ea;++ta)'A'==La[ta].tagName&&(Na=La[ta].getAttribute('onclick')),Na?'undefined'==typeof Na||/return false/.test(Na)||(Na=/;$/.test(Na)?Na+'return false;':Na+'; return false;'):La[ta].setAttribute('onclick',
'return false;'),La[ta].id?Fa=La[ta].id:(Fa='popin.close.'+P.v4(),La[ta].id=Fa,La[ta].setAttribute('id',Fa)),'undefined'!=typeof gina.events[Fa]&&gina.events[Fa]==La[ta].id||W('close',Fa,La[ta]);la=0;Ea=Qa.length;var Ia=null,Ja=null,Ua=null,pb={},ab=null,gb=new DOMParser,Ub=null,Zb=null;for(Fa=La=La=null;la<Ea;++la)null==Qa[la].getAttribute('disabled')&&(Qa[la].id=/^null$/i.test(Qa[la].getAttribute('id'))?null:Qa[la].getAttribute('id'),Qa[la].id&&/^popin\.link/.test(Qa[la].id)&&/^popin\.click/.test(Qa[la].id)?
Fa=Qa[la].id:(Fa=!0,La=Qa[la].getAttribute('href'),La&&''!=La&&'#'!=La||('#'!=La&&Qa[la].setAttribute('href','#'),Fa=!1),/^null$/i.test(Qa[la].id)?Fa?(Fa='popin.link.'+P.v4(),Qa[la].setAttribute('data-gina-popin-is-link',!0)):(Fa='popin.click.'+P.v4(),Qa[la].setAttribute('data-gina-popin-is-link',!1)):Fa=Qa[la].id,Qa[la].id=Fa,Qa[la].setAttribute('id',Fa)),La=(La=Qa[la].getAttribute('data-gina-form-submit'))&&/^true$/i.test(La)?!0:!1,La||(/^(null|\s*)$/.test(Qa[la].getAttribute('href'))||addListener(gina,
...
jb.currentTarget.href+='?inheritedData='+encodeRFC5987ValueChars(JSON.stringify(pb)))}}),'undefined'!=typeof gina.events[Fa]&&gina.events[Fa]==Qa[la].id||W('link',Fa,Qa[la])));if(ka.hasForm)for(W=null,Qa=ha.getElementsByTagName('form'),la=0,Ea=Qa.length;la<Ea;++la)Qa[la].id&&'string'==typeof Qa[la]?W=Qa[la].id:(W=Qa[la].getAttribute('id')||'form.'+P.v4(),Qa[la].setAttribute('id',W),Qa[la].id=W),0>ka.$forms.indexOf(W)&&ka.$forms.push(W),Qa[la].close=O,z.isPopinContext=!0,z.validateFormById(Qa[la].getAttribute('id')),
...
null;if(null==ta){var Ea=null;D.options.useDialogMode?(Ea=xa.options.class+' '+la,ta=document.createElement('dialog'),ta.setAttribute('id',la),ta.setAttribute('class',Ea),ta.setAttribute('data-type','modal'),ta.setAttribute('aria-labelledby',W),($overlay=document.getElementById('gina-popins-overlay'))?$overlay.appendChild(ta):l.target.appendChild(ta)):(Ea=xa.options.class+' '+la,ta=document.createElement('div'),ta.setAttribute('id',la),ta.setAttribute('class',Ea),l.target.firstChild.appendChild(ta))}'undefined'==
typeof ha?ha=Da:(W=Da.withCredentials,ha=U(ha,Da),ha.withCredentials=W);/^(http|https):/.test(ka)&&!(new RegExp('^'+window.location.protocol+'//'+window.location.host)).test(ka)&&(W=ma.getRootDomain(window.location.hostname).value,Ea=ma.getRootDomain(ka).value,W=W===Ea?!0:!1,gina.config.envIsDev&&(console.debug('Checking CORS from Popin plugin...TODO - local CORS Proxy'),console.debug('Is request from same domain ? ',W)),W||(ka=ka.match(/^(https|http):/)[0]+'//corsacme.herokuapp.com/?'+ka,ha.withCredentials=
...
'undefined'!=typeof ha.withCredentials?ha.withCredentials:!1;F.onerror=function(Na,Ia){Qa={status:F.status,error:'Transaction error: might be due to the server CORS settings.\nPlease, check the console for more details.'};La=!0;l.eventData.error=Qa+'\n'+Ia;S(Qa,La);triggerEvent(gina,ta,'error.'+la,Qa)};for(var Fa in ha.headers)F.setRequestHeader(Fa,ha.headers[Fa]);F.onreadystatechange=function(Na){if(4==F.readyState)if(Na=null,/^2/.test(F.status))try{Na=F.responseText;var Ia=F.getResponseHeader('Content-Type'),
...
ka.open('GET',W,!0);ka.setRequestHeader('Content-Type','text/css');ka.onload=function(){eval(ka.response)};ka.send()}function Aa(W){var ka='undefined'!=typeof W?T(W):L(this.id);if(!ka)throw Error('Popin name `'+W+'` not found !');W=document.getElementById(ka.id);var ha=ka.parentScripts,xa=W.getElementsByTagName('script'),la=ka.parentStyles,ta=W.getElementsByTagName('link'),Ea=0,Qa=xa.length,La=gina.config.hostname.replace(/(https|http|):\/\//,'').replace(/:\d+$/,'');for(La=new RegExp(La+':\\d+|'+
La);Ea<Qa;++Ea){if('undefined'==typeof xa[Ea].src||''==xa[Ea].src)continue;let Fa=xa[Ea].src.replace(/(https|http|):\/\//,'').replace(La,'');-1<ha.indexOf(Fa)||w(xa[Ea].src)}Ea=0;for(Qa=ta.length;Ea<Qa;++Ea)'undefined'!=typeof ta[Ea].href&&''!=ta[Ea].href&&(ha=ta[Ea].href.replace(/(https|http|):\/\//,'').replace(La,''),-1<la.indexOf(ha)||va(ta[Ea].href));Q({target:W,type:'loaded.'+ka.id},ka);/gina-popin-is-active/.test(W.className)||(W.className+=' gina-popin-is-active');if(!D.options.useDialogMode||
...
W.appendChild(ka)}document.body.appendChild(W);l.target=W;l.on=on;gina.popinContainer=l.id},G=function(W,ka,ha){addListener(gina,W,'click',function(xa){cancelEvent(xa);triggerEvent(gina,ka,ha)})},L=function(W){return'undefined'!=typeof l.$popins[W]?l.$popins[W]:null},T=function(W){var ka=null,ha;for(ha in l.$popins)if(l.$popins[ha].name===W){ka=l.$popins[ha];break}return ka},qa=function(W,ka){ka=getElementsByAttribute('data-gina-popin-name');var ha=null,xa=null,la=null,ta=null,Ea=null,Qa=null;Ea=
0;for(Qa=ka.length;Ea<Qa;++Ea){ha=ka[Ea];xa=ha.getAttribute('data-gina-popin-name');'A'==ha.tagName&&(la=ha.getAttribute('href'),''==la||'#'==la||/#/.test(la))&&(la=null);la||'undefined'==typeof ha.getAttribute('data-gina-popin-url')||(la=ha.getAttribute('data-gina-popin-url'));if(!la)throw Error('Found `data-gina-popin-name` without `url` !');ha.url||(ha.url=la);ha.popinName||(ha.popinName=xa);if(xa==W.name&&(ta='popin.click.gina-popin-'+l.id+'-'+P.v4()+'-'+xa,ha.id=ta,ha.setAttribute('id',ta),!gina.events[ta])){addListener(gina,
ha,ta,function(Fa){cancelEvent(Fa);var Na=!1;addListener(gina,W.target,'loaded.'+W.id,function(Ja){Ja.preventDefault();Na||(Na=!0,console.debug('active popin should be ',W.id),gina.popin.activePopinId=W.id,Q(Ja,W),W.isOpen||Aa(W.name))});Fa={isSynchrone:!1,withCredentials:!1};Fa=U(W.options,Fa);var Ia=this.getAttribute('data-gina-popin-url')||this.getAttribute('href');if(!Ia)throw Error('Popin `url` not defined, please check value for `data-gina-popin-url`');r(W.name,Ia,Fa)});xa=ha.childNodes;var La=
0;lLen=xa.length;if(0<lLen)for(;La<lLen;++La)'undefined'!=typeof xa[La].tagName&&G(xa[La],ha,ta)}}ta='click';addListener(gina,document,ta,function(Fa){if(null!=Fa.target.getAttribute('disabled')&&'false'!=Fa.target.getAttribute('disabled'))return!1;'undefined'==typeof Fa.target.id&&(Fa.target.setAttribute('id',ta+'.'+P.v4()),Fa.target.id=Fa.target.getAttribute('id'));if(/^popin\.close\./.test(Fa.target.id)){cancelEvent(Fa);var Na=Fa.target.id;triggerEvent(gina,Fa.target,Na,Fa.detail)}/^popin\.click\./.test(Fa.target.id)&&
(cancelEvent(Fa),Na=Fa.target.id,(new RegExp('^popin.click.gina-popin-'+l.id)).test(Na)&&triggerEvent(gina,Fa.target,Na,Fa.detail))});gina.popinIsBinded=!1},Da={url:'',method:'GET',isSynchrone:!1,withCredentials:!0,headers:{'X-Requested-With':'XMLHttpRequest'}};gina.hasPopinHandler?(l.target=document.getElementById(gina.popinContainer),l.on=on):v();new V(function(W,ka){if(W)throw W;ma=ka});return function(W){l.getPopinById=L;l.getPopinByName=T;l.load=r;l.loadContent=H;l.getActivePopin=ba;l.open=Aa;
...
for(let Ea=0,Qa=la.length;Ea<Qa;Ea++)if(la[Ea].src&&''!=la[Ea].src){var ta=la[Ea].src.replace(/(https|http|):\/\//,'').replace(xa,'');ha.parentScripts[Ea]=ta}la=document.getElementsByTagName('link');for(let Ea=0,Qa=la.length;Ea<Qa;Ea++)'undefined'!=typeof la[Ea].rel&&/stylesheet/i.test(la[Ea].rel)&&(ta=la[Ea].href.replace(/(https|http|):\/\//,'').replace(xa,''),ha.parentStyles[Ea]=ta);l.$popins[ha.id]=ha;if(window.XMLHttpRequest)F=new XMLHttpRequest;else if(window.ActiveXObject)try{F=new ActiveXObject('Msxml2.XMLHTTP')}catch(Ea){try{F=
new ActiveXObject('Microsoft.XMLHTTP')}catch(Qa){}}qa(ha)}}l.isReady=!0;gina.hasPopinHandler=!0;gina.popin=U(gina.popin,l);triggerEvent(gina,l.target,'ready.'+l.id,ka)});l.initialized=!0;return l}(M)}});
